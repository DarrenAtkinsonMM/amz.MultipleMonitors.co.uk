		...
		if (ddlop1.options[i].selected == true) {
			...
			switch(ddlop1.options[i].id) {
				...
				case '294':
					...
					numQuiet = numQuiet;
					if (strPC == "ULT") {
						document.getElementById('optMotherboard').innerHTML='Fast B660 Chipset Motherboard';
					} else {
						document.getElementById('optMotherboard').innerHTML='Fast Z690 Chipset Motherboard';
					}
				...
				case '317':
					...
					numMulThr = 16;
					numQuiet = numQuiet - 3;
					document.getElementById('optMotherboard').innerHTML='Fast X670 Chipset Motherboard';
					document.getElementById('optCPUCool').innerHTML='Corsair Liquid AIO Cooler';
					break;	
				case '318':
					//'7950x
			...
			switch(ddlop5.options[i].id) {
				...
				case '300':
					...
					if (strPC == "ULT") {
						...
						document.getElementById('optPSU').innerHTML='BeQuiet Premium Low Noise 700w';
					}
					document.getElementById('optCaseCool').innerHTML='Enhanced Low Noise';
					document.getElementById('optRes').innerHTML='<li>Up to 3 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 3 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 3 4K (3840 x 2160) 60Hz Screens</li>';
				...
				case '302':
					...
					document.getElementById('optCaseCool').innerHTML='Enhanced Low Noise';
					document.getElementById('optRes').innerHTML='<li>Up to 4 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 4 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 4 4K (3840 x 2160) 60Hz Screens</li><li>Up to 4 5K (5120 x 2880) 60Hz Screens</li><li>Up to 2 8K (7680 x 4320) 60Hz Screens</li>';
				...
				case '303':
					...
					document.getElementById('optCaseCool').innerHTML='Enhanced Low Noise';
					document.getElementById('optRes').innerHTML='<li>Up to 8 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 8 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 7 4K (3840 x 2160) 60Hz Screens</li><li>Up to 4 5K (5120 x 2880) 60Hz Screens</li><li>Up to 2 8K (7680 x 4320) 60Hz Screens</li>';
				...
				case '999':
					...
					document.getElementById('optPorts').innerHTML='<li>3 x Mini-DisplayPort Outputs</li><li>1 x HDMI Output</li>';
					numGPU = 10;
					//document.getElementById('trGA').style.display = "none";
					break;
				case '998':
				...
				case '994':
					...
					document.getElementById('optCaseCool').innerHTML='Enhanced Low Noise';
					document.getElementById('optRes').innerHTML='<li>Up to 9 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 9 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 5 4K (3840 x 2160) 60Hz Screens</li>';
					document.getElementById('optPorts').innerHTML='<li>9 x Mini-DisplayPort Outputs</li>';
					//document.getElementById('trGA').style.display = "none";
					numGPU = 10;
					break;
				default:
