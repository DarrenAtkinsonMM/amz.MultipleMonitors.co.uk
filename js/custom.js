...
//DA Addition to implement smooth inpage anchor scrolling
  $(function() {
	...
	function computerscustomjump(){
		$('html, body').stop().animate({
				scrollTop: $('#tradinghead').offset().top -200
			}, 1500, 'easeInOutExpo');
        return false;
	};
	
	function tradingcomplpcustomjump(){
		$('html, body').stop().animate({
				scrollTop: $('#pc-tradingsection2').offset().top -100
			}, 1500, 'easeInOutExpo');
        return false;
	};
	...
	function tradingcomplpcustomjump2(){
		$('html, body').stop().animate({
				scrollTop: $('#product-stands').offset().top -100
			}, 1500, 'easeInOutExpo');
        return false;
	};