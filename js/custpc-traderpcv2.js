function pageLD() {
	...
	document.getElementById('txtCPU').innerHTML='Intel i5 12400F // 2.5 - 4.4GHz // 6C - 12T';
	document.getElementById('txtMB').innerHTML='Fast B660 Chipset Motherboard';
	...
	document.getElementById('txtGPU').innerHTML='nVidia T400 Graphics Card';
	document.getElementById('txtCPUCool').innerHTML='BeQuiet Ultra Low Noise Air CPU Cooler';
	document.getElementById('optRes').innerHTML='<li>Up to 4 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 4 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 3 4K (3840 x 2160) 60Hz Screens</li>';
	document.getElementById('optPorts').innerHTML='<li>3x Mini-DisplayPort Outputs';
	...
	for (var i = 0; i < ddlop1.options.length; i++) {
		if (ddlop1.options[i].selected == true) {
			...
			switch(ddlop1.options[i].id){
				...
				break;
				case '2':
				document.getElementById('txtGPU').innerHTML='nVidia T400 & Intel UHD Graphics Card';
				...
				document.getElementById('optPorts').innerHTML='<li>6 x DisplayPort Outputs</li>';	
				numQuiet = 20;
				break;
				case '4':
				document.getElementById('txtGPU').innerHTML='nVidia T400 Graphics Card (x3)';
	...
	for (var i = 0; i < ddlop5.options.length; i++) {
		if (ddlop5.options[i].selected == true) {
			...
			if (ddlop5.options[i].id == 1){
				document.getElementById('txtCPU').innerHTML='Intel i3 12100F // 3.3 - 4.3GHz // 4C - 8T';
				document.getElementById('txtMB').innerHTML='Fast B660 Chipset Motherboard';
				document.getElementById('txtCPUCool').innerHTML='BeQuiet Ultra Low Noise Air CPU Cooler';
				numSpeed = 8;
				numMulti = 10;
				...
				document.getElementById('txtCPU').innerHTML='Intel i5 12600KF // 3.7 - 4.9GHz // 10C - 16T';
				document.getElementById('txtMB').innerHTML='Fast B660 Chipset Motherboard';
				document.getElementById('txtCPUCool').innerHTML='BeQuiet Ultra Low Noise Air CPU Cooler';
				numSpeed = 13;
				numMulti = 14;
