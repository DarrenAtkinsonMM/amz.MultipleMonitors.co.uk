function pageLD() {
	...
	document.getElementById('txtCPU').innerHTML='Intel i3 10105F // 3.7 - 4.4GHz // 4C - 8T';
	document.getElementById('txtRAM').innerHTML='8GB DDR4 2,666MHz RAM';
	document.getElementById('txtSSD').innerHTML='250GB Adata NVMe M.2 SSD';
	document.getElementById('txtGPU').innerHTML='nVidia T400 (2GB) Graphics Cards';
	//document.getElementById('txtGPU2').innerHTML='Connect up to 4 DVI or HDMI Screens (Any mix)';
	document.getElementById('optRes').innerHTML='<li>Up to 3 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 3 QHD (2560 x 1440) 120Hz Screens</li><li>Up to 3 4K (3840 x 2160) 120Hz Screens</li><li>Up to 3 5K (5120 x 2880) 60Hz Screens</li>';
	document.getElementById('optPorts').innerHTML='<li>3 x Mini-DisplayPort Outputs</li>';	
	...
	$(document).ready(function() {
		...
		if (numMonitorAmount > 1) {
			document.getElementById('txtWIFI').innerHTML='<p id="pWIFI">Wireless N 300Mbps Network Card</p>';	
...
function reCalc() {
	...
	for (var i = 0; i < ddlop1.options.length; i++) {
		if (ddlop1.options[i].selected == true) {
			...
			switch(ddlop1.options[i].id){
				case '0':
				document.getElementById('txtGPU').innerHTML='nVidia T400 Graphics Cards';
				document.getElementById('optRes').innerHTML='<li>Up to 3 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 3 QHD (2560 x 1440) 120Hz Screens</li><li>Up to 3 4K (3840 x 2160) 120Hz Screens</li><li>Up to 3 5K (5120 x 2880) 60Hz Screens</li>';
				document.getElementById('optPorts').innerHTML='<li>3 x Mini-DisplayPort Outputs</li>';	
				numQuiet = 20;
				break;
				...
				document.getElementById('optRes').innerHTML='<li>Up to 6 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 6 QHD (2560 x 1440) 120Hz Screens</li><li>Up to 5 4K (3840 x 2160) 60Hz Screens</li><li>Up to 3 5K (5120 x 2880) 60Hz Screens</li>';
	...
	for (var i = 0; i < ddlop5.options.length; i++) {
		if (ddlop5.options[i].selected == true) {
			...
			if (ddlop5.options[i].id == 0){
				document.getElementById('txtCPU').innerHTML='Intel i3 10105F // 3.7 - 4.4GHz // 4C - 8T';
				numSpeed = 5;
				numMulti = 6;
				numMulThr = 4;
				numQuiet = numQuiet;
			} else if (ddlop5.options[i].id == 1) {
				document.getElementById('txtCPU').innerHTML='Intel i5 10600KF // 4.1 - 4.8GHz // 6C - 12T';
				numSpeed = 8;
				numMulti = 12;
				numMulThr = 7;
				numQuiet = numQuiet;
			} else if (ddlop5.options[i].id == 2) {
				document.getElementById('txtCPU').innerHTML='Intel i7 10700KF // 3.8 - 5.1GHz // 8C - 16T';
				numSpeed = 9;
				numMulti = 14;
				numMulThr = 8;
				numQuiet = numQuiet;
			}  else if (ddlop5.options[i].id == 3) {
				document.getElementById('txtCPU').innerHTML='Intel i9 10900KF // 3.7 - 5.3GHz // 10C - 20T';
				numSpeed = 10;
				numMulti = 16;
				numMulThr = 10;
				numQuiet = numQuiet;
	...
	for (var i = 0; i < ddlop6.options.length; i++) {
		if (ddlop6.options[i].selected == true) {
			...
			if (ddlop6.options[i].id == 0){
				...
				document.getElementById('txtRAM').innerHTML='16GB DDR4 2,666MHz RAM';
				numMulti = numMulti + 1;
			} else if (ddlop6.options[i].id == 2) {
				document.getElementById('txtRAM').innerHTML='32GB DDR4 2,666MHz RAM';
				numMulti = numMulti + 2;
			} else if (ddlop6.options[i].id == 3) {
				document.getElementById('txtRAM').innerHTML='64GB DDR4 2,666MHz RAM';
				numMulti = numMulti + 2;
			}
		}
	}
	...
	var ddlop10 = document.getElementById('idOption6');
	if (ddlop10 != null)
	{
	for (var i = 0; i < ddlop10.options.length; i++) {
		if (ddlop10.options[i].selected == true) {
			...
			if (ddlop10.options[i].id == 0){
				document.getElementById('txtSPK').innerHTML='';
			} else if (ddlop10.options[i].id == 1) {
				document.getElementById('txtSPK').innerHTML='<p id="pSPK">Logitech Desktop Speakers</p>';
			} 
		}
	}
	...
	for (var i = 0; i < ddlop11.options.length; i++) {
		if (ddlop11.options[i].selected == true) {
			...
			if (ddlop11.options[i].id == 0){
				document.getElementById('txtKYB').innerHTML='<del>Wired Mouse / Keyboard Set</del>';
	...
	for (var i = 0; i < ddlop12.options.length; i++) {
		if (ddlop12.options[i].selected == true) {
			...
			if (ddlop12.options[i].id == 0){
				...
				document.getElementById('txtWIFI').innerHTML='<p id="pWIFI">Wireless N 300Mbps Network Card</p>';
			} else if (ddlop12.options[i].id == 2) {
	...
	var ddlop14 = document.getElementById('idOption15');
	if (ddlop14 != null)
	{
	...
	var ddlop15 = document.getElementById('idOption16');
	if (ddlop15 != null)
	{
	for (var i = 0; i < ddlop15.options.length; i++) {
		if (ddlop15.options[i].selected == true) {
			numSubTotal = eval(numSubTotal) + eval(ddlop15.options[i].title);
			if (ddlop15.options[i].id == 0){
				document.getElementById('txtBT').innerHTML='';
			} else if (ddlop15.options[i].id == 1) {
