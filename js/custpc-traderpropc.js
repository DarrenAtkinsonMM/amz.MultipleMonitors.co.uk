function pageLD() {
	...
	document.getElementById('txtCPU').innerHTML='Intel Core Ultra 5 245KF // 4.2 - 5.2GHz // 14C - 14T';
	document.getElementById('txtMB').innerHTML='Fast Z890 Chipset Motherboard';
	document.getElementById('txtRAM').innerHTML='32GB DDR5 5,200MHz RAM';
	document.getElementById('txtSSD').innerHTML='500GB WD M.2 NVMe SSD (5000MBs/4000MBs)';
	document.getElementById('txtGPU').innerHTML='Intel Arc A380 (6GB) Graphics Card';
	...
	document.getElementById('txtPSU').innerHTML='BeQuiet 700W Premium Quiet Power Supply';
	...
	$(document).ready(function() {
		...
		//Make 8 select the 9 monitor option
		//if (numMonitorAmount > 7) { numMonitorAmount = 9;}
		...
		if (numMonitorAmount > 1) {
			document.getElementById('txtWIFI').innerHTML='<p id="pWIFI">Wireless AX 3,000Mbps Network Card</p>';	
	...
	for (var i = 0; i < ddlop1.options.length; i++) {
		if (ddlop1.options[i].selected == true) {
			...
			switch(ddlop1.options[i].id){
				...
				break;
				case '2':
				document.getElementById('txtGPU').innerHTML='nVidia RTX 5060 (8GB) Graphics Card';
				...
				break;
				case '5':
				document.getElementById('txtGPU').innerHTML='Intel Arc A380 (6GB) Graphics Card x2';
				document.getElementById('optRes').innerHTML='<li>Up to 8 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 8 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 4 4K (3840 x 2160) 60Hz Screens</li><li>Up to 4 5K (5120 x 1440) 60Hz Screens</li>';
				...
				break;
				case '6':
				document.getElementById('txtGPU').innerHTML='nVidia RTX 5060 (8GB) Graphics Card (x2)';
				...
				document.getElementById('optPorts').innerHTML='<li>2 x HDMI Outputs</li><li>6 x DisplayPort Outputs</li>';	
				document.getElementById('stars-gputops').innerHTML='614';
				document.getElementById('txtPSU').innerHTML='BeQuiet 850W Premium Quiet Power Supply';
				numQuiet = 20;
				numGPU = 20;
				break;
				case '7':
				...
				break;
				case '8':
				document.getElementById('txtGPU').innerHTML='nVidia A400 (8GB) Graphics Card (x3)';
				document.getElementById('optRes').innerHTML='<li>Up to 12 FHD (1920 x 1080) 60Hz Screens</li><li>Up to 12 QHD (2560 x 1440) 60Hz Screens</li><li>Up to 7 4K (3840 x 2160) 60Hz Screens</li>';
				...
				break;
				case '9':
				document.getElementById('txtGPU').innerHTML='nVidia RTX 5070 (12GB) Graphics Card';
				document.getElementById('optRes').innerHTML='<li>Up to 4 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 4 QHD (2560 x 1440) 120Hz Screens</li><li>Up to 4 4K (3840 x 2160) 120Hz Screens</li><li>Up to 4 5K (5120 x 2880) 60Hz Screens</li><li>Up to 2 8K (7680 x 4320) 60Hz Screens</li>';
				document.getElementById('optPorts').innerHTML='<li>1 x HDMI Output</li><li>3 x DisplayPort Outputs</li>';
				...
				break;
				case '10':
				document.getElementById('txtGPU').innerHTML='nVidia RTX 5080 (16GB) Graphics Card';
				document.getElementById('optRes').innerHTML='<li>Up to 4 FHD (1920 x 1080) 120Hz Screens</li><li>Up to 4 QHD (2560 x 1440) 120Hz Screens</li><li>Up to 4 4K (3840 x 2160) 120Hz Screens</li><li>Up to 4 5K (5120 x 2880) 60Hz Screens</li><li>Up to 2 8K (7680 x 4320) 60Hz Screens</li>';
				document.getElementById('optPorts').innerHTML='<li>1 x HDMI Output</li><li>3 x DisplayPort Outputs</li>';
				document.getElementById('stars-gputops').innerHTML='1801';
				document.getElementById('txtPSU').innerHTML='BeQuiet 1000W Premium Quiet Power Supply';
				numQuiet = 20;
				numGPU = 20;
				break;
			} 
	...
	for (var i = 0; i < ddlop5.options.length; i++) {
		if (ddlop5.options[i].selected == true) {
			...
			if (ddlop5.options[i].id == 1) {
				document.getElementById('txtCPU').innerHTML='Intel i5 14600KF // 3.5 - 5.3GHz // 14C - 20T';
				...
				document.getElementById('txtCPU').innerHTML='Intel Core Ultra 7 265KF // 3.9 - 5.5GHz // 20C - 20T';
				document.getElementById('txtMB').innerHTML='Fast Z890 Chipset Motherboard';
				document.getElementById('txtCPUCool').innerHTML='BeQuiet Ultra Low Noise Air CPU Cooler';
				numSpeed = 18;
				numMulti = 20;
				numMulThr = 17;
				numQuiet = 20;
			} else if (ddlop5.options[i].id == 6) {
				document.getElementById('txtCPU').innerHTML='Intel Core Ultra 9 285KF // 3.7 - 5.7GHz // 24C - 24T';
				document.getElementById('txtMB').innerHTML='Fast Z890 Chipset Motherboard';
				document.getElementById('txtCPUCool').innerHTML='BeQuiet Ultra Low Noise Air CPU Cooler';
				numSpeed = 20;
				numMulti = 20;
	...
	for (var i = 0; i < ddlop7.options.length; i++) {
		if (ddlop7.options[i].selected == true) {
			...
			if (ddlop7.options[i].id == 0){
				...
				document.getElementById('txtSSD').innerHTML='1TB Kingston M.2 NVMe SSD (6000MBs/4000MBs)';
			} else if (ddlop7.options[i].id == 2) {
				document.getElementById('txtSSD').innerHTML='2TB WD M.2 NVMe SSD (7250MBs/6900MBs)';
			} else if (ddlop7.options[i].id == 3) {
				document.getElementById('txtSSD').innerHTML='4TB Kingston M.2 NVMe SSD (3500MBs/2800MBs)';
			}
		}
	}
	}
	...
	for (var i = 0; i < ddlop13.options.length; i++) {
		if (ddlop13.options[i].selected == true) {
			...
			if (ddlop13.options[i].id == 0){
				...
				document.getElementById('txtHDD2').innerHTML='<p id="pHDD2">1TB Adata M.2 NVMe SSD (3500MBs/3000MBs)</p>';
			} else if (ddlop13.options[i].id == 8) {
				document.getElementById('txtHDD2').innerHTML='<p id="pHDD2">2TB Adata M.2 NVMe SSD (3500MBs/3000MBs)</p>';
...
function flashGPU() {
	...
	$("#txtPSU").fadeIn(600).fadeOut(600).fadeIn(600).fadeOut(600).fadeIn(600).fadeOut(600).fadeIn(600);
