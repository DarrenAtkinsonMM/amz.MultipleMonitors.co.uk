...
<head>
<title>Do you want to run dual monitors off your current PC? - Multiple Monitors</title>
<meta name="Description" content="Select whether your want a new dual monitors capable PC or you wish to upgrade your current computer to support dual monitors. The Multiple Monitors Guide."/>
...
<div id="pageContent">
<div id="tool-page">
<h1>Do you already have a computer system?</h1>
<p>Are you looking for a new computer to support your dual monitor setup, or are you looking to use your current PC in conjunction with the two screens?</p>
<div class="tool-but">
  <a href="/guide/dual-q2/"><img src="/images/tools/dual-q1-yes.jpg" alt="I want to run dual monitors from my current PC" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but">
  <a href="/guide/dual-o5/"><img src="/images/tools/dual-q1-yes-2.jpg" alt="I want to use my laptop to run dual monitors" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but">
  <a href="/guide/dual-o1/"><img src="/images/tools/dual-q1-no.jpg" alt="I want to purchase a new computer for dual monitor support" width="210" height="184" class="tool-but-img" /></a></div>
<div id="tool-ans-top">
...
<p>If this is incorrect simply <a href="/guide/">restart the guide</a>.</p>
</div>
<div id="tool-ans-bot">
</div>
</div><!-- content-page -->
