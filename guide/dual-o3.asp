...
<head>
<title>USB to VGA Adapter | Multiple Monitors</title>
<meta name="Description" content="The USB to VGA Graphics Adapter outcome page accessed directly through the Multiple Monitors Guide."/>
...
<p>The easiest way to upgrade your current computer to run dual monitors is to purchase a USB - VGA adapter.</p>
<p>Simply plug in the adapter into a spare USB 2 port on your computer and connect the other end to one of your dual monitor inputs and you can instantly support dual screens on your current computer.</p>
