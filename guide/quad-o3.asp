...
<head>
<title>Quad Monitor USB Adapter - Multiple Monitors</title>
<meta name="Description" content="The easiest way to get your current PC which already supports dual monitors to support four separate screens is to install twin USB - VGA adapters."/>
...
<p>The easiest way to upgrade your current computer to run quad monitors is to purchase two USB - VGA adapters.</p>
<p>Simply plug in the adapters into spare USB 2 ports on your computer and connect the other ends to two of your quad monitor inputs, you can then support four screens using your existing dual monitor video card and the two USB adapters.</p>
<p>You should also be aware that these adapters can use extra CPU processing power so it is recommended that you have a relatively powerful computer to use this option.</p>
