...
<head>
<title>Do you want to run quad monitors off your current PC? - Multiple Monitors</title>
<meta name="Description" content="Answer to find out the options you have for upgrading to quad monitors using the Multiple Monitors Guide."/>
...
<p>Are you looking for a new computer to support your quad monitor setup, or are you looking to use your current PC in conjunction with the four screens?</p>
<div class="tool-spacer">
</div>
<div class="tool-but">
  <a href="/guide/quad-q2/"><img src="/images/tools/quad-q1-yes.jpg" alt="I want to upgrade my current computer to support quad monitors" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but"><a href="/guide/quad-o1/"><img src="/images/tools/quad-q1-no.jpg" alt="I want to purchase a new computer to run a quad display system" width="210" height="184" class="tool-but-img" /></a></div>
<div id="tool-ans-top">
