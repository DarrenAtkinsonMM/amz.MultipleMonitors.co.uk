...
<head>
<title>Quad Monitor Computer Upgrades - Multiple Monitors</title>
<meta name="Description" content="What upgrades are possible on a standard PC to enable support of four monitors? Brought to you by the Multiple Monitors Guide."/>
...
<p>Assessing the information provided by your answers you have a few options available to you in your quest to support quad monitors on your current computer:</p>
...
<p><strong>Install 2 New Graphics Cards</strong></p>
<p>Depending on your specific computer you may be able to support two internal graphics cards which in turn could each support two separate monitors. You would need two new cards and to remove the current one from your system.</p>
...
<p>A final piece of information for people who are looking to build their own system is that the nVidia SLI setup allows you to switch the output from one monitor to four separate ones in the software control panel.</p>
...
<p>If this is incorrect simply <a href="/guide/quad-q2/">go back a step</a> or <a href="/guide/">restart the guide</a>.</p>
</div>
<div id="tool-ans-bot">
</div>
  </div>
