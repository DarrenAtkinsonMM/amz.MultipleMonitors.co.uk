...
<head>
<title>Do you want to run triple monitors off your current PC? - Multiple Monitors</title>
<meta name="Description" content="Answer to find out the options you have for upgrading to triple monitors using the Multiple Monitors Guide."/>
...
<p>Are you looking for a new computer to support your triple monitor setup, or are you looking to use your current PC in conjunction with the three screens?</p>
<div class="tool-spacer">
</div>
<div class="tool-but">
  <a href="/guide/triple-q2/"><img src="/images/tools/triple-q1-yes.jpg" alt="I want to run triple monitors from my current PC" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but">
  <a href="/guide/triple-o1/"><img src="/images/tools/triple-q1-no.jpg" alt="I want to purchase a new computer for triple monitor support" width="210" height="184" class="tool-but-img" /></a></div>
<div id="tool-ans-top">
