...
<head>
<title>Can your PC support dual monitors? - Multiple Monitors</title>
<meta name="Description" content="Check to see if your PC can support dual monitors already, guides for Windows XP and Vista included."/>
...
<div id="tool-page">
<h1>Can you already support two monitors?</h1>
<p>To decide which route to go down when supporting triple monitors it is useful to know if you can already support dual monitors on your existing computer.</p>
<p>Please use one of our guides to check if your current system has this capability.</p>
<p><a href="/pop-xp-settings.htm?KeepThis=true&TB_iframe=true&height=334&width=576" class="thickbox">Windows XP Guide</a> | <a href="/pop-vista-settings.htm?KeepThis=true&TB_iframe=true&height=334&width=576" class="thickbox">Windows Vista Guide</a></p>
<div class="tool-spacer">
</div>
<div class="tool-but">
  <a href="/guide/triple-q3/"><img src="/images/tools/dual-q2-yes.jpg" alt="Yes my current computer can run dual monitors already" width="210" height="184" class="tool-but-img" /></a></div>
  <div class="tool-but"><a href="/guide/triple-o2/"><img src="/images/tools/dual-q2-no.jpg" alt="No, my current PC doesn't seem to support dual monitors" width="210" height="184" class="tool-but-img" /></a></div>
<div id="tool-ans-top">
