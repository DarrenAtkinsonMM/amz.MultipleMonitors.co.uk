...
<head>
<title>Laptop Dual Monitors - Multiple Monitors</title>
<meta name="Description" content="How to use dual or triple monitors with your laptop computer, from the Multiple Monitors Guide."/>
...
<div id="pageContent">
<div id="tool-page">
<img src="/images/tools/rextron-vga-usb.jpg" alt="Rextron USB - VGA Adapter" width="180" height="154" class="tools-img" />
<h1>Laptop USB - VGA Adapter</h1>
<p>If you wish to run a dual monitor display system from your laptop computer which will give you a total of 3 displays (2 x external and laptop main display), then the best choice would be to opt for a USB to VGA adapter.</p>
<p>The setup would require you to connect and install a small USB adapter on your laptop, you would then simply connect one of the dual monitor cables to the USB adapter and the other one to your laptops standard extra video port.</p>
<p>Having tested various USB - VGA adapters we recommend the <a href="/products/rextron-usb-vga/">Rextron USB Adapter</a> as it is easy to install and provides good, stable performance on both Windows XP and Vista. This item costs just &pound;60 inclusive of delivery and is available direct from Multiple Monitors.</p>
<p>See full <a href="/products/rextron-usb-vga/">Rextron USB - VGA Adapter product details</a>.</p>
<p>Please note, there are other solutions available to give your external monitors greater graphics power, however these are still fairly expensive options and are overkill for most scenarios we encounter.</p>
<div id="tool-ans-top">
...
<li>You would like to use your current laptop to run dual monitors</li>
</ul>
