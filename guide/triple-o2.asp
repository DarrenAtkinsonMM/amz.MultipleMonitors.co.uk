...
<head>
<title>Triple Monitors Upgrade Guide - Multiple Monitors</title>
<meta name="Description" content="Information and advice for upgrading your current PC to support triple monitor displays brought to you by the Multiple Monitors Guide."/>
...
<div id="pageContent">
<div id="tool-page">
<h1>Triple Monitor Upgrade Options</h1>
<p>Assessing the information provided by your answers you have a few options available to you in your quest to support triple monitors on your current computer:</p>
...
<p>If you decide to go down this route we recommend the nVidia NVS 440 graphics cards which are available from a few different vendors. You should be looking to pay around &pound;350 for the card alone.</p>
<p><strong>Install 2nd Graphics Card</strong></p>
<p>Depending on your specific computer you may be able to install a secondary graphics card, if you select one which supports 2 monitor outputs then you will have a system that can output to a triple screen display.</p>
...
<p><strong>Use Two USB - VGA Adapters</strong></p>
<p>USB - VGA adapters provide you with an extra monitor output using a standard USB 2 port. They are simple to install and work in both Windows 2000, XP and Vista, and most computers can use a maximum of six adapters to output to 6 extra monitors.</p>
<p>These adapters are great for use with computer programs that display mainly static information such as word processors, spreadsheets, emails and Internet browsing, but they are not recommended for more graphical applications such as video editing or 3D gaming.</p>
<p>We currently sell the <a href="/products/rextron-usb-vga/">Rextron USB - VGA adapter</a> for just &pound;60 including delivery costs, for more details check out our <a href="/products/rextron-usb-vga/">Rextron USB Adapter product details</a> page.</p>
<p><strong>nVidia SLI Configuration</strong></p>
<p>A final piece of information for people who are looking to build their own system is that the nVidia SLI setup allows you to switch the output from one monitor to four seperate ones in the software control panel.</p>
<p>This is useful to know when buying components, nVidia SLI setups are much easier to identify as they are generally labelled as such. This in turn gives you the confidence of knowing that the end solution will support the number of monitors you desire.</p>
<div id="tool-ans-top">
...
<li>You would like to use your current computer to run triple screens</li>
<li>Your current computer does not support dual screens</li>
</ul>
<p>If this is incorrect simply <a href="/guide/triple-q2/">go back a step</a> or <a href="/guide/">restart the guide</a>.</p>
</div>
<div id="tool-ans-bot">
</div>
  </div>
