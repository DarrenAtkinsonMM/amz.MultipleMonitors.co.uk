...
<head>
<title>Triple Monitor Usage - Multiple Monitors</title>
<meta name="Description" content="Select what type of programs you will use triple screens for, this will impact the solution required to upgrade your current computer."/>
...
<div id="pageContent">
<div id="tool-page">
<h1>What usage do you want from the screens?</h1>
<p>Depending on what content you want to view on your monitors, there are a couple of options available to help you support triple monitors on your current system.</p>
<div class="tool-spacer">
</div>
<div class="tool-but">
  <a href="/guide/triple-o3/"><img src="/images/tools/dual-q3-office.jpg" alt="I will use office based programs mainly" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but">
  <a href="/guide/triple-o4/"><img src="/images/tools/dual-q3-heavy.jpg" alt="I will require dedicated graphics power to each screen - heavy usage" width="210" height="184" class="tool-but-img" /></a></div>
<p class="tool-clear"><strong>Office Use:</strong> We class 'Office Use' as using standard office programs such as a word processor, spreadsheet program, or Internet and email usage. These types of programs put less strain on a computer when displaying their output.</p>
<p><strong>Heavy Use:</strong> We class 'Heavy Use' as using video editing software, high level graphics manipulation programs, playing '3D' games, or any other activity which requires the graphics card to display anything not '2D' in nature.</p>
<div id="tool-ans-top">
