...
<p>To decide which route to go down when supporting quad monitors it is useful to know if you can already support dual monitors on your existing computer.</p>
...
<div class="tool-but">
  <a href="/guide/quad-q3/"><img src="/images/tools/dual-q2-yes.jpg" alt="Yes my current computer can run dual monitors already" width="210" height="184" class="tool-but-img" /></a></div>
<div class="tool-but"><a href="/guide/quad-o2/"><img src="/images/tools/dual-q2-no.jpg" alt="No, my current PC doesn't seem to support dual monitors" width="210" height="184" class="tool-but-img" /></a></div>
<div id="tool-ans-top">
