...
<head>
<title>Triple Monitors USB Adapter - Multiple Monitors</title>
<meta name="Description" content="You can use a USB - VGA adapter to upgrade your current dual monitor capable computer to supporting 3 screens."/>
...
<h1>USB - VGA Adapter</h1>
<p>The easiest way to upgrade your current computer to run triple monitors is to purchase a USB - VGA adapter.</p>
<p>Simply plug in the adapter into a spare USB 2 port on your computer and connect the other end to one of your triple monitor inputs, you can then support three screens using your existing dual monitor video card and the USB adapter.</p>
...
<li>You will be running standard '2D' programs on your screens</li>
</ul>
