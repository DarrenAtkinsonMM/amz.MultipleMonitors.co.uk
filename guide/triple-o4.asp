...
<head>
<title>Triple Monitor Upgrade Paths - Multiple Monitors</title>
<meta name="Description" content="A collection of options which will enable your current PC to output a picture to three separate screens."/>
...
<p>Using the answers you have supplied we have determined the following options for you to consider in your attempt to run triple monitors:</p>
...
<p><strong>Use a USB - VGA Adapter</strong></p>
<p>USB - VGA adapters provide you with an extra monitor output using a standard USB 2 port. They are simple to install and work in both Windows 2000, XP and Vista, however they are primarily used for programs that require limited graphical output such as word processors, email applications or Internet browsing.</p>
<p>Although you have said you require extra graphics power to each screen, if you only intend to run more intensive programs on 2 of your screens whilst leaving the third for more mundane tasks then using a USB to VGA adapter could still be a cost effective option for you.</p>
...
<p>If this is incorrect simply <a href="/guide/triple-q3/">go back a step</a> or <a href="/guide/">restart the guide</a>.</p>
</div>
<div id="tool-ans-bot">
</div>
  </div>
