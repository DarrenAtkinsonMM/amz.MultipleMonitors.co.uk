...
imageData = getUserInput(Request.Form("hidImage"), 0)
tempPath = getUserInput(Request.Form("hidPath"), 0) '"/LiveEditor/images/"
filename= getUserInput(Request.Form("hidFile"), 0)
