function loadTxt() {
    ...
    document.getElementById("divNote1").innerHTML = "For info on HTML5 video see: <a href='http://www.w3schools.com/html/html5_video.asp' target='_blank'>www.w3schools.com/html/html5_video.asp</a>." +
