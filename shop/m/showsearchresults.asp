...
If len(getUserInput(request("idCategory"), 0))>0 Then
    newurl = rooturl & "viewcategories.asp" & "?idCategory=" & getUserInput(request("idCategory"), 0)
Else   
    newurl = rooturl & "showsearchresults.asp?" & Request.QueryString
End If
