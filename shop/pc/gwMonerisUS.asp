...
'*************************************************************************************
	...
	if strMessage<>"" then
        ...
        Session("backbuttonURL") = tempURL & "?psslurl=gwMonerisUS.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId")
	...
	<div class="pcMainContent">
            ...
            <div class="pcFormItem">
                ...
                <div class="pcInfoMessage">
                    Please verify your credit card billing address information below. This is the address that your credit card statement is mailed to. If you need to alter the postal code, please click on the <a href="onepagecheckout.asp"><%=dictLanguage.Item(Session("language")&"_GateWay_2")%></a> above to change your billing address.
                </div>                     
                <div class="pcFormItem">
                    <div class="pcFormLabel">Street number:</div>
                    <div class="pcFormField"><input name="avs_street_number" type="text" value="" size="10">
							&nbsp;&nbsp;Street Name: &nbsp;&nbsp;
							<input type="text" name="avs_street_name" value=""></div>
                </div>                 
                <div class="pcFormItem">
                    <div class="pcFormLabel">Postal Code:  </div>
                    <div class="pcFormField"><%=pcBillingPostalCode%></div>
                </div> 
