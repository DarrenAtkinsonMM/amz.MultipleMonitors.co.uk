...
storeAdminEmail=""
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf & dictLanguage.Item(Session("language")&"_adminMail_1") & (scpre + int(pIdOrder)) & "<br>" & vbcrlf & "<br>" & vbcrlf

' Order summary starts here ...
storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_2") & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & "===================" & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & pName & " " & pLName & "<br>" & vbcrlf

If Trim(pCustomerCompany) <> "" Then
	storeAdminEmail=storeAdminEmail & pCustomerCompany & "<br>" & vbcrlf
End If
storeAdminEmail=storeAdminEmail & paddress & "<br>" & vbcrlf
if paddress2 <> "" then
	storeAdminEmail=storeAdminEmail & paddress2 & "<br>" & vbcrlf
end if
storeAdminEmail=storeAdminEmail & pCity & ", "
storeAdminEmail=storeAdminEmail & pStateCode & " "
storeAdminEmail=storeAdminEmail & pzip & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & pCountryCode & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & pPhone & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & pEmail & "<br>" & vbcrlf
...
if session("pcSFCustFieldsExist")="YES" AND Session("idCustomer")<>0 then
	...
	For k=0 to ubound(pcArr,2)
		...
		if trim(pcArr(10,k))<>"" then
			storeAdminEmail=storeAdminEmail & pcArr(1,k) & ": " & pcArr(10,k) & "<br>" & vbcrlf
		end if
	Next
...
if Session("pcSFCRecvNews")="1" then
	storeAdminEmail=storeAdminEmail & "Signed up for the store newsletter" & "<br>" & vbcrlf
end if
...
if (Session("pcSFIDrefer")<>"") and (Session("pcSFIDrefer")<>"0") then
	...
	if not rstempObj.eof then
		pRefer=dictLanguage.Item(Session("language")&"_adminMail_3") & rstempObj("name") & "<br>" & vbcrlf
	end if
	set rstempObj=nothing
	storeAdminEmail=storeAdminEmail & pRefer & "<br>" & vbcrlf & "<br>" & vbcrlf
else
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
end if
...
storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_4") & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & "====================" & "<br>" & vbcrlf
If Trim(pshippingAddress) <> "" Then
	if pShippingFullName<>"" then
		storeAdminEmail=storeAdminEmail & pShippingFullName & "<br>" & vbcrlf
	end if
	if pShippingCompany<>"" then
		storeAdminEmail=storeAdminEmail & pShippingCompany & "<br>" & vbcrlf
	end if
	storeAdminEmail=storeAdminEmail & pshippingAddress & "<br>" & vbcrlf
	if pshippingAddress2<>"" then
		storeAdminEmail=storeAdminEmail & pshippingAddress2 & "<br>" & vbcrlf
	end if
	storeAdminEmail=storeAdminEmail & pshippingCity & ", "
	storeAdminEmail=storeAdminEmail & pshippingStateCode & " "
	storeAdminEmail=storeAdminEmail & pshippingZip & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & pshippingCountryCode & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & trim(pshippingPhone) & "<br>" & vbcrlf
Else
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_5") & "<br>" & vbcrlf
End if 
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & "Shipping Type: " & pTempDisShipType & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
...
if ubound(shipping)>1 then
	if NOT isNumeric(shipping(2)) then
		storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_6") & pShipmentDetails & "<br>" & vbcrlf
		Service=""
		Postage=0
	else
		Shipper=shipping(0)
...
If DFShow="1" AND pord_DeliveryDate <> "" Then
	storeAdminEmail=storeAdminEmail & DFLabel & ": " & pord_DeliveryDate & "<br>" & vbcrlf
End If

if Service<>"" then
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_7") & Service & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_35") & pOrdPackageNum & "<br>" & vbcrlf
end if
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
...
if instr(PaymentType,"FREE") AND len(PaymentType)<6 then
	...
	storeAdminEmail = storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_8") & paymentdetails(0) & "<br>" & vbcrlf
	
	'// Custom Field "paymnta_c.asp"
	if Session("pcSFpAccNum2") <> "" then
		storeAdminEmail = storeAdminEmail & trim(paymentdetails(0)) & ": " & Session("pcSFpAccNum2") & "<br>" & vbcrlf		
	end if
...
if gIDEvent<>"0" then
	...
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_36") & geName & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_37") & geDate & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_38") & gReg & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
end if
'GGG Add-on end
...
for k=0 to intArryCnt
	...
	if instr(pTempDiscountDetails,"- ||") then 
		...
		if (pdiscountAmt>0 OR pdiscountAmt=0) AND pIsNumeric=1 then
			storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_9") & pdiscountDesc & "<br>" & vbcrlf
		end if
	Else
		pdiscountAmt=0
	end if
...
set rs19=connTemp.execute(query)
	...
	if pdiscountAmt>0 then
		storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_9a") & pGCName & " (" & GCInfo(0) & ")" & "<br>" & vbcrlf
	end if
end if
Next
end if
...
If (int(piRewardValue) > 0) OR (int(piRewardPointsCustAccrued) > 0) then
	...
	If int(piRewardPointsCustAccrued) > 0 Then 'Accrued
		...
		storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_10") & int(piRewardPointsCustAccrued) & " " & RewardsLabel & dictLanguage.Item(Session("language")&"_adminMail_11") & scCurSign&money(iDollarValue) & "<br>" & vbcrlf
	End If
	If int(piRewardValue) > 0 Then
		storeAdminEmail=storeAdminEmail & scCurSign&money(piRewardValue) & dictLanguage.Item(Session("language")&"_adminMail_12") & RewardsLabel & "." & "<br>" & vbcrlf
	End If			
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
End If 
...
storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_adminMail_13") & "<br>" & vbcrlf & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & FixedField(10, "L", dictLanguage.Item(Session("language")&"_adminMail_16"))
storeAdminEmail=storeAdminEmail & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_18"))
storeAdminEmail=storeAdminEmail & FixedField(15, "R", dictLanguage.Item(Session("language")&"_adminMail_14"))
storeAdminEmail=storeAdminEmail & FixedField(15, "R", dictLanguage.Item(Session("language")&"_adminMail_15"))
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf

storeAdminEmail=storeAdminEmail & FixedField(80, "R", "====================================================================================================")
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
iSubtotal=0
...
Do While Not rsOrderDetails.EOF
	...
	storeAdminEmail=storeAdminEmail & FixedField(10, "L", pqty)
	...
	storeAdminEmail=storeAdminEmail & "BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB" & "<br>" & vbcrlf
	...
	if scBTO=1 then
		if pIdConfigSession<>"0" then
			...
			storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_34A"))
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ") & "<br>" & vbcrlf
			...
			for i=lbound(ArrProduct) to (UBound(ArrProduct)-1)
				...
				if (ccur(ArrValue(i))<>0) or ((((ArrQuantity(i)-clng(tmpMinQty)<>0) AND (tmpDefault=1)) OR ((ArrQuantity(i)-1<>0) AND (tmpDefault=0))) and (ArrPrice(i)<>0)) then
					...
					storeAdminEmail=storeAdminEmail & FixedField(30, "R", scCurSign & money((ArrValue(i)+UPrice)*pQty))
				else
					if tmpDefault=1 then
						storeAdminEmail=storeAdminEmail & FixedField(30, "R", dictLanguage.Item(Session("language")&"_defaultnotice_1"))
					end if
				end if
				storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
				dispStrLen = len(dispStr)-wrapPos
	...
	If len(pcv_strSelectedOptions)>0 Then
			...
			storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L","OPTIONS") & "<br>" & vbcrlf
			...
			For pcv_intOptionLoopCounter = 0 to pcv_intOptionLoopSize
				...
				if tempPrice="" or tempPrice=0 then
					storeAdminEmail=storeAdminEmail & FixedField(30, "R", " ")
					storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
				else 
					storeAdminEmail=storeAdminEmail & FixedField(30, "R", "")
					storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	...
	If len(xfdetails)>3 then
		...
		for q=lbound(xfarray) to ubound(xfarray)
			...
			if Instr(tStr,"<BR>") then
				...
				storeAdminEmail=storeAdminEmail & tStr & "<br>" & vbcrlf
			else
				storeAdminEmail=storeAdminEmail & FixedField(40, "L", tStr) & "<br>" & vbcrlf
			end if
			dispStrLen = len(dispStr)-wrapPos
			if inStr(dispStr,"<BR>")>0 then
			  if dispStrLen > 0 then
				...
				storeAdminEmail=storeAdminEmail & dispStr & "<br>" & vbcrlf
			else
				do while dispStrLen > 40
					dispStr = right(dispStr,dispStrLen)
	...
	storeAdminEmail=replace(storeAdminEmail,"BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB" & "<br>" & vbcrlf,tmpText1)
	if pcPrdOrd_BundledDisc>0 then
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_custOrdInvoice_36"))
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
		storeAdminEmail=storeAdminEmail & FixedField(15, "R","-" & scCurSign & money(pcPrdOrd_BundledDisc))  & "<br>" & vbcrlf
	end if
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	...
	if scBTO=1 then
		...
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_31"))
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", "-" & scCurSign & money(ItemsDiscounts))  & "<br>" & vbcrlf
		end if
		...
		if pIdConfigSession<>"0" then
			...
			storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_34"))
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ") & "<br>" & vbcrlf
			...
			for i=lbound(ArrCProduct) to (UBound(ArrCProduct)-1)
				...
				if ArrCValue(i)<>0 then
					storeAdminEmail=storeAdminEmail & FixedField(30, "R", scCursign & money(ArrCValue(i)))
				end if
				storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	...
	'======================================
		...
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_32"))
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", "-" & scCurSign & money(QDiscounts)) & "<br>" & vbcrlf
		end if
	...
	if cdblCmprTmp2<>cdblCmprTmp1 then
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_33"))
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", " ")
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money((pPrice*pqty)-cdbl(QDiscounts)-cdbl(ItemsDiscounts)+cdbl(Charges))) & "<br>" & vbcrlf
	end if
	...
	if not rsG.eof then
		...
		storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_39")) & "<br>" & vbcrlf
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", pGWOptName) & FixedField(15, "R", scCurSign & money(pGWPrice)) & "<br>" & vbcrlf
		storeAdminEmail=storeAdminEmail & FixedField(10, "L","") & FixedField(40, "L", dictLanguage.Item(Session("language")&"_adminMail_41")) & "<br>" & vbcrlf
		dispStr = pGWText
		storeAdminEmail=storeAdminEmail & FixedField(10, "L", "")
		tStr = dispStr
		wrapPos=40
...
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_20"))
storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(iSubTotal))
storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf

' processing fees ...
if paymentCharge<>0 then
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_21"))
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(paymentCharge))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
end if
...
if ptotalDiscounts>0 then
	if piRewardValue>0 then
		storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_22")&RewardsLabel&dictLanguage.Item(Session("language")&"_adminMail_23"))
	else
		storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_24"))
	end if
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", "-"&scCurSign & money(ptotalDiscounts))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
End If

'GGG Add-on start
If pGWTotal<>"0" Then
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_39"))
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(pGWTotal))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
End If
'GGG Add-on end
...
If Postage<>0 Then
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_26"))
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(Postage))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
End If

' Shipping & handling fees, when applicable ...
If serviceHandlingFee>0 Then
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_27"))
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(serviceHandlingFee))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
End If
...
if pord_VAT>0 then
	If ptaxAmount>"0" Then
		storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_orderverify_35"))
		storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(pord_VAT))
		storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	End If
else
	if isNull(ptaxDetails) OR trim(ptaxDetails)="" then 
		If ptaxAmount>"0" Then
			storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_25"))
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(ptaxAmount))
			storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
		End If
	else 
		...
		for i=0 to (ubound(taxArray)-1)
			...
			storeAdminEmail=storeAdminEmail & FixedField(65, "R", taxDesc(0)&":")
			storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(taxDesc(1)))
			storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
		next 
	end if
end if
...
' Grand total ...
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", "===============")
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", "===============")
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
	storeAdminEmail=storeAdminEmail & FixedField(65, "R", dictLanguage.Item(Session("language")&"_adminMail_28"))
	storeAdminEmail=storeAdminEmail & FixedField(15, "R", scCurSign & money(ptotal))
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf
...
If idAffiliate<>1 AND idAffiliate<>"" then
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf & dictLanguage.Item(Session("language")&"_adminMail_29")& idAffiliate
	storeAdminEmail=storeAdminEmail & "<br>" & vbcrlf & dictLanguage.Item(Session("language")&"_adminMail_30") & scCurSign & money(affiliatePay)
End If
...
IF DPOrder="1" AND pOrderStatus="3" then
	...
	do while not rs11.eof
		...
		if not rs.eof then
			...
			storeAdminEmail=storeAdminEmail & FixedField(80, "R", "====================================================================================================") & "<br>" & vbcrlf & "<br>" & vbcrlf
	
			storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_sendMail_28") & pProductName & "<br>" & vbcrlf & "<br>" & vbcrlf
			...
			if (pURLExpire<>"") and (pURLExpire="1") then
				if date()-(CDate(pprocessDate)+pExpireDays)<0 then
					storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_sendMail_30") & (CDate(pprocessDate)+pExpireDays)-date() & dictLanguage.Item(Session("language")&"_sendMail_31") & "<br>" & vbcrlf & "<br>" & vbcrlf
				else
					if date()-(CDate(pprocessDate)+pExpireDays)=0 then
						storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_sendMail_32") & "<br>" & vbcrlf & "<br>" & vbcrlf
					else
						storeAdminEmail=storeAdminEmail & dictLanguage.Item(Session("language")&"_sendMail_33") & "<br>" & vbcrlf & "<br>" & vbcrlf
					end if
				end if
			else
				storeAdminEmail=storeAdminEmail & ":" & "<br>" & vbcrlf & "<br>" & vbcrlf
			end if
			storeAdminEmail=storeAdminEmail & pdownloadStr & "<br>" & vbcrlf & "<br>" & vbcrlf
			...
			if (pLicense<>"") and (pLicense="1") then
				...
				if TempLicStr<>"" then
					...
					storeAdminEmail=storeAdminEmail & TempLicStr & "<br>" & vbcrlf
				end if
			end if
