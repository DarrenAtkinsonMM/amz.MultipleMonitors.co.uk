...
if request("PaymentSubmitted")="Go" then
	...
	If (strStatus <> 200) Then
		...
		elseif session("x_response_code")<>1 then
            ...
            Session("backbuttonURL") = tempURL & "?psslurl=gwAuthorizeCheck.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId") & "&ordertotal=" & pcBillingTotal
...
<div id="pcMain">
	<div class="pcMainContent">
        ...
        <form method="POST" action="<%=session("redirectPage")%>" name="PaymentForm" class="pcForms">
            ...
            <div class="pcFormItem"> 
                <%= dictLanguage.Item(Session("language")&"_gwAuthorizeCheck_18")%>
            </div>
            ...
            <div class="pcFormItem"> 
                <%= dictLanguage.Item(Session("language")&"_gwAuthorizeCheck_20")%>
            </div>
            ...
            <div class="pcInfoMessage">
                By clicking the button below, I authorize <%=scCompanyName%> to charge my account specified above on <%=Now() %> for the amount of <%=money(pcBillingTotal)%> for the contents of my cart in <%=scCompanyName%> store.
            </div>  
