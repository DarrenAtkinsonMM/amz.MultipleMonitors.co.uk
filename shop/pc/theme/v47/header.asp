...
<div id="pcHeaderContainer">
    ...
    <div id="pcHeader">
        ...
        <div id="pcHeaderRight">
			<span><img src="<%=pcf_getImagePath("theme/v47/images","pc11-sampleAd2.png")%>" width="134" height="50" alt="Hassle free returns"></span>
            <span><img src="<%=pcf_getImagePath("theme/v47/images","pc11-sampleAd1.png")%>" width="134" height="50" alt="Free shipping"></span>
        </div>
            </div>
        </div>
...
<div id="pcIconBarContainer">
    ...
    <div id="pcIconBar">
    	...
    	<div id="pcIconBarRight">
        	<span class="pcIconBarSeparator"><img src="<%=pcf_getImagePath("theme/v47/images","pc11-icon-callus.png")%>" alt="Call Us">Questions? Call us at 800.800.8000</span>
        	<%
			Dim pcMyAccountLink
			...
			%>
            <a href="custPref.asp"><img src="<%=pcf_getImagePath("theme/v47/images","pc11-icon-account.png")%>" alt="<%=pcMyAccountLink%>"></a><a href="custPref.asp" class="pcIconBarSeparator"><%=pcMyAccountLink%></a>
            <a href="checkout.asp"><img src="<%=pcf_getImagePath("theme/v47/images","pc11-icon-checkout.png")%>" alt="Checkout"></a><a href="checkout.asp">Checkout</a>
            <a href="contact.asp"><img src="<%=pcf_getImagePath("theme/v47/images","pc11-icon-contact.png")%>" alt="Contact Us"></a><a href="contact.asp">Contact Us</a>
            <a href="default.asp"><img src="<%=pcf_getImagePath("theme/v47/images","pc11-icon-home.png")%>" alt="Home"></a><a href="default.asp">Home</a>
        </div>
	</div>
