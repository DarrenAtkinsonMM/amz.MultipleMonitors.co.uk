            ...
            <div class="col-sm-2">
                <div class="brand">
                    <span itemscope itemtype="http://schema.org/Organization">
                    	<link itemprop="url" href="<%=scURLredirect%>">
                        <a href="default.asp">
                            <% if len(scCompanyLogo) > 0 then %>
                            	<link itemprop="logo" href="<%=pcf_getImagePath(scStoreURL & "/" & scPcFolder & "/pc/catalog",scCompanyLogo)%>">
                                <img src="<%=pcf_getImagePath("catalog",scCompanyLogo)%>" alt="<%= scCompanyName %>" />
                            <% else %>
...
<% If (InStr(lcase(Request.ServerVariables("SCRIPT_NAME")),"home.asp") > 0) Then %>
<div id="pc-slideshow">
	<div class="container"> 
		<div class="row">
