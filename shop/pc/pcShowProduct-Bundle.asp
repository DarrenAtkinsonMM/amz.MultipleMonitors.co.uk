...
Select Case Request.ServerVariables("PATH_INFO")
	Case "/shop/pc/CUSTOMCAT-bundles1.asp"
		bunHrefAdd = "/bundles-2/?sid=" & pIdProduct & "&mid=" & request.querystring("mid") & "&cid=" & request.querystring("cid")
		bunHrefMore = "/products/" & pUrl & "/?sid=" & pIdProduct & "&mid=" & request.querystring("mid") & "&cid=" & request.querystring("cid")
	Case "/shop/pc/CUSTOMCAT-bundles2.asp"
		bunHrefAdd = "/bundles-3/?sid=" & request.querystring("sid") & "&mid=" & pIdProduct & "&cid=" & request.querystring("cid")
		bunHrefMore = "/products/" & pUrl & "/?sid=" & request.querystring("sid") & "&cid=" & request.querystring("cid")
End Select
%>
