		...
		<div class="container">
            ...
            %>
						...
						<div class="further-info">
							...
							<a href="javascript:dimensionjump();void(0);" class="text-underline">View Stand Dimensions</a><br />
                            <a href="javascript:videojump();void(0);" class="text-underline">View Stand Assembly Videos</a>
						</div>
					</div>
				</div>
        <% ' START RIGHT COLUMN %>
				...
				<div class="col-sm-12 col-md-8">
					<div class="wow fadeInUp" data-wow-delay="0">
                        ...
                        %>
							...
							%>
							<a class="btn btn-skin btn-wc semi order-btn margintop-30" href="/shop/pc/instPrd.asp?idproduct=<%=pIdProduct%>">Add Stand To Your Basket <i class="fa fa-angle-right"></i></a>
                            <%
							else
								if request.querystring("arr") = 1 Then
								'We are building an array
								%>
							<a class="btn btn-skin btn-wc semi order-btn margintop-30" href="/display-systems-2/?sid=<%=pIdProduct%>&mid=<%=request.querystring("mid")%>">Add Stand To Your Array <i class="fa fa-angle-right"></i></a>
                                <%
								else
								'We must be on a bundle
								%>
							<a class="btn btn-skin btn-wc semi order-btn margintop-30" href="/bundles-2/?sid=<%=pIdProduct%>&mid=<%=request.querystring("mid")%>&cid=<%=request.querystring("cid")%>">Add Stand To Your Bundle <i class="fa fa-angle-right"></i></a>
                                <%
								end if
							end if
							%>
						...
						<div class="callaction">
							<div class="row">
								<div class="col-md-10">
									...
									<h3 class="h-light font-light disp-inline">&nbsp;Buy with Monitors &amp get free long length cables</h3>
									</div>
									</div>
								</div>
								<div class="col-md-2">
			...
			<div class="row">
				<div class="col-sm-12 specs-wrap wow fadeInUp" data-wow-delay="0.1s">
					<ul id="productSpecs" class="nav nav-tabs">
					   <li class="active pscustom-wide"><a href="#dimensions-tab" data-toggle="tab">Stand Dimensions</a></li>
					   <li class="pscustom-wide2"><a href="#specVideos" data-toggle="tab">Installation Videos</a></li>	
					</ul>
