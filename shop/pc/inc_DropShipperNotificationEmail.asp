...
query="SELECT DISTINCT ProductsOrdered.pcDropShipper_ID,pcDropShippersSuppliers.pcDS_IsDropShipper "
query = query & "FROM pcDropShippersSuppliers "
query = query & "INNER JOIN ProductsOrdered ON pcDropShippersSuppliers.idproduct=ProductsOrdered.idproduct "
query = query & "LEFT OUTER JOIN Products ON pcDropShippersSuppliers.idproduct = products.pcprod_ParentPrd "
query = query & "WHERE ProductsOrdered.idorder=" & qry_ID & tmpStr
