...
if request("PaymentSubmitted")="Go" then
	...
	if pcv_IntProtxApply3DSecure="3" then
	...
	if err.number<>0 then
		...
		if strPageError<>"" then
            ...
            call closeDb()
            Session("message") = strProtxErrorMsg
            Session("backbuttonURL") = tempURL & "?psslurl=gwProtxVSP.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId")
	...
	if strStatus="3DAUTH" then
		...
		if strStatus="OK" then
            ...
            call closeDb()
            Session("message") = strProtxErrorType&" - "&strProtxErrorMsg
            Session("backbuttonURL") = tempURL & "?psslurl=gwProtxVSP.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId")
            response.redirect "msgb.asp?back=1"
	...
	<div class="pcMainContent">
		...
		if strPageState="3DRedirect" then %>
                        ...
                        <div class="pcInfoMessage"> 
                            To increase the security of Internet transactions Visa and Mastercard have introduced 3D-Secure (like an online version of Chip and PIN). <br>
							  <br>
                            ...
                            <br><br>
                            <img src="<%=pcf_getImagePath("images","vbv_logo_small.gif")%>" alt="Verified by Visa"><BR><BR><img src="<%=pcf_getImagePath("images","mcsc_logo.gif")%>" alt="MasterCard SecureCode">
                        </div>  
				...
				%>
					...
					response.write "<SCRIPT > function OnLoadEvent() { document.form.submit(); }</" & "SCRIPT>" 		
        ...
        <% else %>
            ...
            <% End If %>
                    ...
                    <% call pcs_showBillingAddress %>
                        ...
                        <div class="daOPCCCformitem"> 
                            <div class="daOPCCCformlabel"><%=dictLanguage.Item(Session("language")&"_GateWay_12")%></div>
                            <div class="daOPCCCformfield">
            ...
            <div class="daOPCCCformitem">
                <div class="daOPCCCformlabel"><%=dictLanguage.Item(Session("language")&"_GateWay_7")%></div>
                <div class="daOPCCCformfield"><input type="text" name="CardNumber" value="" autocomplete="off"></div>
            </div>
            
					<% if pcv_StrProtxAmex=1 then %>
                    
                        <div class="daOPCCCformitem">
                            <div class="daOPCCCformlabel">Start Date:</div>
                            <div class="daOPCCCformfield">
					...
					<% if pcv_StrProtxMaestro=1 then %>
                        ...
                        <div class="daOPCCCformitem"> 
                            <div class="daOPCCCformlabel">Issue Number:</div>
                            <div class="daOPCCCformfield">
                                <input name="IssueNumber" autocomplete="off" type="text" size="6" maxlength="2">
					...
					<div class="daOPCCCformitem">
						<div class="daOPCCCformlabel"><%=dictLanguage.Item(Session("language")&"_GateWay_8")%></div>
						<div class="daOPCCCformfield"><%=dictLanguage.Item(Session("language")&"_GateWay_9")%> 
					...
					<% If pcv_CVV ="1" Then %>
                <div class="daOPCCCformitem">
                    <div class="daOPCCCformlabel"><%=dictLanguage.Item(Session("language")&"_GateWay_11")%></div>
                    <div class="daOPCCCformfield"><input name="CVV" type="text" id="CVV" value="" size="6" maxlength="4"></div>
                </div> 
                <div class="daOPCCCformitem">
                    <div class="daOPCCCformlabel">&nbsp;</div>
                    <div class="daOPCCCformfield"><img src="<%=pcf_getImagePath("images","CVC.gif")%>" alt="cvc code" width="212" height="155"></div>
                </div>
					<% End If %>

            <div class="daOPCCCformitem"> 
			    <div class="daOPCCCformlabel">Total Amount:</div>
                <div class="daOPCCCformfield"><%= scCurSign & money(pcBillingTotal)%></div> 
            </div>
					
            <div class="pcFormButtons daOPCCCButtons">
