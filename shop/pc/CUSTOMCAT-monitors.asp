				...
				<div class="row">
					<div class="col-md-6">
                         <div class="wow fadeInDown pt-headtext maxW-fix marginT-xlfix" data-wow-offset="0" data-wow-delay="0">
							<h1 class="">Monitors</h1>
							<h2 class="text-uppercase">WE HAVE <span class="color-sb">HANDPICKED</span> THIS SELECTION OF MONITORS AS THEY ARE <span class="color-sb">PERFECTLY SUITED</span> TO BEING USED IN A MULTI-SCREEN ARRAY</h2>
						 </div>
						 <div class="wow fadeInUp maxW-fix" data-wow-offset="0" data-wow-delay="0">
							<p class="home-head-text text-white text-justify">Monitors are an important part of your setup, choosing the right size and resolution will determine exactly how much room you actually get to lay your work out.</p>
						    <p class="home-head-text text-white text-justify">Buy with confidence knowing that the following screens are all guaranteed to work perfectly with our multi-screen stands and our range of multiple monitor computers.</p>
						</div>
                    </div>
					<div class="col-md-6">
                         <div class="wow fadeInRight text-center" data-wow-offset="0" data-wow-delay="0.1s">
							  <img src="/images/banners/monitors.png">
						 </div>
                    </div>
