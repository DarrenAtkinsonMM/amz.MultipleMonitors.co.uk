...
If pcv_intErr>0 Then
	response.redirect pcStrErrPage&"?msg=1&pagetype=" & pcv_pageType & "&idsds=" & pcv_idsds
Else
	'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	' START: Update
	'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
	query="UPDATE " & pcv_Table & "s SET " & pcv_Table & "_Username='" & Session("pcSFpcv_sdsUsername") & "'," & pcv_Table & "_Password='" & Session("pcSFpcv_sdsPassword") & "'," & pcv_Table & "_FirstName=N'" & Session("pcSFpcv_sdsFirstName") & "'," & pcv_Table & "_LastName=N'" & Session("pcSFpcv_sdsLastName") & "'," & pcv_Table & "_Company=N'" & Session("pcSFpcv_sdsCompany") & "'," & pcv_Table & "_Phone='" & Session("pcSFpcv_sdsPhone") & "'," & pcv_Table & "_Email='" & Session("pcSFpcv_sdsEmail") & "'," & pcv_Table & "_URL='" & Session("pcSFpcv_sdsURL") & "'," & pcv_Table & "_FromAddress=N'" & Session("pcSFpcv_sdsFromAddress") & "'," & pcv_Table & "_FromAddress2=N'" & Session("pcSFpcv_sdsFromAddress2") & "'," & pcv_Table & "_FromCity=N'" & Session("pcSFpcv_sdsFromCity") & "'," & pcv_Table & "_FromStateProvinceCode=N'" & pcv_sdsFromStateProvinceCode & "'," & pcv_Table & "_FromZip='" & Session("pcSFpcv_sdsFromZip") & "'," & pcv_Table & "_FromCountryCode='" & Session("pcSFpcv_sdsFromCountrycode") & "'," & pcv_Table & "_BillingAddress=N'" & Session("pcSFpcv_sdsBillingAddress") & "'," & pcv_Table & "_BillingAddress2=N'" & Session("pcSFpcv_sdsBillingAddress2") & "'," & pcv_Table & "_BillingCity=N'" & Session("pcSFpcv_sdsBillingCity") & "'," & pcv_Table & "_BillingStateProvinceCode=N'" & pcv_sdsBillingStateProvinceCode & "'," & pcv_Table & "_BillingZip='" & Session("pcSFpcv_sdsBillingZip") & "'," & pcv_Table & "_BillingCountryCode='" & Session("pcSFpcv_sdsBillingCountrycode") & "'," & pcv_Table & "_NoticeEmail='" & Session("pcSFpcv_sdsNoticeEmail") & "'," & pcv_Table & "_NoticeType=" & Session("pcSFpcv_sdsNoticeType") & "," & pcv_Table & "_NoticeMsg=N'" & Session("pcSFpcv_sdsNoticeMsg") & "'," & pcv_Table & "_NotifyManually=" & Session("pcSFpcv_sdsNotifyManually") & "," & pcv_Table & "_CustNotifyUpdates=" & Session("pcSFpcv_sdsCustNotifyUpdates")
...
response.redirect "sds_MainMenu.asp?msg=1" %>
