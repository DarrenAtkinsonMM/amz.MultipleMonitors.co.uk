...
%>
<%
'DA Edit - Jump logic for bundle breadcrumb modification
if not request.querystring("cid") = "" then
'We are on the choose PC page and have a PC selection already
		select case request.querystring("cid")
			Case 301
		response.redirect("/products/pro-multi-screen-pc/?sid=" & request.querystring("sid") & "&mid=" & request.querystring("mid") & "&cid=" & request.querystring("cid"))
			Case 306
		response.redirect("/products/ultra-multi-monitor-pc/?sid=" & request.querystring("sid") & "&mid=" & request.querystring("mid") & "&cid=" & request.querystring("cid"))
			Case 307
...
if request.querystring("sid") = "" then
	...
	if request.querystring("mid") = "" then
		Response.Status="301 Moved Permanently"
		Response.AddHeader "Location","/bundles-2/?sid=" & request.QueryString("sid")
		Response.End
	end if
end if

'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
' DA EDIT - Auto add price of correct graphics card option to PC prices	
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~	
'Work out screens supported by stand based on querystring
Select Case Request.Querystring("sid")
	Case 312
		'Triple
		pMonitorsNeeded = 3
		pProAdd = 45
...
pcv_PageName = "Trading Bundles &mdash; Choose Your PC | Multiple Monitors"
pcv_DefaultDescription = "Step 3 of the trading bundle builder. Pair your stand and monitors with a Trader PC or other multi-screen workstation. Bundle discount applied at checkout."
%>
