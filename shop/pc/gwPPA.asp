...
stext = "USER="&pcPay_PayPal_Username
stext = stext & "&VENDOR="&pcPay_PayPal_Vendor
...
End If
stext = stext & "&AMT="&pcv_strFinalTotal
	...
	<div class="pcMainContent">  
      ...
      <div class="pcErrorMessage"><%=myMsg%></div>
		...
		<div class="pcPayPalFrameContainer">
			<iframe class="pcPayPalFrame" id="PPAFrame" name="PPAFrame" src="https://payflowlink.paypal.com/?<%=ppmode%><%=iframeString%>" scrolling="no" width="490" height="565"></iframe>
		</div>
	</div>
</div>
