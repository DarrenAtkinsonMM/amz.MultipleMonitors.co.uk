...
IF request.Form("Submit")<>"" THEN
	...
	Else
		...
		mySQL="UPDATE affiliates SET affiliateName=N'" &Session("pcSFname")& "', affiliateEmail='" &Session("pcSFemail")& "'"
		
		if Session("pcSFcompany") <> "" then
			mySQL=mySQL & ", affiliatecompany=N'" &Session("pcSFcompany")& "'"
		end if
			mySQL=mySQL & ", affiliateaddress=N'" &Session("pcSFaddress")& "'"
		
		if Session("pcSFaddress2") <> "" then
			mySQL=mySQL & ", affiliateaddress2=N'" &Session("pcSFaddress2")& "'"
		end if
			mySQL=mySQL & ", affiliatecity=N'" &Session("pcSFcity")& "', affiliatestate=N'" &pcv_strStateOrProvince& "', affiliateCountryCode='" &Session("pcSFcountry")& "', affiliatezip='" &Session("pcSFzip")& "'"
		...
		response.redirect "AffiliateMain.asp?msg=1"
	...
	<div class="pcMainContent">
		...
		<div class="pcFormItem">
			<div class="pcFormItemFull">
				<%response.write dictLanguage.Item(Session("language")&"_NewAffa_1b")%>
			</div>
		</div>
		...
		<form method="post" name="addaffiliate" action="<%=pcStrPageName%>" onSubmit="return Form1_Validator(this)" class="pcForms">
			...
			<div class="pcShowContent">
				...
				<% '// Commission %>
				<div class="pcFormItem"> 
					<div class="pcFormLabel"><%=dictLanguage.Item(Session("language")&"_NewAffa_14")%></div>
					<div class="pcFormField">  
						<%=pcommission%>&nbsp;%
					</div>
				</div>
