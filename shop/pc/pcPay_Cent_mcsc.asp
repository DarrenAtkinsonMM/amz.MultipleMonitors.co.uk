...
<div id="pcMain">
	<div class="container-fluid">
        ...
        <div class="row">
            <div class="col-xs-12"><img height="44" alt="MasterCard® SecureCode" src="<%=pcf_getImagePath("images","pc_secureCode_logo.gif")%>" width="116"></div>
        </div>
	    <div class="row">
            <div class="col-xs-12">
        ...
        <div class="row">
            <div class="col-xs-3"><img height=43 alt=MasterCard src="<%=pcf_getImagePath("images","pc_mc_logo.gif")%>" width=72 align=left></div>
            <div class="col-xs-6">
                <p>To find out more about MasterCard SecureCode go to <a href="http://www.mastercardsecurecode.com" target="_blank">www.mastercardsecurecode.com</a> </p>
                <p>&nbsp;</p>
            </div>
            <div class="col-xs-3"><img height=43 alt="Maestro International" src="<%=pcf_getImagePath("images","pc_maestro_logo.gif")%>" width=72 align=left></div>		
        </div>
