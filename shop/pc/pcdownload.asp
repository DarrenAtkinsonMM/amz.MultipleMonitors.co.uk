...
<html>
<head>
<title><%= dictLanguage.Item(Session("language")&"_pcDownload_1")%></title>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">

<!--#include file="inc_theme.asp" -->

</head>
<body id="pcPopup">
<div id="pcMain" class="pcDownload">
	<div class="pcMainContent">
  	<div style="float: left; width: 70%;">
			<div class="pcSectionTitle">
				<%= dictLanguage.Item(Session("language")&"_pcDownload_1")%>
      </div>
    </div>
    
    <% If Len(scCompanyLogo) > 0 Then %>
      <div style="float: right">
        <img src="<%=pcf_getImagePath("catalog",scCompanyLogo)%>">
      </div>
    <% End If %>
