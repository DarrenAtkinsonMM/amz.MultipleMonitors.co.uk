<%'Start SDBA
	...
	query="select Products.Description,ProductsOrdered.quantity,Products.pcProd_ShipNDays FROM Products INNER JOIN ProductsOrdered ON products.idproduct=ProductsOrdered.idproduct WHERE ProductsOrdered.idOrder="& qry_ID & " AND (((Products.pcProd_BackOrder=1) AND (Products.stock<0) AND (Products.nostock=0)) OR (ProductsOrdered.pcPrdOrd_BackOrder=1));"
	pidorder=qry_ID
	set rsQ=connTemp.execute(query)
	
	if not rsQ.eof then
	
		pcv_BackOrderStr=pcv_BackOrderStr & FixedField(100, "R", "====================================================================================================") & "<br>" & vbcrlf
		...
		do while not rsQ.eof
			...
			pcv_BackOrderStr=pcv_BackOrderStr & "<br>" & vbcrlf & vbcrlf
			rsQ.MoveNext
		loop
		set rsQ=nothing
		pcv_BackOrderStr=pcv_BackOrderStr & vbcrlf & FixedField(100, "R", "====================================================================================================") & "<br>" & vbcrlf & vbcrlf
	end if
	set rsQ=nothing
