...
<!--#include file="bundle-breadcrumb.asp"-->
    ...
    <header id="pagetitle" class="pagetitle">
		<div class="pt-content bundle-pt-content">
			<div class="container">
				<div class="row">
				...
				<div class="col-sm-12 col-md-8">
					<div class="wow fadeInUp" data-wow-delay="0">
                        ...
                        %>
							...
							<div class="delivery-details bg-smog">
								...
								if daFunDelDateBlockTest(1,0) then
									'daDelEstimate = "Due to the Easter break, orders will be delivered on <strong class=""color"">" & daFunDelDateReturn(1,0) & "</strong>."
						   			daDelEstimate = "Due to the Easter holiday, orders will now be delivered on <strong class=""color"">" & daFunDelDateReturn(1,0) & "</strong>."
								Else
								...
								%>
                        		<p class="dcategory"><label class="rubric semi space-right10">UK :</label> <strong class="color">FREE DELIVERY</strong> | <%=daDelEstimate%></p>
                        		<p class="dcategory"><label class="rubric semi space-right10">International :</label> International shipping from just &pound;20 - <a data-toggle="lightbox" data-title="International Delivery" class="text-underline" href="/pop-pages/int-del-pop.asp?ProdID=<%=pidProduct%>&sid=<%=request.querystring("sid")%>&mid=<%=request.querystring("mid")%>">View Costs / Timescales</a></p>
							...
							<a class="btn btn-skin btn-wc semi order-btn margintop-30" href="javascript:specjump();">Customise &amp; Order Your New PC <i class="fa fa-angle-right"></i></a>
						</div>
					</div>
				</div>
			</div>
  ...
  <input name="index" type="hidden" value="1">
        <input type="hidden" name="idproduct1" value="<%=pidProduct%>">
        <input type="hidden" name="QtyM<%=pidProduct%>" value="1">
        <%=formBundleOptions%>
<% pcs_OptionsBUN %>
											...
											<div class="spec-content">
												<table width="100%" cellpadding="0" cellspacing="0" class="upgrades">
												   <tbody>
														<tr>
															<td><%=txtStandName%>:</td>
															<td align="right">&pound;<span id="standPrice"></span></td>
														</tr>
														<tr>
															<td><%=txtMonitorsName%>:</td>
															<td align="right">&pound;<span id="monitorsPrice"></span></td>
														</tr>
														<tr>
															<td>PC Base Price:</td>
														...
														<tr>
															...
															<td align="right">&pound;<span id="gpuPrice"></span></td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td align="right">&pound;<span id="bunDiscount"></span></td>
														</tr>
														<tr>
														...
														<tr>
															<td colspan="2" align="center">
																<input type="submit" value="ORDER YOUR BUNDLE NOW" class="btn btn-skin btn-sm text-uppercase" />
															</td>
														</tr>
												    </tbody>
												</table>
							...
							<div class="row spec-additions">
								...
								<div class="col-lg-3 col-sm-6 prd-additions prd-add4 wow fadeInLeft" data-wow-delay="0.6s">
									...
									<p>Order now and <span class="rubric">receive your computer on the morning of <%=daFunDelDateReturn(1,0) %>*</span>.</p>
									<p>We do NOT charge extra for this quick build or for a premium AM delivery.</p>
