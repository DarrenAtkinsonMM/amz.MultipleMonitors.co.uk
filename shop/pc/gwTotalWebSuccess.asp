...
Else
    ...
    call closeDb()
    Session("message") = "The transaction was declined."
    Session("backbuttonURL") = tempURL & "?psslurl=gwTotalWeb.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId")
