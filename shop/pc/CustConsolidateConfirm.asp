	...
	<div class="pcMainContent">
		...
		<%else%>
			...
			<div class="pcFormButtons">
				<button class="pcButton pcButtonSubmit" id="submit" name="go" onClick="location='login.asp?lmode=2';">
					<img src="<%=pcf_getImagePath("",rslayout("submit"))%>" alt="<%= dictLanguage.Item(Session("language")&"_opc_consconf_6")%>" />
					<span class="pcButtonText"><%= dictLanguage.Item(Session("language")&"_opc_consconf_6") %></span>
				</button>
			</div>
		<%end if%>
	</div>
