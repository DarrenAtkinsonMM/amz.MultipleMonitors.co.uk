...
'set rs23=connTemp23.execute(query)
...
'pcv_StrProtxTestmode=rs23("ProtxTestmode")
pcv_StrProtxTestmode=0
...
if strStatus="OK" then
	...
	response.redirect "msgb.asp?message="&server.URLEncode("<b>Error&nbsp;</b>:&nbsp;"&strProtxErrorType&" - "&strProtxErrorMsg&"<br><br><a href="""&tempURL&"?psslurl=gwProtxVSP.asp&idCustomer="&session("idCustomer")&"&idOrder="&session("GWOrderId")&"&amount="&request.QueryString("amount")&"""><img src="""&rslayout("back")&"""></a>")
