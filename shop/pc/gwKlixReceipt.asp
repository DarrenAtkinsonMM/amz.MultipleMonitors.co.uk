...
Else
    ...
    call closeDb()
    Session("message") = ssl_result&"&nbsp;&nbsp;"&lcase(ssl_result_message)
    Session("backbuttonURL") = tempURL & "?psslurl=gwklix.asp&idCustomer=" & session("idCustomer") & "&idOrder=" & session("GWOrderId")
