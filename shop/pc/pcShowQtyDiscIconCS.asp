...
%>
	...
	<div class="pcShowProductPromoDiscount">
		<a href="javascript:openbrowser('priceBreaks.asp?type=<%=Session("customerType")%>&amp;idproduct=<%=cs_pidProduct%>&amp;type=1')">
			<img src="<%=pcf_getImagePath("",rsIconObj("discount"))%>" alt="<%=dictLanguage.Item(Session("language")&"_viewPrd_16")%>" style="vertical-align: middle">
		</a>
	</div>
<% 
end if	
