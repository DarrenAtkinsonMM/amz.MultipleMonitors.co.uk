...
IF session("idCustomer")>0 then
	...
	If len(pcStrDefaultShipAddress)<1 Then
		...
		If NOT session("CustomerGuest")>0 Then
				pcShipArr="0|*|" & dictLanguage.Item(Session("language")&"_CustSAmanage_10") & "|*|" & rs("name") & "|*|" & rs("lastName") & "|*|" & rs("email") & "|*|" & rs("phone") & "|*|" & rs("fax") & "|*|" & rs("customerCompany") & "|*|" & rs("address") & "|*|" & rs("address2") & "|*|" & rs("city") & "|*|" & rs("state") & "|*|" & rs("stateCode") & "|*|" & rs("zip") & "|*|" & rs("countryCode") & "|*|" & rs("pcCust_Residential") & "|$|"
		End If	
	...
	Else
		...
		If (NOT session("CustomerGuest")=1 OR session("CustomerGuest")=2) AND (len(pcStrDefaultShipEmail)>0) Then
				pcShipArr="0|*|" & dictLanguage.Item(Session("language")&"_CustSAmanage_10") & "|*|" & rs("name") & "|*|" & rs("lastName") & "|*|" & pcStrDefaultShipEmail & "|*|" & pcStrDefaultShipPhone & "|*|" & pcStrDefaultShipFax & "|*|" & pcStrDefaultShipCompany & "|*|" & rs("shippingAddress") & "|*|" & rs("shippingAddress2") & "|*|" & rs("shippingCity") & "|*|" & rs("shippingState") & "|*|" & rs("shippingStateCode") & "|*|" & rs("shippingZip") & "|*|" & rs("shippingCountryCode") & "|*|" & rs("pcCust_Residential") & "|$|"
		End If
