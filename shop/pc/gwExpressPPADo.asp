...
'// To change this value from the default "Itemized Order"
...
'******************************************************************
'// Set to "Itemized Order" by Default
pcv_strItemizeOrder = 0
'******************************************************************
...
If ack=0 Then
	...
	if session("GWTransId") <> "" then
		...
		query="INSERT INTO pcPay_PFL_Authorize (idOrder, orderDate, amount, paySource, paymentmethod, transtype, authcode, captured, gwCode) VALUES ("&pcGatewayDataIdOrder&", '" & Date() & "', "&pcBillingTotal&", 'PayPalExp', '" & paymentMethod & "', '" & PaymentAction & "', '"&session("GWTransId")&"', 0, 80);"
