...
<table class="pcShowContent" cellpadding="4">
	<tr>
		<td colspan="2">
	...
	<tr>
		...
		<td width="69%">
			<select class="form-control" name="key2" size="1" onblur="javascript:srcImgsCount();">
	...
	<tr> 
		...
		<td width="69%">
			<input class="form-control" type=text name="key1" size="50" value="" onblur="javascript:srcImgsCount();">
		</td>
	</tr>
	
	<tr> 
		<td width="31%" align="left">Maximum Size (bytes):</td>
		<td width="69%">
			<input class="form-control" type=text name="key3" size="50" value="" onblur="javascript:srcImgsCount();">
		</td>
	</tr>
	
	<tr>
		<td width="31%" align="left">Images Uploaded Since:</td>
		<td>
			<input class="form-control" type=text name="key4" size="50" value="" onblur="javascript:srcImgsCount();" placeholder="06/01/2012">
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="center">
			<br>
			<input name="Submit" type="submit" class="btn btn-info" value="<%=src_Button1%>" id="searchSubmit" />
			<input name="Close" type="button" value="Close" onclick="JavaScript:window.close()" class="btn btn-default" />
			<% if session("srcImg_query") <> "" then %>
			    <input name="Submit2" type="submit" value="Repeat Last Search" id="Submit2" class="btn btn-default" />
			<% end if %>
		</td>
	</tr>
</table>
