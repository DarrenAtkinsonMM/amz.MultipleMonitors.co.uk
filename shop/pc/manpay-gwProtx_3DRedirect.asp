...
If scSSL="" OR scSSL="0" Then
	tempURL=replace((scStoreURL&"/"&scPcFolder&"/pc/manpay-gwProtx_3DCallback.asp"),"//","/")
	tempURL=replace(tempURL,"https:/","https://")
	tempURL=replace(tempURL,"http:/","http://") 
Else
	tempURL=replace((scSslURL&"/"&scPcFolder&"/pc/manpay-gwProtx_3DCallback.asp"),"//","/")
	tempURL=replace(tempURL,"https:/","https://")
	tempURL=replace(tempURL,"http:/","http://")
End If
...
<%  
	...
	response.write "<input type=""hidden"" name=""TermUrl"" value=""" & tempURL & "?VendorTxCode=" & strVendorTxCode & "&amount="&request.QueryString("amount")&"""/>"
