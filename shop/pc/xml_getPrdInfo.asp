...
<%response.end
end if%><!--#include file="../includes/common.asp"--><!--#include file="../includes/common_checkout.asp"--><% 
...
dim pIdProduct, pDescription, pPrice, pDetails, pListPrice, pLgimageURL, pImageUrl, pWeight, pSku ,pconfigOnly,pserviceSpec, pBtoBPrice, plistHidden, pArequired,pBrequired, pStock, pEmailText, pformQuantity, pnoshipping, pcustom1, pcustom2, pcustom3, pcontent1, pcontent2, pcontent3, pNoStock, psDesc, pnoshippingtext
...
tmpList=pDescription & "|||" & "<table class=""mainbox"">"
	...
	if pSmimageURL<>"" and pSmimageURL<>"no_image.gif" then
		...
		tmpList=tmpList & "<img src=""" & pcf_getImagePath("catalog",pSmimageURL) & """ >" & vbcrlf
