...
Body=Body & "private const scCompanyLogo="&q&"yourlogohere.png"&q&CHR(10)
...
if statusBTO="1" then
	...
	Body=Body & "private const iBTOShowMustIm=0"&CHR(10)
...
Body=Body & "private const scErrorHandler=1"&CHR(10)
...
Body=Body & "private const scDisplayQuickView=1"&CHR(10)
Body=Body & "private const scDisplayPNButtons=0"&CHR(10)
Body=Body & "private const scConURL=0"&CHR(10)
...
Body=Body & "private const scGAType=0" & CHR(10)
