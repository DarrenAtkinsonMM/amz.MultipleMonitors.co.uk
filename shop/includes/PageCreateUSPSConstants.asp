...
tUSPS_UserId=Session("ship_USPS_UserId")
tUSPS_AccessLicense=Session("ship_USPS_AccessLicense")
tUSPS_AddressValidation=Session("ship_USPS_AddressValidation")

If (len(tUSPS_UserId)=0) Then
...
Body=Body & "private const USPS_PM_FREOption="&q&tUSPS_PM_FREOption&q&CHR(10)
Body=Body & "private const USPS_Id="&q&tUSPS_UserId&q&CHR(10)
Body=Body & "private const USPS_AccessLicense="&q&tUSPS_AccessLicense&q&CHR(10)
Body=Body & "private const USPS_AddressValidation="&q&tUSPS_AddressValidation&q&CHR(37)&CHR(62)
