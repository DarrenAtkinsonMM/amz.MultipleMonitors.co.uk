...
%>
  <div class="pcFormItem" id="zone1<%=pcv_strCountryBox%>" style="display: none;"> 
    <div class="pcFormLabel" ID="Label<%=pcv_strCountryBox%>"><%=pcv_strSPFieldLabel%></div>
  ...
  <div class="pcFormItem" id="zone2<%=pcv_strCountryBox%>" style="display:;"> 
    <div class="pcFormLabel" ID="Label2<%=pcv_strCountryBox%>"><%=pcv_strSPFieldLabel%></div>
    <div class="pcFormField">		
...
Public Sub pcs_CountryDropdown
  ...
  <div class="pcFormItem">
		<div class="pcFormLabel"><%= dictLanguage.Item(Session("language")&"_CustAddModShip_8")%></div>
		<div class="pcFormField">
			<%
