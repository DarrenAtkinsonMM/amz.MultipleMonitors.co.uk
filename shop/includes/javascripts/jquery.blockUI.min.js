...
d.marginTop=0;else if(!a.centerY&&e){var f=a.css&&a.css.top?parseInt(a.css.top,10):0;d.setExpression("top","((document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop) + "+f+') + "px"')}})}g&&(a.theme?d.find(".ui-widget-content").append(g):d.append(g),(g.jquery||g.nodeType)&&b(g).show());(u||a.forceIframe)&&a.showOverlay&&n.show();if(a.fadeIn)f=a.onBlock?a.onBlock:v,n=a.showOverlay&&!g?f:v,f=g?f:v,a.showOverlay&&k._fadeIn(a.fadeIn,n),g&&d._fadeIn(a.fadeIn,
...
onBlock:null,onUnblock:null,onOverlayClick:null,quirksmodeOffsetHack:4,blockMsgClass:"blockMsg",ignoreIfBlocked:!1};var m=null,p=[]}"function"===typeof define&&define.amd&&define.amd.jQuery?define(["jquery"],l):l(jQuery)})();