...
h>p?"left":"left"==e&&d.left-h<k?"right":e;a.removeClass(f).addClass(e)}d=this.getCalculatedOffset(e,d,h,l);this.applyPlacement(d,e);this.hoverState=null;e=function(){c.$element.trigger("shown.bs."+c.type)};b.support.transition&&this.$tip.hasClass("fade")?a.one(b.support.transition.end,e).emulateTransitionEnd(150):e()}};d.prototype.applyPlacement=function(a,c){var e,d=this.tip(),f=d[0].offsetWidth,h=d[0].offsetHeight,l=parseInt(d.css("margin-top"),10),k=parseInt(d.css("margin-left"),10);isNaN(l)&&
