...
tSNW_WDW=Session("SNW_WDW")
tSNW_WDH=Session("SNW_WDH")

If (len(tSNW_TYPE)=0) Then
...
Body=Body & "private const SNW_WDW="&q&tSNW_WDW&q&CHR(10)
Body=Body & "private const SNW_WDH="&q&tSNW_WDH&q&CHR(10)
