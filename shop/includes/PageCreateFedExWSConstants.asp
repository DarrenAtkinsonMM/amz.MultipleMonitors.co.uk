...
FEDEXWS_PREFERRED_CURRENCY=Session("ship_FEDEXWS_PREFERRED_CURRENCY")
FEDEXWS_ONERATE=Session("ship_FEDEXWS_ONERATE")
FEDEXWS_SATURDAYDELIVERY=Session("ship_FEDEXWS_SATURDAYDELIVERY")
FEDEXWS_SATURDAYPICKUP=Session("ship_FEDEXWS_SATURDAYPICKUP")
FEDEXWS_DYNAMICINSUREDVALUE=Session("ship_FEDEXWS_DYNAMICINSUREDVALUE")
FEDEXWS_INSUREDVALUE=Session("ship_FEDEXWS_INSUREDVALUE")
FEDEXWS_CURRENCY=Session("ship_FEDEXWS_CURRENCY")
FEDEXWS_SMHUBID=Session("ship_FEDEXWS_SMHUBID")
FEDEXWS_ADDDAY=Session("ship_FEDEXWS_ADDDAY")

If (len(FEDEXWS_FEDEX_PACKAGE)=0) Then
...
Body=Body & "private const FEDEXWS_PREFERRED_CURRENCY="&q&FEDEXWS_PREFERRED_CURRENCY&q&CHR(10)
Body=Body & "private const FEDEXWS_ONERATE="&q&FEDEXWS_ONERATE&q&CHR(10)
...
Body=Body & "private const FEDEXWS_DYNAMICINSUREDVALUE="&q&FEDEXWS_DYNAMICINSUREDVALUE&q&CHR(10)
Body=Body & "private const FEDEXWS_INSUREDVALUE="&q&FEDEXWS_INSUREDVALUE&q&CHR(10)
Body=Body & "private const FEDEXWS_CURRENCY="&q&FEDEXWS_CURRENCY&q&CHR(10)
Body=Body & "private const FEDEXWS_SMHUBID="&q&FEDEXWS_SMHUBID&q&CHR(10)
...
if request.QueryString("refer")<>"" then
	...
	response.redirect "../"&scAdminFolderName&"/viewShippingOptions.asp"
end if
%>