...
' &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=400"></a>
	...
	' Marketing features
		...
		case 220
			pcStrTitle = "Allow Discount Codes when 'On Sale'"
			pcStrDetails = "This setting allows you to enable/disable discount codes when any item in the shopping cart contains a promotional offer."	
	...
	' Payment Options and Order Processing
		...
		' UPS Help
		case 320
			pcStrTitle = "UPS Packaging"
			pcStrDetails = "When using UPS packaging, select the packaging type from the drop-down list.<br><br>When using non-UPS packaging, select ""Your Packaging"", and then enter the dimensions manually.<br><br>For more information on packaging guidelines, please visit the <a target=""_blank"" href=""http://www.ups.com/content/us/en/resources/ship/packaging/index.html?WT.svl=SubNav"">Packaging and Supplies</a> page on the UPS site."

		case 321
			pcStrTitle = "UPS Package Weight"
			pcStrDetails = "Weight values may be given as whole numbers or as a real numbers with precision to the tenth. The fractional separator must be a &quot;.&quot;<br><br>Examples of valid values are 25, 25.6 and 25.0. Examples of invalid values are 25.05 and 25,6."

		case 322
			pcStrTitle = "Oversized and/or Large Packages"
			pcStrDetails = "<strong>OS1: </strong>Ground shipments will be declared OS1 when the dimensions are supplied and the length and girth combined exceeds 84&quot; and is equal to or less than 108&quot; and the package weighs less than 30 LBS.<br><br><strong>OS2: </strong>Ground shipments will be declared OS2 when dimensions are supplied and the length and girth combined exceeds 108&quot; and is equal to or less than 130&quot; and the package weighs less than 70LBS.<br><br><strong>OS3: </strong>Ground and Air shipments will be declared OS3/LP when dimensions are supplied and the length and girth combined exceeds 130&quot; and is equal to or less than 165&quot;.<br><br>For Ground shipments if the actual weight is less than 150 pounds, then the billable weight is 150 pounds. Air and 3 Day Select shipments will not be subject to a minimum billable weight."
		...
		case 413
			pcStrTitle = "Store settings: Enable &quot;Wish List&quot; Feature"
			pcStrDetails = "When this option is enabled, your customers will be able to save products to their accounts so that they may review them and purchase them at a later time." 
		...
		case 422
			pcStrTitle = "Store settings: Enable built-in Help Desk"
		...
		case 431
			...
			pcStrDetails = "When products are displayed in a list, you can specify whether you want the product part number (SKU) and a small product thumbnail to be displayed or not.<br><br>Technical Note: the product thumbnail used when products are shown in a list is a smaller version of the thumbnail image specified for the product (if any). The size of the thumbnail is controlled by the css/pcStorefront.css cascading style sheet (&quot;pcShowProductImageL&quot; and &pcShowProductImageM&quot; classes)."
			
		case 432
			pcStrTitle = "Store settings: default product sorting preference"
			pcStrDetails = "When products are displayed within a category, they are sorted according to the preference specified here. You may override this store-wide preference at the category level by either of the following methods: <ol><li>Selecting a category-specific default ordering. To do this, go to the Display Options tab in the category details page and choose a custom ordering default at the bottom of the page.</li><li>Manually set the order in which products should be displayed within the category. To do this, look for a category, select &quot;Products&quot; to view the products listed within the category, and sort the products using the corresponding input field.</li></ol>"
		...
		case 449
			pcStrTitle = "Non-Shipping Item"
			pcStrDetails = "<p>When the 'Non-Shipping Item' setting is active, the product is not considered a shipping product. The product weight, if any, is not added to the total weight for the order and if there are only 'Non-Shipping' products in the shopping cart, the shipping options page is skipped.</p><p>For example, a product such as a support plan or an hour of consulting service would be 'Non-Shipping' item.</p><p>The <u>Non-Shipping Text</u> message displayed on the product details page can be edited by editing the file 'includes/languages.asp' (look for the string 'viewprd_8').</p><p>If you want to create a 'Free Shipping' promotion, you can use electronic coupons (discount codes) that make specific shipping options free. You can limit the applicability of those coupons to specific products, categories of products, order amounts, etc. Please see the User Guide for more details.</p>"	
		...
		case 478
			pcStrTitle = "Managing Brands: Brand Images"
			pcStrDetails = "The <strong>small brand image</strong> is shown on the pages where the customer is &quot;browsing by brand&quot;, if the store has been set up to use brand images (if you set up your store to only list the brand names, the small brand image is not used).<br><br>The <strong>large brand image</strong> (if any) is used when the storefront is displaying products and/or sub-brand within the brand. It is shown at the top of the page, above the long brand description."
			
		case 479
			pcStrTitle = "Managing Brands: Brand Descriptions"
			pcStrDetails = "The <strong>short brand description</strong> is shown on the pages where the customer is &quot;browsing by brand&quot;, if the store has been set up to show one brand per row. If the store has been setup to show sub-brands with more than one per row, the short brand description is not used.<br><br>The <strong>long brand description</strong> is used when the storefront is displaying products and/or sub-brands within the brand. It is shown at the top of the page, below the large brand image (if any)."
			
		' Enforce Consistent URL

		case 480
			pcStrTitle = "Enforce Consistent URL"
			pcStrDetails = "This setting allows you to enforce a consistent URL format throughout your store based on the server and domain requirements of your site (e.g. always use 'www' in front of the Root Domain; or, never use 'www' and load each ProductCart page without it).<br/><br/>The enforced URL is the one you enter during setup of the site, or later change on the admin settings page. Before going live, be sure to update the store URL if you used a separate domain name for your testing site.<br/><br/><strong>WARNING: </strong> Changing this setting may cause issues such as lost carts or the inability to checkout if configured incorrectly. Be sure to read our Wiki page on using <a href='http://wiki.productcart.com/productcart/settings-general#secure_socket_layer_url_ssl' target='_blank'>SSL and domains</a> in ProductCart before you change this setting.<br/><br/>" 

		case 481
			pcStrTitle = "Enable Source Code Minification and Bundling"
			pcStrDetails = "Bundling and Minification are two techniques that can be used to improve page request load time by reducing the number of requests to the server and reducing the size of requested assets (such as CSS and JavaScript.) Visit <a href='http://www.asp.net/mvc/overview/performance/bundling-and-minification' target='_blank'>this 3rd-party site</a> to learn more."

		case 482
			pcStrTitle = "Enable JavaScript Optimization"
			pcStrDetails = "In broad terms, Javascript Optimization involves simplifying code, precomputing results which are repeatedly reused, and organizing code so more results can be reused. <a href='https://developers.google.com/speed/articles/optimizing-javascript' target='_blank'>Read more about this here</a>"

		case 483
			pcStrTitle = "Enable 'Keep Admin Session Alive' feature"
			pcStrDetails = "This setting will help prevent the scenario where your ProductCart Control Panel session times out after 20 minutes of inactivity, which can cause loss of work and data entered that hasn't been saved to the database. For example, you are in the middle of adding the Description and Pricing information for a new Product and get distracted for over 20 minutes (the default server timeout), only to come back to your computer to find that the original session has been terminated by the server and your data has been lost! Enabling this (Yes) will keep the session alive in the background."
				
		' Configurator
		
		case 500
			pcStrTitle = "Configurator: &quot;Default&quot; and &quot;Base&quot; prices"
			pcStrDetails = "A configurable product's &quot;<strong>Default Price</strong>&quot; is the price shown when customers browse the store (e.g. the price shown in a search, or on the Specials or New Arrivals pages).<br><br>This price is calculated as <strong>Base Price</strong> + <strong>Default Option Prices</strong>, where the last is the sum of the prices of the items selected as &quot;default&quot; when you assign configurable items to the configurable product (Locate a Configurable Product &gt; Configure).<br><br>The Base Price is set when adding/modifying a configurable product. It can also be set or edited for multiple configurable products at once using the &quot;<a href=""updBTOPrdPrices.asp"" target=""_blank"">Update Base Prices</a>&quot; feature." 
		...
		case 803
			pcStrTitle = "PayPal Express Checkout"
		...
		case 805
			pcStrTitle = "PayPal Payments Pro (Direct Payments)"
			pcStrDetails = "<p><strong>Test Mode: </strong>Visit <a href='https://developer.paypal.com' target='_blank'>PayPal's Developer Site</a> to obtain &quot;SandBox&quot; (Test) credentials. Do not use your real account information while test mode is enabled.</p>"
			
		case 806
			pcStrTitle = "PayPal Payments Pro"
			pcStrDetails = "<p><strong>NOTE:</strong>In the UK this gateway is known as Website Payments Pro.</p><p><strong>Partner Name:</strong> This should be the same partner name that's used when logging into your PayPal Payflow account.</p><p><strong>Merchant Login:</strong> This is the login name you created when signing up for Payflow.</p><p><strong>User:</strong> PayPal recommends entering a User Login here instead of your Merchant Login. You can set up a User profile in <a href='https://manager.paypal.com'>PayPal Manager</a>. This will enhance security and prevent service interruption should you change your Merchant Login password.</p><p><strong>Password:</strong> This is the password you created when signing up for Payflow or the password you created for API calls.</p><p><strong>Test Mode: </strong>Visit <a href='https://developer.paypal.com' target='_blank'>PayPal's Developer Site</a> to obtain &quot;SandBox&quot; (Test) credentials. Do not use your real account information while test mode is enabled.</p>"
			
			
		'Slideshow Feature
		
		case 850
			pcStrTitle = "Slide Dimensions"
			pcStrDetails = "<p>Set the <strong>width</strong> and <strong>height</strong> of the slideshow here. All slide images that you upload will be resized to these dimensions and the aspect ratio will be locked. <br><br> If you have uploaded slides already and change the dimensions here, you will be alerted to the slides that you need to re-upload. Simply click the ""Re-Upload"" link to update the slide.</p>"
		
		case 851
			pcStrTitle = "Transition Effect"
			pcStrDetails = "<p>This is the effect used by the <a href='http://dev7studios.com/plugins/nivo-slider' target='_blank'>Nivo Slider</a> jQuery plugin to transition between slides. The most popular effects to use for this plugin are the <strong>Random</strong>, <strong>Fade</strong>, and <strong>Fold</strong> effects.</p>"
	
		case 852
			pcStrTitle = "Pause Time"
			pcStrDetails = "<p>The number of <strong>Milliseconds</strong> to display each slide. <ul><li><strong>500 ms</strong> = half a second</li><li><strong>1000 ms</strong> = 1 second</li><li><strong>3000 ms</strong> = 3 seconds</li><li><strong>5000 ms</strong> = 5 seconds</li></ul></p>"
	
		case 853
			pcStrTitle = "Animation Speed"
			pcStrDetails = "<p>The number of <strong>Milliseconds</strong> that the slideshow will take to complete a transition between slides. To completely disable transition animations, set this field to 0. <br><br> Popular animation speed values are <strong>100 ms</strong> (fast), <strong>500 ms</strong> (medium), and <strong>1000 ms</strong> (slow).</p>"
	
	
		'Social & Payment Settings Page
		
		case 900
			pcStrTitle = "Social Links"
			pcStrDetails = "<p><strong>Description: </strong>These are the social links that appear on your storefront as icons (e.g., ""Like us on Facebook!"" and ""Follow us on Twitter!""). To display any social icon on your site simply include a <strong>Link</strong> to your associated social, blog, RSS, or web page. If no link is specified the icon will be hidden. <br><br><strong>Alt/Title: </strong>This customizes the <i>alt</i> and <i>title</i> tags of the image and link (respectively) for SEO and usability purposes. Whatever you specify here will be displayed in a tooltip to the user when hovered over. <br><br><strong>Custom Icon: </strong>This allows you to upload a social icon that will override the theme default. Simply click the <i>find</i> icon next to the field or specify an image name from your catalog directory. <br><br><strong>Display Order: </strong>You may also change the display order of social links on your storefront by clicking and dragging the logos on the left. </p>"
	
		case 901
			pcStrTitle = "AddThis Buttons"
			pcStrDetails = "<p>AddThis provides buttons that allow visitors to your store to easily share a page on social networks (such as Facebook or Twitter) or via email.</p><p>You can show the buttons either at the right of the page title (they are shown on the product details page, content pages, show specials, new arrivals, etc.) or below the Add To Cart button, on the product details page only.</p><p><strong>WARNING: This setting is overridden for any product that uses a custom (tabbed) layout. If you are using a custom product layout you can choose where to place these buttons by selecting the ""Add This Zone"" from the setup page.</strong></p><p>For more information about AddThis and to select the buttons code that best fits your needs, <a href=https://www.addthis.com/get/original-sharing-buttons?where=website&clickbacks=1&type=bm&bm=tb5&analytics=1 target=_blank>click here</a>.</p><p><strong>NOTE: this feature utilizes a 3rd-party service. For technical support on issues related to the AddThis service, please contact AddThis support at <a href=http://www.addthis.com/forum/ target=_blank>http://www.addthis.com/forum/</a></strong></p>"	
			
		case 902
			pcStrTitle = "Pinterest ""Pin It"" Button"
			pcStrDetails = "<p>Enabling this setting will add a Pinterest ""Pin It"" button next to the product ""More Details"" and ""Buy"" buttons on category display pages and next to the ""Add to Cart"" button on the product details page.</p><p>You may also customize where the pin counter appears in relation to the ""Pin It"" icon - either above, to the right, or not shown at all."
			
		case 903
			pcStrTitle = "Accepted Payment Types"
			pcStrDetails = "<p><strong>Description: </strong>These are the accepted ""credit card"" icons that appear on your storefront. Only items that you <strong>Enable</strong> will be displayed. <br><br><strong>Alt/Title: </strong>This customizes the <i>alt</i> and <i>title</i> tags of the image for SEO and usability purposes. Whatever you specify here will be displayed in a tooltip to the user when hovered over. <br><br><strong>Custom Icon: </strong>This allows you to upload a payment icon that will override the theme default icon. Simply click the <i>find</i> icon next to the field or specify an image name from your catalog directory. <br><br><strong>Display Order: </strong>You may also change the display order of accepted payment types on your storefront by clicking and dragging the credit card icons on the left. </p>"
	
		case 904
			pcStrTitle = "Keep Admin Session Alive"
			pcStrDetails = "<p><strong>Description: </strong>This setting will prevent the Windows Server Session from timing our after 20 minutes of inactivity, which eliminates the scenario (for example) where you are in the middle of adding a new Product to the Store but get interrupted by a phone call or other event, only to come back and find out that you have been logged out of the ProductCart Control Panel by the server and lost the previously entered data.</p>"
