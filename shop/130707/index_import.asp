...
<!--#include file="AdminHeader.asp"-->
    ...
    <form action="step2.asp" method="post" class="pcForms">
		<table class="pcCPcontent">
            ...
            <tr>
                <td colspan="2">
                    <p align="right"><input type="submit" name=Go value="Go to Step 2 >>" class="btn btn-primary"></p>
                </td>
            </tr>
            </table>
            </form>
	...
	%>
        ...
        <tr>
            <td colspan="2"><input class="btn btn-primary" type="submit" name="submit" value="Select"></td>
        </tr>
	</table>
	</form>
<%end if%>
