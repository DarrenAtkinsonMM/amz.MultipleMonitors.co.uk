...
<tr>
	...
	<td width="60%">
		<select size="1" name="T<%=validfields%>">
			...
			<option value="Pricing Category (1)">Pricing Category (1)</option>
			<option value="Pricing Category (2)">Pricing Category (2)</option>
			<option value="Pricing Category (3)">Pricing Category (3)</option>
			<option value="Pricing Category (4)">Pricing Category (4)</option>
			<option value="Pricing Category (5)">Pricing Category (5)</option>
            ...
            <option value="Alt Tag Text">Alt Tag Text</option>
            ...
            <option value="Hide Additional Images">Hide Additional Images</option>
			...
			<option value="Meta Tags - Title">Meta Tags - Title</option>
			<option value="Meta Tags - Description">Meta Tags - Description</option>
			<option value="Meta Tags - Keywords">Meta Tags - Keywords</option>
			
			<%if scBTO=1 then%>
			<option value="Hide Configurator Price">Hide Configurator Price</option>
			...
			<option value="Product Layout - Top Area">Product Layout - Top Area</option>
			<option value="Product Layout - Top-Left Area">Product Layout - Top-Left Area</option>
			<option value="Product Layout - Top-Right Area">Product Layout - Top-Right Area</option>
			<option value="Product Layout - Middle Area">Product Layout - Middle Area</option>
			<option value="Product Layout - Tabs Area">Product Layout - Tabs Area</option>
			<option value="Product Layout - Bottom Area">Product Layout - Bottom Area</option>

			<% If statusAPP="1" OR scAPP=1 Then %>
				<option value="Apparel product">Apparel product</option>
				<option value="Show out of stock items">Show out of stock items</option>
				<option value="Out of stock items message">Out of stock items message</option>
	
				<option value="Display type">Display type</option>
				<option value="Size chart text link">Size chart text link</option>
				<option value="Size chart description">Size chart description</option>
				<option value="Size chart image file">Size chart image file</option>
				<option value="Size chart image URL">Size chart image URL</option>
			<% End If %>
			
	<%if session("importT" & validfields)<>"" then%>
		<option value="<%=session("importT" & validfields)%>" selected><%=session("importT" & validfields)%></option>
    <%session("importT" & validfields)=""
	else
				FiName1=""
