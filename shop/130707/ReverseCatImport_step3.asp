...
'***** End of Generate Data Lines *****	
	...
	call pcs_SaveUTF8(strFile & tmpext,strFile & tmpext,tmp_HeadLine & VBCrLf & tmp_DataLine)
...
<tr>
	<td colspan="2">
		<input type="button" class="btn btn-default"  name="back" value="Start Again" onClick="javasccript:location='ReverseCatImport_step1.asp';">
	</td>
</tr>
<%ELSE%>
<tr>
