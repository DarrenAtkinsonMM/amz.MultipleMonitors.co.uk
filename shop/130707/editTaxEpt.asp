...
%>
    ...
    <tr> 
        ...
        <%end if%>
        <input type="button" class="btn btn-default"  name="addnew" value="Add New Rules" onclick="location='AddTaxEpt.asp';">&nbsp;
        <input type="button" class="btn btn-default"  name="goback" value="Manage Exemptions" onclick="location='manageTaxEpt.asp';">
