...
<form action="pushOrdersC.asp" method="post" name="form1" class="pcForms">
	<table class="pcCPcontent">
		...
		<tr> 
			<td align="center">
			<input type="button" class="btn btn-default"  name="viewOrders" value="View Orders for Consolidated Account" onClick="location.href='viewCustOrders.asp?idcustomer=<%=pcv_idtarget%>'">
			&nbsp;
            <input type="button" class="btn btn-default"  name="viewCust" value="Locate Another Customer" onClick="location.href='viewCusta.asp'">
			</td>
		</tr>
	</table>
</form>
