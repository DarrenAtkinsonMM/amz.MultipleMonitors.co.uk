...
if (sMode="Update") and (msg="") then
	...
	query="UPDATE discounts SET pricetodiscount="&pricetodiscount&",percentagetodiscount="&percentagetodiscount&",discountcode='"&discountcode&"',discountdesc=N'"&discountdesc&"', active="&active
	If expDate<>"" Then
			...
			<tr>
				<td colspan="3"><hr></td>
					...
					<td colspan="3" align="center">
						<input type="submit" name="submit1" value="Update" class="btn btn-primary" onClick="hForm.clicksav.value='1';">
			            ...
			            &nbsp;
			            <input type="button" class="btn btn-default"  name="discountHome" value="View All" onClick="document.location.href='adminDiscounts.asp'">
