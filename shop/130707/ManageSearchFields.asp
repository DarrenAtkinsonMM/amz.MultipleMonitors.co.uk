...
IF request("action")="update" then
	IF request("submit2")<>"" THEN
		...
		if not rsQ.eof then
			...
			query="INSERT INTO pcSearchFields (pcSearchFieldName,pcSearchFieldOrder,pcSearchFieldShow,pcSearchFieldCPShow,pcSearchFieldSearch,pcSearchFieldCPSearch) VALUES (N'" & SF_name & "'," & SF_order & "," & SF_show & "," & CP_show & "," & SF_showSEARCH & "," & CP_showSEARCH & ");"
			set rsQ=connTemp.execute(query)
			set rsQ=nothing
		...
		IF request("Count")<>"" then
			For k=1 to clng(Count)
				if request("C"&k)="1" then
					...
					query="UPDATE pcSearchFields SET pcSearchFieldName=N'" & SF_name & "',pcSearchFieldOrder=" & SF_order & ",pcSearchFieldShow=" & SF_show & ",pcSearchFieldCPShow=" & CP_show & ",pcSearchFieldSearch=" & SF_showSEARCH & ",pcSearchFieldCPSearch=" & CP_showSEARCH & " WHERE idSearchField=" & SF_id & ";"
					set rsQ=connTemp.execute(query)
					set rsQ=nothing
...
<%	query="SELECT idSearchField,pcSearchFieldName,pcSearchFieldOrder,pcSearchFieldShow,pcSearchFieldCPShow,pcSearchFieldSearch,pcSearchFieldCPSearch FROM pcSearchFields ORDER BY "& strORD &" "& strSort
	...
	<form name="form1" action="ManageSearchFields.asp?action=update" method="post" class="pcForms">
        ...
        <th valign="top" nowrap="nowrap">Order&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=453"></a><div style="margin: 2px 0 2px 0;"><a href="ManageSearchFields.asp?order=pcSearchFieldOrder&sort=ASC"><img src="images/sortasc_blue.gif" width="14" height="14" border="0" alt="Sort Ascending"></a><a href="ManageSearchFields.asp?order=pcSearchFieldOrder&sort=Desc"><img src="images/sortdesc_blue.gif" width="14" height="14" border="0" alt="Sort Descending"></a></div>
        </th>
<th valign="top" nowrap="nowrap">CP Search&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=454"></a>
        ...
        <th valign="top" nowrap="nowrap">SF Search&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=454"></a>
      ...
      <th valign="top" nowrap="nowrap">CP Details&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=455"></a>
      ...
      <th valign="top" nowrap="nowrap" colspan="2">SF Details&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=455"></a>
        ...
        <td align="center" colspan="8" style="padding-bottom: 20px;">
          ...
          &nbsp;
          <input type="button" class="btn btn-default"  name="button" value="Assign to Products" onClick="document.location.href='addSFtoPrds.asp?nav='">
          &nbsp;
          <input type="button" class="btn btn-default"  name="button2" value="Map to Export Fields" onClick="document.location.href='SearchFields_Export.asp'">          
          <%end if%>
          &nbsp;
          <input type="button" class="btn btn-default"  value="Back" onClick="document.location.href='ManageCFields.asp';">
          &nbsp;
          <input type="button" class="btn btn-default"  value="Help" onClick="window.open('http://wiki.productcart.com/productcart/managing_search_fields');">
        </td>
			</tr>
			<tr>
        	...
        	<a name="new">&nbsp;</a><br />
					...
					<tr>       
						<td>&nbsp;</td>
						<td><input type="submit" name="submit2" value="Add New" class="btn btn-primary" onClick="javascript: if (document.form1.new_fieldname.value=='') {alert('Please enter a value for Field Name'); document.form1.new_fieldname.focus();return(false)} else {return(true)};"></td>
					</tr>
			  </table>
       </td>
			</tr>
