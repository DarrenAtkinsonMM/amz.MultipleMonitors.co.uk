...
response.redirect "techErr.asp?error="&Server.Urlencode("Error generating product drop-down")
			...
			%>
					...
					<tr> 
						...
						<td>
							...
							tempURL2=replace(tempURL2,"https:/","https://")
							%>
		...
		<br>
		<form name="links" method="post" action="genLinksa.asp" class="pcForms">
		<table class="pcCPcontent">
			<tr> 
				<td colspan="2" class="pcCPspacer"></td>
			</tr>
			...
			<tr> 
				...
				<td>
					<%
					tempURL=replace((scStoreURL&"/"&scPcFolder&"/pc/viewcontent.asp"),"//","/")
					tempURL=replace(tempURL,"http:/","http://")
					tempURL=replace(tempURL,"https:/","https://")
					%>
