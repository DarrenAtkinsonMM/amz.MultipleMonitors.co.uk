...
<tr><td align="right"><input type="checkbox" name="C25" value="1" checked class="clearBorder"></td><td>Category Order</td></tr>
	...
	<tr>
		<td colspan="2"><input type="submit" name="submit" value=" Export categories " class="btn btn-primary" onclick="javascript: if (testCheckBox()) { return(confirm('You are about to export the selected categories fields. Are you sure you want to complete this action?')); } else { return(false); }"></td>
	</tr>
</table>
</FORM>
