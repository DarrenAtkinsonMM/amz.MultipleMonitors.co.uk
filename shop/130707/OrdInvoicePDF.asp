...
IF request.Form("GO")="Generate" THEN
	...
	While Not rs.EOF
		...
		pdf.SetCreator("ProductCart software - NetSource Commerce. (www.productcart.com)")
...
<%'START - Fees & Order Total%>
	...
	if pShowAdminComments = "YES" and pAdminComments<>"" then
		pAdminComments=ClearHTMLTags2(pAdminComments,0)
	...
	pdf.Output server.mappath("./" & tmpPDFFile),0,1
	%>
