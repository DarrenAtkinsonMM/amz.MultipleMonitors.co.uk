...
<div class="pcCPmessage">
	...
	select case cint(varmsg)
		...
		case 46
			response.write "It appears that the .NET Framework and related Libraries are not properly installed on your server, but these are required for the new, stronger encryption used by v5.2. Please contact your web host and ask them to promptly enable .NET on your site."
		case 47
			response.write "We have detected a compatibility issue. View our <a href='https://productcart.desk.com/customer/portal/articles/2530322-ssl-use-in-v5-2' target='_blank'>help desk</a> for more information about how to fix this error. "
		' End Customer Import Wizard
		
	end select

	if request.QueryString("bk")=1 AND isNumeric(request.QueryString("bk")) then
		response.write "<br><br><input type=""button"" name=""back"" value=""Back"" onClick=""javascript:history.back()"" class=""btn btn-default"">"
	end if %>
</div>
</div>
