...
if isNumeric(pidcustomcardrule) AND request.form("Update")="Update" then
	...
	mySQL="UPDATE customCardRules SET ruleName=N'"&pruleName&"',intruleRequired="&pintRuleRequired&", intlengthOfField="&pintLengthOfField&",intMaxInput="&pintMaxInput&" WHERE idCustomCardRules="&pidcustomcardrule&";"
