...
if request("action")="update" then
	...
	if pcv_Img1="" then
		pcv_Img1="smileygreen.png"
	end if
	pcv_Img2=request("Img2")
	if pcv_Img2="" then
		pcv_Img2="smileyred.png"
	end if
	pcv_Img3=request("Img3")
	if pcv_Img3="" then
		pcv_Img3="fullstar.png"
	end if
	pcv_Img4=request("Img4")
	if pcv_Img4="" then
		pcv_Img4="halfstar.png"
	end if
	pcv_Img5=request("Img5")
	if pcv_Img5="" then
		pcv_Img5="emptystar.png"
	end if
	...
	<table class="pcCPcontent">	
		<tr>
            ...
            <ul class="nav nav-tabs">
                <li class="active"><a href="#tabs-1" data-toggle="tab">Status &amp; General Settings</a></li>
                <li><a href="#tabs-2" data-toggle="tab">Write a Review Reminder</a></li>
                <li><a href="#tabs-3" data-toggle="tab">Rewards for Reviews</a></li>
            ...
            <div class="tab-content">
                                    ...
                                    <table id="rateByMarksTable" style="display: <%if pcv_RatingType<>"1" then%>none<%end if%>;" class="pcCPcontent">
                                        ...
                                        <tr> 
                                          ...
                                          <td>
                                            ...
                                            <br>
                                            <span class="pcSmallText" style="padding-left: 24px;">E.g. quality, comfort, value for the money, etc. <a href="http://wiki.productcart.com/productcart/products_reviews" target="_blank">Learn more</a> about how sub-ratings work.</span><br />
                    ...
                    <div id="tabs-3" class="tab-pane">
                        <table class="pcCPcontent">
                            ...
                            <tr valign="top"> 
                                ...
                                <td><input type="text" name="RewardForReviewURL" size="50" maxlength="255" value="<% = pcv_RewardForReviewURL %>"><span id="urlerr" style="color: #f00;"></span><br /><span class="pcSmallText"><br />Note: This could be a "content page". Please enter a full url (e.g. http://www.productcart.com/) </span></td>
                            </tr>
                            <tr valign="top"> 
				...
				<script type=text/javascript>
					...
					<%if request("tab")<>"" and IsNumeric(request("tab")) then%>
					    $pc( "#TabbedPanels2" ).tabs( "option", "active", <%=request("tab")%> );
					<%end if%>
                </script>
			</td>
		</tr>
		...
		<td align="center" colspan="2"> 
            <input type="submit" name="Submit" value="Update Settings" onclick="return(checkRatingType())" class="btn btn-primary">&nbsp;
            <input type="button" class="btn btn-default"  value="Manage Fields" onClick="location.href='prv_FieldManager.asp'">&nbsp;
            <input type="button" class="btn btn-default"  value="Bad Words" onClick="location.href='prv_ManageBadWords.asp'">&nbsp;
            <input type="button" class="btn btn-default"  value="Product-specific Settings" onClick="location.href='prv_SpecialPrd.asp'">&nbsp;
            <input type="button" class="btn btn-default"  value="Product Exclusions" onClick="location.href='prv_PrdExc.asp'">
			<script type=text/javascript>
		...
		<tr> 
            <td align="center" colspan="2"> 
                <input type="button" class="btn btn-default"  value="View Pending Reviews" onClick="location.href='prv_ManageRevPrds.asp?nav=1'">&nbsp;
                <input type="button" class="btn btn-default"  value="View Live Reviews" onClick="location.href='prv_ManageRevPrds.asp?nav=2'">&nbsp;                
