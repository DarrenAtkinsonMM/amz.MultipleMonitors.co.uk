...
PmAdmin=19
pageTitle = "ProductCart v5.02 to v5.03 - Database Update Completed"
Section = "" 
%>
	...
	<tr>
		<td>
            <div class="pcCPmessageSuccess">
                Your store database was successfully updated. The version number will be updated to v5.03 the next time you load any Control Panel page.
            </div>
            
            <div class="bs-callout bs-callout-info">
                <h4>Your database is upgraded, but you're not done yet!</h4>
                <p>                    
                    Improvements have been to the way email settings are saved.  In order to take advantage of the changes you will need to re-save your email settings.  To complete the update please <a href="emailSettings.asp">click here</a>, and then click any of the "Update" buttons to re-save your email settings. After re-saving the update is complete and you may return to the main menu. 
                </p>
            </div>
    </td>
  </tr>
