...
session("cp_revImport_extype")=request("ExType")
if session("cp_revImport_extype")="" then
	session("cp_revImport_extype")=0
end if
	...
	<td colspan="2">
		...
		<tr>
			<td>
				...
				src_DisplayType=1
				src_ShowLinks=0
				src_FromPage="ReverseImport_step1A.asp?fseparator=" & session("cp_revImport_fseparator") & "&cseparator=" & session("cp_revImport_cseparator") & "&ExType=" & session("cp_revImport_extype") & "&ExportSize=" & session("cp_ExportSize")
				src_ToPage="ReverseImport_step1A.asp?fseparator=" & session("cp_revImport_fseparator") & "&cseparator=" & session("cp_revImport_cseparator") & "&ExType=" & session("cp_revImport_extype") & "&ExportSize=" & session("cp_ExportSize")
				src_Button1=" Search "
