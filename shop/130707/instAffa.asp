...
response.redirect pcStrPageName&"?msg="&pcv_strGenericPageError
	Else
		...
		mySQL="INSERT INTO affiliates (affiliatename, affiliateEmail, affiliateaddress, affiliateaddress2, affiliatecity, affiliatestate, affiliateCountryCode, affiliatezip, affiliatephone, affiliatefax, affiliatecompany, commission,pcAff_Password,pcAff_Active,pcAff_website) VALUES (N'" &Session("pcAdminname")& "','" &Session("pcAdminemail")& "',N'" &Session("pcAdminaddress")& "',N'" &Session("pcAdminaddress2")& "',N'" &Session("pcAdmincity")& "',N'" &pcv_strStateOrProvince& "','" &Session("pcAdmincountry")& "','" &Session("pcAdminzip")& "','" &Session("pcAdminphone")& "','" &Session("pcAdminfax")& "',N'" &Session("pcAdmincompany")& "','" & pcommission & "','" & Session("pcAdminPassword") & "'," & pactive & ",'" &Session("pcAdminwebsite")& "')"
