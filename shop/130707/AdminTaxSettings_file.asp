...
<form name="form1" method="post" action="../includes/PageCreateTaxSettings.asp" class="pcForms">
	...
	<input type="hidden" name="refpage" value="AdminTaxsettings.asp">
        ...
        <table class="pcCPcontent">
            ...
            <tr> 
                <td colspan="2">
                	How do you know which sales tax rate applies to an order? Let ProductCart automatically locate the correct tax rate. <a href="http://www.productcart.com/support/updates/taxlink.asp" target="_blank">Order an updated sales tax rates file</a>, which can help you apply the correct sales tax to your customers' orders.
                <a href="http://wiki.productcart.com/productcart/tax_data_file" target="_blank"><img src="images/pcv3_infoIcon.gif" width="16" height="16" alt="More information on this topic" border="0"></a></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><a href="http://www.productcart.com/support/updates/taxlink.asp" target="_blank"><strong>Order</strong> an updated tax file (or find out whether you need one)</a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                	<table width="100%" border="0" cellspacing="0" cellpadding="4">
						<tr> 
                          <td colspan="6">
                          Fallback Tax Rate <a href="http://wiki.productcart.com/productcart/tax_data_file#configuring_productcart_s_tax_module" target="_blank"><img src="images/pcv3_infoIcon.gif" alt="Fallback tax rates" width="16" height="16" border="0"></a></td>
                		</tr>
							<% 
                            ...
                            <tr>
                                ...
                                <tr> 
                                  <td colspan="6">
								  	<% if tShowInfo=1 then %>
                                    	<input type="button" class="btn btn-default"  name="Update" value="Add Fallback State Tax Rate" onClick="newWindow2('AddTaxRateState_popup.asp','window2')" class="btn btn-primary"> 
                                    <% else %>
                                    	<input type="button" class="btn btn-default"  name="Update" value="Add New Fallback State Tax Rate" onClick="newWindow2('AddTaxRateState_popup.asp','window2')" class="btn btn-primary"> 
                                    <% end if %>
                                   </td>
                                </tr>
                              </table>
