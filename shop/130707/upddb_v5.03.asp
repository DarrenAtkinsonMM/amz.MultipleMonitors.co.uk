<% 
PmAdmin=19
pageTitle = "ProductCart v5.02 to v5.03 - Database Update" 
Section = "" 
%>
...
IF request("action")="sql" then
	if request("hmode")="2" then
		...
		if SSIP="" or UID="" or PWD="" then
			call closeDb()
            response.redirect "upddb_v5.03.asp?mode=3"
			response.End
		end if
		...
		if instr(ucase(scDSN),"DSN=") then
			call closeDb()
            response.redirect "upddb_v5.03.asp?mode=1"
			response.End
		end if
...
<form action="upddb_v5.03.asp" method="post" name="form1" id="form1" class="pcForms">
<%
if mode="complete" then
	call closeDb()
	response.redirect "upddb_v5.03_complete.asp?CanUpd=" & CanUpd
	response.end()	
else 
%>
	<table class="pcCPcontent" style="width:600px;" align="center">
		...
		<tr>
			<td>
                ...
                <h1 class="page-header">Welcome to ProductCart 5.03</h1>
                <p class="lead">
                    ProductCart 5.03 is a service patch containing miscellaneous bug fixes and improvements for ProductCart v5.02. 
                    Be sure to read the <a href="https://productcart.desk.com/customer/portal/articles/1701404-updating-productcart-v5-02-to-v5-03-" target="_blank">v5.03 Update Guide</a>.
                </p>
                    ...
                    <div class="bs-callout bs-callout-info">
                        <h4>Read Me</h4>
                        <p>
                            Click "Update Now" to update your MS SQL Database to v5.03.  
                        </p>
                    </div>              
