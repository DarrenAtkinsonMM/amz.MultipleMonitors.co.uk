...
<% 
dim f, pIdAffiliate, pDescription, pDetails, pPrice, pImageUrl, pListPrice, pstock, psku, plisthidden, pactive, pweight
...
response.redirect pcStrPageName&"?idAffiliate="& pIDAffiliate &"&msg="&pcv_strGenericPageError
	Else
		...
		mySQL="UPDATE affiliates SET affiliateName=N'" &Session("pcAdminname")& "', affiliateEmail='" &Session("pcAdminemail")& "'"
		
		if Session("pcAdmincompany") <> "" then
			mySQL=mySQL & ", affiliatecompany=N'" &Session("pcAdmincompany")& "'"
		end if
			mySQL=mySQL & ", affiliateaddress=N'" &Session("pcAdminaddress")& "'"
		
		if Session("pcAdminaddress2") <> "" then
			mySQL=mySQL & ", affiliateaddress2=N'" &Session("pcAdminaddress2")& "'"
		end if
			mySQL=mySQL & ", affiliatecity=N'" &Session("pcAdmincity")& "', affiliatestate=N'" &pcv_strStateOrProvince& "', affiliateCountryCode='" &Session("pcAdmincountry")& "', affiliatezip='" &Session("pcAdminzip")& "'"
