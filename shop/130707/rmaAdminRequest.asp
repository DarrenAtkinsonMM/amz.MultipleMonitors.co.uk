...
query="INSERT INTO PCReturns (rmaNumber,rmaReturnReason,rmaDateTime,idOrder,rmaIdProducts,rmaApproved) VALUES ('" &pRmaNumber& "',N'" &pRmaReturnReason& "','"&pRMADate&"',"&pIdOrder&",'"&pIdProduct&"',"&pRmaApproved&")"
