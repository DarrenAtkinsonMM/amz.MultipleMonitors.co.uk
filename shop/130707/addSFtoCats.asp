...
%>
	...
	if not rs.eof then
		...
		<tr> 
			<td height="10"></td>
			<td> 
			<input type="submit" name="submit0" value="Continue" class="btn btn-primary">
			&nbsp;
...
<input name="nav" type="hidden" value="<%=nav%>">
	<table class="pcCPcontent">
        ...
        <tr>       
            <td>&nbsp;</td>
            <td> 
                <input type="submit" name="submit2" value="Add New" class="btn btn-primary" onClick="javascript: if (document.form1.new_fieldname.value=='') {alert('Please enter a value for Field Name'); document.form1.new_fieldname.focus();return(false)} else {return(true)};"></td>
        </tr>
  </table>
</form>
