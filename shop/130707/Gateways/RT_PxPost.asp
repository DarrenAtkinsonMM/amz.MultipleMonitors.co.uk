...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	query="UPDATE payTypes SET pcPayTypes_processOrder=" & pcv_processOrder & ",pcPayTypes_setPayStatus=" & pcv_setPayStatus & ", priceToAdd="&priceToAdd&" ,percentageToAdd="&percentageToAdd&" ,paymentNickName=N'"&paymentNickName&"' WHERE gwCode=47"
	set rs=Server.CreateObject("ADODB.Recordset")     
	set rs=conntemp.execute(query)
	if err.number <> 0 then
		strErrorDescription=err.description
...
response.redirect "techErr.asp?err="&pcStrCustRefID
	...
	query = ""
	query="INSERT INTO payTypes (pcPayTypes_processOrder,pcPayTypes_setPayStatus,paymentDesc, sslURL, active, Cbtob, quantityFrom, quantityUntil, weightFrom, weightUntil, priceFrom, priceUntil,ssl,priceToAdd, percentageToAdd,gwCode,paymentNickName) VALUES (" & pcv_processOrder & "," & pcv_setPayStatus & ",'PaymentExpress','gwPaymentExpress.asp',-1,0,0,9999,0,9999,0,9999,-1,"& priceToAdd &","&percentageToAdd&",47,N'"&paymentNickName&"')"
	set rs=Server.CreateObject("ADODB.Recordset")     
	set rs=connTemp.execute(query)
        ...
        <tr>
            <td>
                <div class="bs-callout bs-callout-info">
                    ...
                    <p>DPS is a high growth, innovative global leader in payment technology. Providing PCI DSS compliant payment solutions under the Payment Express brand.</p>
                    <p>
                        <a class="btn btn-info btn-xs" href="http://www.paymentexpress.com/Technical_Resources/Ecommerce_NonHosted/PxPost.aspx" target="_blank">Learn More</a>        
                    </p>
                </div>
            ...
            <td>
                ...
                <tr> 
                    ...
                    <select name="pcPay_PaymentExpress_TransType">
                        <option value="SALE" <%if pcPay_PaymentExpress_TransType="SALE" then%>selected<%end if%>>Sale</option>
