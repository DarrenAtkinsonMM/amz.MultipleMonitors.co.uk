...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	query="UPDATE payTypes SET pcPayTypes_processOrder=" & pcv_processOrder & ", sslURL='"&ProtxURL&"', pcPayTypes_setPayStatus=" & pcv_setPayStatus & ",priceToAdd="& priceToAdd &" , percentageToAdd="& percentageToAdd &", paymentNickName=N'"&paymentNickName&"' WHERE gwCode=26"
        ...
        <tr>
            <td>
                <div class="bs-callout bs-callout-info">
                    <h4>SagePay</h4>    
                    <p>Security and service is at the heart of Sage Pay's business so that you can depend on us for fast, secure and reliable payments.</p>
                    <p>
                        <a class="btn btn-info btn-xs" href="http://www.sagepay.com" target="_blank">Learn More</a>        
                    </p>
                </div>
            ...
            <td>
                ...
                <tr> 
                    ...
                    <td> <select name="TxType">
                            <option value="PAYMENT" <% if TxType="PAYMENT" then%>selected<% end if %>>Sale</option>
