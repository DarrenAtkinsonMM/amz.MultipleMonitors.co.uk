...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	query="UPDATE payTypes SET pcPayTypes_processOrder=" & pcv_processOrder & ",pcPayTypes_setPayStatus=" & pcv_setPayStatus & ",priceToAdd="& priceToAdd &" , percentageToAdd="& percentageToAdd &", paymentNickName=N'"&paymentNickName&"' WHERE gwCode=56"
...
response.redirect "techErr.asp?err="&pcStrCustRefID
	...
	query="INSERT INTO payTypes (pcPayTypes_processOrder,pcPayTypes_setPayStatus,paymentDesc, sslURL, active, Cbtob, quantityFrom, quantityUntil, weightFrom, weightUntil, priceFrom, priceUntil,ssl,priceToAdd, percentageToAdd,gwCode,paymentNickName) VALUES (" & pcv_processOrder & "," & pcv_setPayStatus & ",'VirtualMerchant','gwVMPay.asp',-1,0,0,9999,0,9999,0,9999,-1,"& priceToAdd &","&percentageToAdd&",56,N'"&paymentNickName&"')"
	set rs=Server.CreateObject("ADODB.Recordset")     
	set rs=connTemp.execute(query)
	if err.number<>0 then
		call LogErrorToDatabase()
        ...
        <tr>
            <td>
                <div class="bs-callout bs-callout-info">
                    <h4>VirtualMerchant</h4>    
                    <p>Elavon VirtualMerchant (formerly known as Nova ViaKlix) is a complete, hosted payment solution for e-commerce transactions.</p>
                    <p>
                        <a class="btn btn-info btn-xs" href="https://www.myvirtualmerchant.com" target="_blank">Learn More</a>        
                    </p>
                </div>
            ...
            <td>
                ...
                <tr> 
                    ...
                    <td> <select name="pcPay_VM_TransType">
                            <option value="CCSALE" <% if pcPay_VM_TransType="CCSALE" then%>selected<% end if %>>Sale</option>
