...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	query="UPDATE payTypes SET pcPayTypes_processOrder=" & pcv_processOrder & ",pcPayTypes_setPayStatus=" & pcv_setPayStatus & ",priceToAdd="& priceToAdd &" , percentageToAdd="& percentageToAdd &", paymentNickName=N'"&paymentNickName&"' WHERE gwCode=58"
	set rs=Server.CreateObject("ADODB.Recordset")     
	set rs=conntemp.execute(query)
	set rs=nothing
	if err.number <> 0 then
        ...
        <tr>
            <td>
                <div class="bs-callout bs-callout-info">
                    ...
                    <p>Service. Driven. Commerce</p>
                    <p>
                        <a class="btn btn-info btn-xs" href="http://www.globalpaymentsinc.com" target="_blank">Learn More</a>        
                    </p>
                </div>
