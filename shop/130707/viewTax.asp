...
<form method="POST" action="product_action.asp" class="pcForms">
	<table class="pcCPcontent">
		...
		%>
				...
				<td width="5%"><%=FormatPercent(rsTaxPrd("taxPerProduct"),3,0,0,0) %></td>
...
%>
	<form method="POST" action="product_action.asp" class="pcForms">
		<table class="pcCPcontent">
			...
			<tr> 
				<td colspan="8"><div style="float: right; padding-top: 8px;"><a href="AddTaxPerZone.asp">Add new</a></div><h2>Tax Rules by Zone&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=450"></a></h2></td>
			</tr>
			<% If rsTaxZone.eof Then %>
				<tr> 
					<td colspan="8">No tax rules have been set. <br />A <strong>zone</strong> is a &quot;group&quot; of locations. For example, a group of states or provinces might share the same tax.&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=450">More details</a>.</td>
				</tr>
