...
if pcv_FormAction = "send" then
    ...
    If request.Form("format")="0" Or request.Form("format")="1" Then
       ...
       response.write "<script type=text/javascript>window.opener.document.hForm.sendreviewreminderformat[0].checked="
	...
	<% end if	
		...
		<tr> 
			<td colspan="2" align="center"><input type="submit" value="Send Test Message" class="btn btn-primary"></td>
		</tr>
<% end if %>
</table>
</form>
<div align="center" style="margin-top: 10px;"><a href="#" onClick="self.close();">Close Window</a> : <a href="http://wiki.productcart.com/productcart/products_reviews#write_a_review_reminder" target="_blank">Documentation</a></div>
</BODY>
</HTML>
<% 'PRV41 end %>
