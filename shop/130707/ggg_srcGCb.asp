...
<tr>
	<td align="center" valign="top">
		<form class="pcForms">
			<input type="button" class="btn btn-default"  VALUE="New Search" onClick="location.href='ggg_manageGCs.asp'">
		<%if submit2="" then%>
			&nbsp;<input type="button" class="btn btn-default"  VALUE="View All" onClick="location.href='ggg_srcGCb.asp?iPageSize=99999&submit2=viewall'">
		<%end if%>
		</form>
	</td>
</tr>
