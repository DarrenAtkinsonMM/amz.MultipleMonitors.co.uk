				...
				For Each catNode In catNodes
					...
					<tr onMouseOver="this.className='activeRow'" onMouseOut="this.className='cpItemlist'" class="cpItemlist"> 
						...
						<td width="25%" align="right" nowrap="nowrap" class="cpLinksList"> 
							...
							%>
                            <a href="viewCat.asp?parent=<%=tIdCategory%>&hidden=<%=pcIntHidden%>" title="Reorder Subcategories">Reorder</a> :  
							<%
							end if
							%>
		...
		<table class="pcCPcontentCat">
            <tr>
            	<td colspan="3" class="cpOtherLinks">
                    ...
                    <a href="viewCat.asp?parent=1&hidden=0" title="Reorder Top-Level Categories">Reorder</a> | 
                    <a href="viewCatRecent.asp">Recently Edited</a> | 
					<a href="pcUpdateBreadCrumbs.asp">Update BreadCrumbs</a> | 
