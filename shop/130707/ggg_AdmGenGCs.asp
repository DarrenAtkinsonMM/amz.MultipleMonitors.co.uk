...
<tr>
	...
	<td>
		...
		<input name="submit1" type="submit" value="Generate" class="btn btn-primary" onClick="pcf_Open_genGerts();">&nbsp;
		<input type="button" class="btn btn-default"  name="back" value=" Back " onclick="location='ggg_AdmManageGCs.asp';">
	</td>
</tr>
<%END IF 'iGiftCerts = 1%>
</table>
