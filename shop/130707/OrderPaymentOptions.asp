...
<form name="data" action="OrderPaymentOptions.asp" method="post" class="pcForms">
	<table class="pcCPcontent">
		<tr> 
			<td colspan="2">During the checkout process, your customers will see a list of available payment options. Here you can set the order in which they are displayed in the dropdown list. Make sure to click on the &quot;Save&quot; button when you are done. PayPal Express Checkout is <u>not shown</u> in the list because it appears separately from the other payment options. </td>
		</tr>
		<tr>
...
response.redirect("pcPaymentSelection.asp")
			...
			<td width="50%" align="left" valign="top"> 
            	<div style="margin-bottom: 10px;"><input id="up" type="button" class="btn btn-default"  value="Move Up" onClick="moveSelected(dest,false)" /></div>
				<div style="margin-bottom: 10px;"><input id="down" type="button" class="btn btn-default"  value="Move Down" onClick="moveSelected(dest,true)" /></div>
				<div style="margin-bottom: 10px;"><input type="hidden" name="destItems" />
				<input name="submit" type="submit" onClick="return setHidden(this.form)" value="Save" class="btn btn-primary"/></div>
			</td>
		</tr>
		<tr>
			<td colspan="2" class="pcCPspacer"></td>
