...
if Session("pcAdminToProvince") = "" OR intResetSessions=1 then
	pcv_strToProvince = pcv_ShippingProvince
	Session("pcAdminToProvince") = pcv_strToProvince
end if
...
response.redirect "techErr.asp?err="&pcStrCustRefID
					...
					For pcv_xCounter = 1 to pcPackageCount
						...
						if pcLocalArray(pcv_xCounter-1) <> "shipped" then
							...
							If pcv_LabelMode = "FCINT" OR pcv_LabelMode = "PMINT" OR pcv_LabelMode = "EMINT" Then
								objUSPSClass.AddNewNode "ToProvince", Session("pcAdminToProvince"), 0
								...
								<tr>
									<td colspan="2">
										<div class="bs-callout bs-callout-info">
											<p>
												With Delivery Confirmation you and your customers can access information on the Internet about the delivery status of a package shipped via USPS. From your ProductCart store  or from the USPS website, you can check the delivery status of Delivery Confirmation packages shipped via Priority Mail, First-Class Mail parcel, and Package Services (Retail Ground, Bound Printed Matter, Media Mail, and Library Mail). The information returned will include the date, time, and ZIP Code of delivery, as well as attempted deliveries, forwarding, and returns. Delivery Confirmation service is not available to APO/FPO addresses, foreign countries, or most U.S. territories.
												<br />
												<br />
							...
							<% If Session("pcAdminToCountryCode") = "US" Then %>
								...
								<tr>
									<td colspan="2">
										<div class="bs-callout bs-callout-info">
											<p>
												With the USPS's Signature Confirmation, you or your customers can access information on the Internet about the delivery status of First-Class Mail parcels, Priority Mail and Package Services (Retail Ground, Bound Printed Matter, Media Mail, and Library Mail), including the date, time, and ZIP Code of delivery, as well as attempted deliveries, forwarding, and returns. Signature Confirmation service is not available to APO/FPO addresses, foreign countries, or most U.S. territories.
												<br/>
												<br />
												The charge (known as the "electronic option rate") for Signature Confirmation is $1.30 for Priority Mail, First-Class mail parcels, and Package Services parcels. From ProductCart or from the USPS website, you can check the delivery status of Signature Confirmation labels (barcodes) generated by these Web Tools.
											</p>
										</div>
									</td>
								</tr>
...
Please refer to the <a href="http://pe.usps.com/text/imm/immc2_011.htm" title="IMM Conditions for Mailing Priority Mail International" target="_blank">International Mail Manual</a> for &quot;Conditions for Mailing&quot; Priority Mail International Mail. You will find all the information regarding size and weight limits.</p></td>
							...
							<tr>
							  <td colspan="2"><input class="btn btn-primary" type="submit" name="Submit2" value="Submit"></td>
							</tr>
							<tr>
								<td colspan="2" class="pcCPspacer"></td>
							</tr>
												...
												<tr>
													<td colspan="2">
														...
														<select name="ServiceType<%=k%>" id="Service<%=k%>">
															...
															<option value="Retail Ground" <%=pcf_SelectOption("ServiceType"&k,"Retail Ground")%>>Retail Ground</option>
...
<input name="Girth<%=k%>" type="text" id="Girth<%=k%>" value="<%=pcf_FillFormField("Girth"&k, true)%>" size="10">
							  ...
							  <div align="center">
									 ...
									 &nbsp;             
									 <input class="btn btn-primary" type="submit" name="submit" value="Process Shipment">
										<br />
										<br />
