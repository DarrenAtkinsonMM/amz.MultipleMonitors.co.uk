...
%>
		<table class="pcCPcontent">
			...
			<tr> 
            	<td colspan="4"><input type="button" class="btn btn-default"  name="Back" value=" Back to Main menu " onclick="location='menu.asp';"></td>
			</tr>
		</table>
<%
