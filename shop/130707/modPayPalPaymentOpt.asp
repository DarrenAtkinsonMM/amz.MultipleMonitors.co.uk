...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
		...
		case "46", "53", "999999" 'PayPal Payments Pro (Direct Payments), PayPal Payments Pro, PayPal Express Checkout
...
paymentNickName=replace(paymentNickName,"""","&quot;")
	...
	<tr>
		<td colspan="4">Process orders when they are placed: <input type="checkbox" class="clearBorder" name="pcv_processOrder" value="1" <%if pcv_processOrder="1" then%>checked<%end if%>>&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=301"></a></td>
	</tr>
	<tr>
	...
	<tr> 
		<td align="center" colspan="4">
			...
			&nbsp;
			<input type="button" class="btn btn-default"  name="back" value="Back" onClick="javascript:history.back()">		</td>
	</tr>
</table>
</form>
