...
%>
<% pageTitle="UPS&reg; Developer Kit Shipping" %>
<% Section="Shipping" %>
<%PmAdmin=1%>
...
<form name="form2" method="post" action="<%=pcPageName%>" class="pcForms">
	<table class="pcCPcontent">
		<tr> 
			<th colspan="2">UPS&reg; Developer Kit Shipping: User Preferences </th>
		</tr>
		<tr> 
      ...
      <td align="right"><input type="checkbox" name="UPSVerbalConfirmation" value="1" class="clearBorder" <%=pcf_CheckOption("UPSVerbalConfirmation", "1")%>></td>
		...
		<tr> 
			<td colspan="2" align="center">
				...
				&nbsp;
				<input name="back" type="button" class="btn btn-default"  onClick="document.location.href='viewShippingOptions.asp';" value="Back">			</td>
		</tr>
		<tr>
