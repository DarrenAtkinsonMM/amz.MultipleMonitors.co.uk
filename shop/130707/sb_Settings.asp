...
if rs.eof then
	...
	Msg = msg & "<ul><li><a href=""pcConfigurePayment.asp?gwchoice=1"" >Authorize.Net</a></li></ul> "
	Msg = msg & "<ul><li><a href=""pcPaymentSelection.asp"" >PayPal</a></li></ul> "
	Msg = msg & "<ul><li><a href=""pcConfigurePayment.asp?gwchoice=67"" >NetSource Commerce Gateway</a></li></ul> "
	set rs=nothing
