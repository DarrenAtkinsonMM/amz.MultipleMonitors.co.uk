<%
PmAdmin=19
pageTitle = "ProductCart 5.2.10 - Database Updater"
Section = ""
%>
...
'// FedEx Web Services
	...
	'//  Add column pcStoreSettings_EnableGCT for table "pcStoreSettings"
	query="ALTER TABLE [pcStoreSettings] ADD [pcStoreSettings_EnableGCT] [int] DEFAULT (0) NOT NULL"
	set rs=server.CreateObject("ADODB.RecordSet")
	set rs=conntemp.execute(query)
	if err.number <> 0 then
		if instr(ucase(Err.Description),"COLUMN NAMES IN EACH TABLE MUST BE UNIQUE") then
	...
	'// ALTER EXISTING TABLES
	call AlterTableSQL("crossSelldata", "ADD", "cs_showNFS", "[INT]", 1, "0", "0")
...
<form action="upddb_v5.2.10.asp" method="post" name="form1" id="form1" class="pcForms">
<%
if mode="complete" then
	call closeDb()
	response.redirect "upddb_v5.2.10_complete.asp?CanUpd=" & CanUpd
	response.end()
else
%>
			...
			<tr>
				<td align="center">
					<p class="bs-callout bs-callout-danger">
                        ...
                        <input name="action" type="button" class="btn btn-success"  id="action" value=" Fix Database Errors " class="btn btn-primary" onclick="javascript:location='upddb_v5.2.10.asp?action=apparel';">

                        <input name="action" type="button" class="btn btn-default"  id="action" value=" Continue without Fix " class="btn btn-primary" onclick="javascript:location='upddb_v5.2.10.asp?action=skip';">
		...
		<% Else %>
            ...
            <tr>
			    <td>
                    ...
                    <h1 class="page-header">Welcome to ProductCart 5.2.10</h1>
                    
                    <% If pcv_boolIsUpdate = true Then %>
                    
                        <p class="lead">
                            ProductCart 5.2.10 is a feature and maintenance release for v5.2.00.
                            Be sure to read the <a href="https://productcart.desk.com/customer/portal/articles/2791264-updating-productcart-v5-2-00-to-v5-2-100" target="_blank">v5.2.10 Update Guide</a>.
                        </p>
                        <br />
                        <br />
                        <div class="bs-callout bs-callout-info upgrade">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item"><span class="glyphicon glyphicon-check checklist"></span>&nbsp;&nbsp;Create a backup of the entire "store" folder. (You don't need to backup the images)</li>
                                <li class="list-group-item"><span class="glyphicon glyphicon-check checklist"></span>&nbsp;&nbsp;Create a backup of the database.</li>
                                <li class="list-group-item"><span class="glyphicon glyphicon-check checklist"></span>&nbsp;&nbsp;Review the <a href="https://productcart.desk.com/customer/portal/articles/2791264-updating-productcart-v5-2-00-to-v5-2-100" target="_blank">v5.2.10 Update Guide</a> and <a href="https://productcart.desk.com/customer/en/portal/articles/2782231-productcart-v5-2-10-change-log" target="_blank">Change Log</a>.</li>
                            </ul>
                        </div>
                    
                    <% Else '// If pcv_boolIsUpdate = true Then %>
                    
                        <p class="lead">
                            ProductCart 5.2 is a full feature release, but also contains miscellaneous bug fixes and improvements for ProductCart v5.1.00.
                            Be sure to read the <a href="https://productcart.desk.com/customer/portal/articles/2492501-updating-productcart-v5-1-0x-to-v5-2-00" target="_blank">v5.2 Update Guide</a>.
                        </p>
                        <br />
                        <br />
                        <%
                        ...
                        <div class="bs-callout bs-callout-info upgrade">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item"><span class="glyphicon glyphicon-check checklist"></span>&nbsp;&nbsp;Create a backup of the database.</li>
                                <li class="list-group-item"><span class="glyphicon glyphicon-check checklist"></span>&nbsp;&nbsp;Review the <a href="https://productcart.desk.com/customer/portal/articles/2492501-updating-productcart-v5-1-0x-to-v5-2-00" target="_blank">v5.2 Update Guide</a> and <a href="https://productcart.desk.com/customer/portal/articles/2492904-productcart-v5-2-00-change-log" target="_blank">Change Log</a>.</li>
                            </ul>
                        </div>
                        ...
                        <div class="bs-callout bs-callout-warning upgrade">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item"><span class="glyphicon glyphicon-thumbs-up defaultlist"></span>&nbsp;&nbsp;v5.2 leverages ASP.NET.  We've already checked and you have it!</li>
                    ...
                    <% End If '// If pcv_boolIsUpdate = true Then %>
