...
<form action="newsWizStep5a.asp" name="d1">
...
Response.Write(vbCrLf & "<script type=text/javascript>document.d1.s1.value = " & Sentmails & ";</script>")
end if
next
...
mySQL="insert into News (FromDate,FromEmail,FromName,Title,MsgBody,MsgType,CustFile,CustTotal) values ('" & pTodaysDate & "','" & MsgFromEmail & "',N'" & MsgFromName & "',N'" & MsgTitle & "',N'" & MsgBody & "'," & session("News_MsgType") & ",'" & CustFile & "'," & session("AddrCount") & ")"
