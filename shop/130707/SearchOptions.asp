...
<tr>
    ...
    <div class="pcCPmessage" style="margin-top: 15px;">
		<p>IMPORTANT NOTE</p>
		<p>&nbsp;</p>
		<p style="font-weight: normal;">Make sure that the file &quot;<strong>CategorySearchFields.asp</strong>&quot; has been included into either <em>header.asp</em> or <em>footer.asp</em>. <a href="http://wiki.productcart.com/productcart/search_fields_widget#storefront" target="_blank">Instructions &gt;&gt;</a></p>
	</div>
    <% end if %>
	</td>
</tr>
...
<form method="post" name="form1" action="<%=pcv_strPageName%>?action=add" class="pcForms">
	...
	<tr>
		<td>
        	<p><strong>Custom search field widget for categories</strong> - <a href="http://wiki.productcart.com/productcart/search_fields_widget" target="_blank">Help on this topic</a>&nbsp;|&nbsp;<a href="ManageSearchFields.asp">Manage Search Fields</a></p>	
    	</td>
	</tr>
	<tr>
		<td>
	...
	<tr> 
		<td style="text-align: center;">
			<input name="submit" type="submit" class="btn btn-primary" value="Save Search Options">&nbsp;
    </td>
	</tr>
	</table>
</form>
