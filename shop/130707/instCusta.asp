...
response.redirect pcStrPageName&"?msg=The email you have chosen is already in use by another customer.&idcustomer=" & pidcustomer
		...
		'// Insert Customer
		query="INSERT INTO customers (pcCust_VATID, pcCust_SSN, name, lastName, email, fax, [password],city,zip,CountryCode, state, stateCode,shippingcity,shippingZip,shippingCountryCode, shippingState, shippingStateCode, phone, address, shippingAddress, customercompany, customerType,IDRefer,address2,shippingCompany, shippingAddress2,RecvNews,idcustomerCategory,pcCust_DateCreated, shippingEmail, shippingPhone,pcCust_AllowReviewEmails) VALUES ('" &Session("pcAdminpcBillingVATID")& "', '" &Session("pcAdminpcBillingSSN")& "',N'" &Session("pcAdminpcBillingFirstName")& "', N'" &Session("pcAdminpcBillingLastName")& "', '" &Session("pcAdminpcBillingEmail")& "', '" &Session("pcAdminpcBillingFax")& "' , '" &Session("pcAdminpassword")&"',N'" &Session("pcAdminpcBillingCity")& "','" &Session("pcAdminpcBillingPostalCode")& "','" &Session("pcAdminpcBillingCountryCode")& "', N'" &Session("pcAdminpcBillingProvince")& "', '" &Session("pcAdminpcBillingStateCode")& "',N'" &Session("pcAdminShipCity")& "','" &Session("pcAdminShipZip")& "','" &Session("pcAdminShipCountryCode")& "', N'" &Session("pcAdminShipState")& "', '" &Session("pcAdminShipStateCode")& "', '" &Session("pcAdminpcBillingPhone")& "', N'" &Session("pcAdminpcBillingAddress")& "', N'" &Session("pcAdminShipAddress")& "', N'" &Session("pcAdminpcBillingCompany")& "', " &Session("pcAdminCustomerType")& ","&pIdRefer&",N'" &Session("pcAdminpcBillingAddress2")& "',N'" &Session("pcAdminShipCompany")& "',N'" &Session("pcAdminShipAddress2")& "',"&Session("pcAdminCRecvNews")&"," & intidcustomerCategory & ",'" & dtTodaysDate & "','" &Session("pcAdminShipEmail")& "','"&Session("pcAdminShipPhone")&"'," & pcAllowReviewEmails & ")"
		' PRV41 end
		...
		call pcs_SaveUsedPass(pcv_IDCustomer,Session("pcAdminpassword")) 
		...
		'// Redirect
		call closeDb()
        response.redirect "viewCusta.asp?action=added&idCustomer="&pcv_IDCustomer
...
<form method="post" id="modCust" name="modCust" action="<%=pcStrPageName%>" onSubmit="return Form1_Validator(this)" class="pcForms">
	...
	<div id="TabbedPanels1" class="tabbable-left">
            ...
            <ul class="nav nav-tabs tabs-left">
				...
				<li>
					<div style="margin-top:10px; margin-bottom:10px; margin-left: 5px; text-align:center">
						<input type="submit" name="Modify" value="Add Customer" class="btn btn-primary">
		...
		<tr> 
			<td><p>Password:</p></td>
			<td><p>
				<input type="password" id="password" name="password" value="<% =pcf_FillFormField ("password", pcv_ispasswordRequired) %>" size="25" maxlength="50">
		...
		<tr> 
			<th colspan="2">Default Billing Address</th>
		</tr>  
		<tr> 
			<td colspan="2" class="pcCPspacer"></td>
		</tr>
