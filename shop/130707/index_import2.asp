...
<table class="pcCPcontent">
    ...
    <tr>
        <td>File name:
            ...
            <br>
            <br>
            <input class="btn btn-primary" type="submit" name="submit" value="Check file on server">
            &nbsp;<input type="button" class="btn btn-default"  name="back" value="Back" onClick="document.location.href='index_import.asp'">
        </td>
    </tr>
</table>
</form>
