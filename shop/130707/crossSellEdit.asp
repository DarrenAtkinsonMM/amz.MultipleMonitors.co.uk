...
<% 
	...
	set rs = nothing
%>
<form name="form1" method="post" action="crossSellEdit.asp" class="pcForms">
	...
	<tr> 
		<td> 
			...
			<tr> 
				...
				<th width="10%" align="center" nowrap="nowrap">Type&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=205"></a></th>
				<th width="10%" align="right" nowrap="nowrap">Disc.&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=206"></a></th>
				<th width="5%" align="right">%</th>
				<th width="10%" align="right" nowrap="nowrap">Required&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=207"></a></th>
			...
			<script type=text/javascript>SetOptions('<%=cnt%>')</script>								
			<%
					cnt=cnt+1
					rs.moveNext
					loop
	...
	<tr> 
		<td align="center">
		<input type="submit" name="submitUpdate" value="Update Relationship" onClick="javascript: return CheckDiscount('<%=cnt%>');" class="btn btn-primary">&nbsp;
		<input type="button" class="btn btn-default"  name="" value="Add more products" onClick="document.location.href='crossSellAddb.asp?idmain=<%=idmain%>'">&nbsp;
        <input type="button" class="btn btn-default"  name="" value="Copy to other products" onClick="document.location.href='crossSellMultiAdd.asp?idmain=<%=idmain%>'">&nbsp;
		<input type="button" class="btn btn-default"  name="" value="View other relationships" onClick="document.location.href='crossSellView.asp'">
		</td>
	</tr>
	<tr> 
		<td align="center">
			<input type="button" class="btn btn-default"  value="Edit Product-specific cross selling settings" onClick="document.location.href='crossSellSettings.asp?idmain=<%=idmain%>'">&nbsp;
		<input type="button" class="btn btn-default"  value="Edit Store-wide cross selling settings" onClick="document.location.href='crossSellSettings.asp?idmain=1'"> 
		</td>
	</tr>
	</table>
</form>
