...
<% If Not IsNull(resArray("EMAIL")) Then %>
<tr>
	<td>Payer Email:</td>
	<td><%=resArray("EMAIL")%></td>
</tr>
<% End If %>
<tr>
	<td>Payer Status:</td>
...
<tr>
	<td>
		...
		&nbsp;
		<input type="button" class="btn btn-default"  name="back1" value=" New Search " onClick="location='popup_PayPalTransSearch.asp';">
		&nbsp;
		<input type="button" class="btn btn-default"  name="close" value=" Close window " onClick="javascript:window.close();">
	</td>
</tr>
</table>
</body>
