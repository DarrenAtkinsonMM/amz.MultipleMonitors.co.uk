...
response.redirect "techErr.asp?err="&pcStrCustRefID
	...
	query="INSERT INTO pcEvents (pcEv_IDCustomer,pcEv_Type,pcEv_Name,pcEv_Date,pcEv_Delivery,pcEv_MyAddr,pcEv_Hide,pcEv_Notify,pcEv_IncGcs,pcEv_Active,pcEv_Code,pcEv_HideAddress) values (" & pcv_IdCustomer & ",'" & getype & "',N'" & gename & "','" & gedate & "'," & gedelivery & "," & gemyaddr & "," & gehide & "," & genotify & "," & geincgc & "," & geactive & ",'" & gecode & "'," & geHideAddress & ")"
	set rstemp=connTemp.execute(query)
	if err.number<>0 then
		call LogErrorToDatabase()
		set rstemp=nothing
...
<tr> 
	<td>Event Date:</td>
	<td>
		<input type="text" name="edate" class="datepicker" size="30" value="<%=gedate%>"> (<i>Format: <%= scDateFrmt %></i>)
	</td>
</tr>
<tr> 
	<td colspan="2"> 
...
<tr> 
	<td colspan="2" align="center"> 
			<input type="submit" class="btn btn-primary" name="submit" value="Add new" onClick="document.Form1.rewrite.value='0';">&nbsp;
			<input type="button" class="btn btn-default"  name="Back" value=" Back" onClick="location='ggg_manageGRs.asp?idcustomer=<%=pcv_IdCustomer%>';">
