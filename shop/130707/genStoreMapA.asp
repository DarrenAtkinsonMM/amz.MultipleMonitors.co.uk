...
Dim CatLevelLimit
Dim pcv_intUseFontTags,  pcv_strStyle, pcv_strStyleHeading, pcv_strStyleLink, pcv_strSMFont, pcv_strSMFSize, pcv_strSMFColor, pcv_strSMLColor, pcv_listType, pIdProduct, pDescription, intIdCategory
...
'// Save Store Map
call pcs_SaveUTF8(SavedFile,SavedFile,strStoreMap)
...
<table class="pcCPcontent">
    ...
    </a>&nbsp;|&nbsp;<a href="http://wiki.productcart.com/productcart/marketing-generate_store_map" target="_blank">How to use it</a>
    </div>
	</td>
	</tr>
<tr> 
<td class="normal">  
<p align="center">
<input name="back1" type="button" class="btn btn-default" value="Generate another Store Map" onClick="location='genStoreMap.asp'">&nbsp;
<input name="back" type="button" class="btn btn-default" value="Return to Start page" onClick="location='menu.asp'">
</td>
</tr>
</table>
</form>
...
Sub GenProducts(catID,levelID)
	...
	IF not rsp.eof then
		...
		For i=0 to PrdCount
			pIdProduct=pcPrdArr(0,i)
			pDescription=pcPrdArr(1,i)
			...
			tempStr1=tempStr1 & "<a href=""" & pcStrPrdLink & """" & pcv_strStyleLink & ">" & pDescription & "</a>"
...
Sub GenCat(catID, tmpCatName, tmpCatsDesc, CurrentLevel)
	...
	StringBuilderObj.append "<a href=""" & SPathInfo & pcStrCatLink & """><span" & pcv_strStyleLink & ">" & pcStrCategoryDesc & "</span></a>"
