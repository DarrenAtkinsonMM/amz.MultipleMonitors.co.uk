...
<% 
Dim pcvStrProductName, pidProduct, CanNotRun
		...
		%>
            <table class="pcCPcontent">
               ...
               <tr>
                ...
                <tr>
                    <td>
                        <input type="button" class="btn btn-default"  name="back" value=" Product Promotions " onClick="location='PromotionPrdSrc.asp';">
                        <input type="button" class="btn btn-default"  name="productDetails" value=" Product Details " onClick="location='modifyProduct.asp?idproduct=<%=pidProduct%>';">
...
response.redirect Request("GoURL")
	...
	if (intRequestSubmit1="Save") and (msg="") then
		...
		query="UPDATE pcPrdPromotions SET pcPrdPro_IncExcCust=" & pcIncExcCust & ",pcPrdPro_IncExcCPrice=" & pcIncExcCPrice & ",pcPrdPro_RetailFlag=" & pcRetail & ",pcPrdPro_WholesaleFlag=" & pcWholesale & ",pcPrdPro_Inactive=" & prinactive & ",pcPrdPro_QtyTrigger=" & qtytrigger & ",pcPrdPro_DiscountType=" & discountType & ",pcPrdPro_DiscountValue=" & discountvalue & ",pcPrdPro_ApplyUnits=" & applyunits & ",pcPrdPro_PromoMsg=N'" & promomsg & "',pcPrdPro_ConfirmMsg=N'" & confirmmsg & "',pcPrdPro_SDesc=N'" & descmsg & "' WHERE idproduct=" & pIDProduct & ";"
		set rs=server.CreateObject("ADODB.RecordSet")
		set rs=conntemp.execute(query)
		set rs=nothing
		...
		<table class="pcCPcontent">
			...
			<tr>
				<td>
					<input type="button" class="btn btn-default"  name="back" value=" Product Promotions " onClick="location='PromotionPrdSrc.asp';">
					&nbsp;&nbsp;<input type="button" class="btn btn-default"  name="back1" value=" View/Edit the Promotion again " onClick="location='ModPromotionPrd.asp?idproduct=<%=pidproduct%>&iMode=start';">
					&nbsp;&nbsp;<input type="button" class="btn btn-default"  name="back2" value=" Back to Main menu " onClick="location='menu.asp';">
				</td>
			</tr>		
		</table>	
			...
			<table class="pcCPcontent">
				...
				<tr> 
					<td colspan="3" align="center">
						...
						&nbsp;<input type="button" class="btn btn-default"  name="" value="Locate Another Promotion" onClick="document.location.href='PromotionPrdSrc.asp'">
						&nbsp;<input type="button" class="btn btn-default"  name="" value="View Storefront Page" onClick="window.open('../pc/viewprd.asp?idproduct=<%=pIDProduct%>')">
