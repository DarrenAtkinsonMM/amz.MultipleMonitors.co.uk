...
if pcv_customerName="" then  
    call closeDb()
    response.redirect "pushOrdersA.asp?idcustomer=" & pcv_idcustomer & "&msg=" & server.URLEncode("Please enter the customer's name, company name, or e-mail address.")
end if
...
<form name="form1" method="post" action="pushOrdersC.asp?action=push" onSubmit="return Form1_Validator(this)" class="pcForms">
	...
	<table class="pcCPcontent">          
        ...
        <tr>
            <td align="center"><br>
            <input type="submit" name="submit" value="Move orders to selected account" class="btn btn-primary">&nbsp;
