...
<table class="pcCPcontent">
	...
	<tr>
		<td>
			<ul class="pcListIcon">
            	<li><a href="checkForUpdates.asp" target="_blank">Check for Updates &gt;&gt;</a></li>
                <li><a href="http://www.productcart.com/release-log.asp" target="_blank">Recent bug fixes &gt;&gt;</a> (in-between official releases of ProductCart).</li>
            </ul>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<div style="text-align: center; margin: 15px;">
			<div style="background-color: #FFFFCC; border: 1px solid #999999; margin-top: 15px; text-align: center; width: 600px; height: 70px; position: relative;">
				<!-- Google CSE Search Box Begins -->
					<form id="searchbox_015541040505873019426:rx6ixm-0y6i" action="http://www.productcart.com/search.asp" style="margin:0;" target="_blank">
		...
		<p>Other resources:</p>
		<ul class="pcListIcon">
			<li><a href="http://wiki.productcart.com/" target="_blank">Productcart User Guides</a>: The User Guides are now a WIKI, constantly updated and expanded (get an <a href="http://wiki.productcart.com/feed.php" target="_blank">RSS feed of recent changes</a>).</li>
		  	<li><a href="http://www.productcart.com/search.asp" target="_blank"> Knowledge Base</a>: Answers to many frequently asked questions.</li>
			<li><a href="http://forum.productcart.com/" target="_blank">Forums</a>: Communicate with other ProductCart users. </li>
			<li><a href="http://wiki.productcart.com/developers/developers" target="_blank">Developer's Corner</a> If you are an experience ASP programmer and are interested in customizing ProductCart, this is the place to go. </li>
			<li><a href="http://www.productcart.com/technical-support.asp" target="_blank">Support Center</a>: Visit the support center for additional resources.</li>
			<li><strong>Submit a Support Request: </strong>
              <ul>
                <li>Did you purchase ProductCart from NetSource Commerce? <a href="https://www.productcart.com/store/pc/custpref.asp" target="_blank">Log into your account to submit a ticket &gt;&gt;</a></li>
                <li>Did you purchase from a ProductCart reseller? Please contact them for technical support.</li>
                <li>More information? See our <a href="http://www.productcart.com/support_updates.asp" target="_blank">Technical Support Policy</a>.</li>
              </ul>
			</li>
		</ul>
		</td>
	...
	<tr>
		<td>
			...
			<ul class="pcListIcon">
				...
				<li>Debugging code? If you need <a href="http://wiki.productcart.com/how_to/show_raw_errors" target="_blank">raw errors</a> printed to the screen, see this <a href="http://wiki.productcart.com/how_to/show_raw_errors" target="_blank">WIKI article</a>.</li>
			</ul>
		</td>
	</tr>
	<tr>
