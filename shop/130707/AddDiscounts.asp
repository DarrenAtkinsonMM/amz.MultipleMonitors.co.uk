...
response.redirect("AddDiscounts.asp?msg=A discount already exists with that code.")
	...
	End If
	query=query & "onetime, quantityfrom, quantityuntil, weightfrom, weightuntil, pricefrom, priceuntil, idProduct, pcSeparate, pcDisc_Auto, pcRetailFlag, pcWholesaleFlag, pcDisc_PerToFlatCartTotal, pcDisc_PerToFlatDiscount,pcDisc_IncExcPrd,pcDisc_IncExcCat,pcDisc_IncExcCust,pcDisc_IncExcCPrice) VALUES ("&pricetodiscount&","&percentagetodiscount&",'"&discountcode&"',N'"&discountdesc&"',"&active&","
	If expDate<>"" Then
