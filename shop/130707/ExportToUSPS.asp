...
<%
dim fso, f, pcv_ExportType, pcv_FromDate, pcv_ToDate, File1
...
<input type="button" class="btn btn-default"  value="Back" onclick="location='exportData.asp#USPS'">
				&nbsp;
<input type="button" class="btn btn-default"  value="Start Page" onclick="location='menu.asp'">
				<br>
				<br>
				</p>
<p>&nbsp;</p>
