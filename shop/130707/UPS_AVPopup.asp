...
<% If request("Submit")<>"" then
	...
	<table>
		<tr>
			<td bgcolor="#E1E1E1"><span class="style1">UPS&reg; Developer Kit Address Validation </span></td>
		</tr>
		<tr>
			<td><p><strong><br />
			  You chose</strong><br />
		...
		<tr><td>
		<FORM action="UPS_AVPopup.asp" NAME="popupForm" onSubmit="return copyForm()">
			<p>
			...
			<p>  
			<INPUT type="button" class="btn btn-default"  VALUE="Submit" onClick="copyForm()">
			</p>
		</FORM>
		</td></tr>
		<tr>
        ...
        <tr>
          ...
          <td width="654" valign="middle"><span class="pcSmallText">UPS, the UPS Shield trademark, the UPS Ready mark, <br />the UPS Developer Kit mark and the Color Brown are trademarks of <br />United Parcel Service of America, Inc. All Rights Reserved.</span></td>
        </tr>
      </table></td>
	  </tr>
		</table>
<% else
	...
	ups_URL="https://onlinetools.ups.com/ups.app/xml/AV"
	...
	<% else %>
		<form id="form1" name="form1" method="post" action="UPS_AVPopup.asp">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
				  <td colspan="2" bgcolor="#E1E1E1"><span class="style1">UPS&reg; Developer Kit Address Validation </span></td>
			  </tr>
				<tr>
				  <td colspan="2">&nbsp;</td>
			  </tr>
