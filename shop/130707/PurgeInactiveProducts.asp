...
response.redirect "techErr.asp?error="& Server.Urlencode("Error in PurgeRemovedProducts.asp: "&Err.Description) 
					...
					<tr> 
						<td align="center">
						<input type="submit" value="Remove ALL Inactive Products" name="submit" class="btn btn-primary" OnClick="return confirm('You are about to permanently remove all INACTIVE products from your database. Orders that contain those products will be removed as well. Are you sure that you wish to continue? This action cannot be undone. Click OK to continue or Cancel to abort.');" />&nbsp;
