...
<tr>
	<td>&nbsp;</td>
	<td><input type="button" class="btn btn-default"  name="back" value=" Back to Endicia Transactions " onclick="javascript:location='EDC_Trans.asp?iPageCurrent=<%=iPageCurrent%>';" class="btn btn-primary"></td>
</tr>
</table>
