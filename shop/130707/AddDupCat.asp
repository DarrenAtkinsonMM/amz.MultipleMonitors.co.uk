	  ...
	  <div id="TabbedPanels1" class="tabbable-left">
		...
		<div class="col-xs-3">
			<ul class="nav nav-tabs tabs-left">
				...
				<input type="submit" name="Submit" value="Clone" onClick="OpenHS();" class="btn btn-primary">
                <div style="padding: 6px 0 15px 0; text-align:left; color: #000000; font-family: Arial, sans-serif; font-weight: normal; font-size: 12px;"">
                	<input type="checkbox" name="runDupPrds" value="1" class="clearBorder" style="vertical-align:middle"> Duplicate products<br>
					<input type="checkbox" name="runDupSubCats" value="1" class="clearBorder" style="vertical-align:middle"> Duplicate sub-categories
				</div>

                <div style="padding: 6px 0 15px 0;">
                	<input type="button" class="btn btn-default"  name="manageCategories" value="Manage Categories" onClick="document.location.href='manageCategories.asp';">
				</div>                
                <div style="margin-top:10px; margin-bottom:10px; text-align: center">
				</li>
			</ul>
			...
			%>
				<div id="tabs-2" class="tab-pane">
					...
					<table class="pcCPcontent">	
						...
						<tr valign="top">
							<td width="30%">Short Description &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=440"></a>
								<div class="small">Shown on pages that display categories</div>
							</td>
							<td width="70%">
								<textarea id="SDesc" name="SDesc" cols="50" rows="6" tabindex="201" maxlength="255"><%=SDesc%></textarea>
						...
						<tr valign="top">
							<td>Long Description &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=440"></a>
							  <div class="small">Only shown on the page that displays products within the category</div>
              </td>
							<td>
							  <textarea class="htmleditor" id="LDesc" name="LDesc" cols="50" rows="6" tabindex="203"><%=LDesc%></textarea>	
							</td>
						</tr>
						<tr>
							<td colspan="2" class="pcCPspacer"></td>
