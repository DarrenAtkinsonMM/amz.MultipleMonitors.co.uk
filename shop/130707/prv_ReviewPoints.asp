	...
	<h2>Product Name: <strong><%=pcv_PrdName%></strong>&nbsp;|&nbsp;Review ID#: <%=pcv_IDReview%></h2>
		...
		<table class="pcCPcontent">
			...
			<tr>
				...
				<td>
				<br>
				<input type="button" class="btn btn-default"  name="Back" value="Back" onclick="location='prv_EditReview.asp?IDReview=<% = pcv_IDReview %>&IDProduct=<%=pcv_IDProduct%>&nav=<%=pcv_RevName%>'"></td>
			</tr>
		</table>
