...
if not rs.eof then
	...
	if pcStrRecentRevDesc<>"" then
		pcStrRecentRevDesc=replace(pcStrRecentRevDesc,"""","&quot;")
		pcStrRecentRevDesc=replace(pcStrRecentRevDesc,"<","&lt;")
		pcStrRecentRevDesc=replace(pcStrRecentRevDesc,">","&gt;")
	end if
...
function Form1_Validator(theForm)
{
  ...
  theForm = document.manageRecentRev;
...
<% 'PRV41 end %>
	...
	<table class="pcCPcontent">
		...
		<tr valign="top">
			...
			<td width="75%">
				<textarea class="htmleditor" id="pcStrRecentRevDesc" name="pcStrRecentRevDesc" cols="50" rows="6"><%=pcStrRecentRevDesc%></textarea>
			</td>
		</tr>	
		<tr> 
			<td colspan="2" class="pcCPspacer"></td>
