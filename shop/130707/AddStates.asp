...
response.redirect "AddStates.asp?s=0&msg=" &  Server.URLEncode("This State Code already exists in this system.")
		...
		query="INSERT INTO States (StateName,StateCode,pcCountryCode) values (N'" & StateName & "','" & StateCode & "','" & Country & "')"
		set rs=connTemp.execute(query)
...
response.redirect "techErr.asp?err="&pcStrCustRefID
	...
	<tr>
		<td colspan="2">
			<input type="submit" name="submit" value="Add State" class="btn btn-primary">&nbsp;
			<input type="button" class="btn btn-default"  name="Button" value="Manage States" onClick="location='manageStates.asp';">
		</td>
	</tr>  
	<tr>
