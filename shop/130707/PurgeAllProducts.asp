...
<% else
	...
	<form action="PurgeAllProducts.asp" method="post" name="form1" id="form1" class="pcForms">
  	<table class="pcCPcontent">
		...
		<tr> 
		<td align="center">
		<input name="purgeproducts" type="submit" value="Yes" class="btn btn-primary">
        &nbsp;
		<input type="button" class="btn btn-default"  value="Cancel" onClick="javascript:history.back()">
		</td>
	</tr>
	<tr>
		<td class="pcCPspacer"></td>
...
<table class="pcCPcontent">
	...
	<td align="center" colspan="2">
		<input name="confirm" type="submit" value="Permanently Remove All Products &amp; Orders" class="btn btn-primary">
		&nbsp;<input type="button" class="btn btn-default"  value="Cancel" onClick="javascript:history.back()">
	</td>
	</tr>
    <tr>
