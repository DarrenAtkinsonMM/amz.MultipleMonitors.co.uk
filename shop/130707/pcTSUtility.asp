...
<div data-ng-controller="appsCtrl">
        ...
        <tr>
            <td>
                ...
                <p>Your ProductCart License Key is: <strong><%=scCrypPass%></strong></p>
      			<p>Your ProductCart Defender Version is: <strong><%=scDefenderBuild%></strong></p>
                <% end if %>
                ...
                <% on error resume next
                    ...
                    <table>
                      <tr> 
                        ...
                        <td width="95%"><font color="#CC3950">You need to assign 'read/write' permissions to the 'store' folder and all of its subfolders.</font></td>
                      </tr>
                    </table>
                                    <% end if
                    ...
                    <table>
                      <tr> 
                        <td width="5%" valign="top"><img src="images/pc_error_sm.gif" width="18" height="18"></td>
                        <td width="95%"><font color="#CC3950">You need to assign 'read/write/delete' permissions to the 'store/includes' folder and all of its subfolders.</font></td>
                      </tr>
                      <tr> 
                    </table>
                    <% end if
                      ...
                      <tr> 
                        ...
                        <td width="96%">The connection string is valid. When you activated ProductCart, you entered <strong>MS <%=scDB%></strong> as your database type. If this is no longer the case:
                                            <ul>
                                                ...
                                                <li>Open it with Notepad or your HTML editor and edit the scDB constant. It should read scDB=&quot;SQL&quot;.</li>
                          ...
                          <tr> 
                            ...
                            <td width="5%">
                                <% If Not IsMailObjInstalled("SoftArtisans.FileUp") Then
                                    ...
                                    If Not IsObjActive("SoftArtisans.FileUp") then
                                        response.write "<img src=images/pcv4_icon_alert_sm.gif>"
                                    else
                                ...
                                <td width="62%" nowrap style="color:#336699;"> 
                                  <% If Not IsMailObjInstalled("SoftArtisans.FileUp") Then %>
                                   Not Installed 
                                    <% Else %>
                                    Installed <%If Not IsObjActive("SoftArtisans.FileUp") then%><%=CUmsg%><%End if%>
                                    <% End If %>
                                </td>
                            </tr>
                          <tr> 
                          ...
                          <tr> 
                            ...
                            <td width="5%">
                                <% If Not IsMailObjInstalled("Persits.Upload") Then
                                    ...
                                    If Not IsObjActive("Persits.Upload") then
                                        response.write "<img src=images/pcv4_icon_alert_sm.gif>"
                                    else
                                        response.write "<img src=images/pc_checkmark_sm.gif>"
                                        uplComCnt = uplComCnt + 1
                                ...
                                <td width="62%" nowrap style="color:#336699;"> 
                                  <% If Not IsMailObjInstalled("Persits.Upload") Then %>
                                   Not Installed 
                                    <% Else %>
                                    Installed <%If Not IsObjActive("Persits.Upload") then%><%=CUmsg%><%End if%>
                                    <% End If %>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table>
                            <tr>
                                <td colspan="3">This is required for the <a href="http://wiki.productcart.com/productcart/products_adding_new#how_to_upload_images" target="_blank">Image Upload &amp; Resize Feature</a>.</td>
                            </tr>
                          <tr> 
                            ...
                            <td width="5%">
                                <% If Not IsMailObjInstalled("Persits.Jpeg") Then
                                    ...
                                    If Not IsObjActive("Persits.Jpeg") then
                                        response.write "<img src=images/pcv4_icon_alert_sm.gif>"
                                    else
                                        response.write "<img src=images/pc_checkmark_sm.gif>"
                                ...
                                <td width="62%" nowrap style="color:#336699;"> 
                                  <% If Not IsMailObjInstalled("Persits.Jpeg") Then %>
                                   Not Installed 
                                    <% Else %>
                                    Installed <%If Not IsObjActive("Persits.Jpeg") then%><%=CUmsg%><%End if%>
                                    <% End If %>
                                </td>
                            </tr>
                          <tr> 
                            ...
                            <td width="5%">
                                <% If Not IsMailObjInstalled("AspImage.Image") Then
                                    ...
                                    If Not IsObjActive("AspImage.Image") then
                                        response.write "<img src=images/pcv4_icon_alert_sm.gif>"
                                    else
                                        response.write "<img src=images/pc_checkmark_sm.gif>"
                                        imgComCnt = imgComCnt + 1
                                ...
                                <td width="62%" nowrap style="color:#336699;"> 
                                  <% If Not IsMailObjInstalled("AspImage.Image") Then %>
                                   Not Installed 
                                    <% Else %>
                                    Installed <%If Not IsObjActive("AspImage.Image") then%><%=CUmsg%><%End if%>
                                    <% End If %>
                                </td>
                            </tr>
                        </table>
                ...
                %>	
                  ...
                  <table width="100%">
                    <tr>
                      ...
                      <td width="18%" nowrap>MSXML Default Parser</td>
                    ...
                    <tr>
                      ...
                      <td width="18%" nowrap>MSXML v3.0 Parser</td>
                      <td id="XML3reason"><%=XML3_Err_reason%><% if XML3_Err_reason="<b>INSTALLED</b>" AND XML3_Err_reason_2<>"" then %>&nbsp;with Errors&nbsp;-&nbsp;<%=XML3_Err_reason_2%><% end if %></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="18%" nowrap>MSXML v6.0 Parser</td>
                    ...
                    <% else %>
                        ...
                        <% 
                        '// Do not recommend 6 if a lower (fully supported) version is available. 
                        if XMLUse=6 then
        ...
        <tr>
            <td>
                ...
                <%  ' Do Product Weight Check
                    ...
                    query = query & "WHERE weight<1 AND (((active=-1) AND (pcProd_ParentPrd=0) AND (pcProd_Apparel=0)) OR ((active=0) AND (pcProd_ParentPrd>0) AND (pcProd_SPInActive=0))) AND noshipping=0 AND pcprod_QtyToPound=0  "
    ...
    response.redirect "techErr.asp?error="& Server.Urlencode("Error in pcTSUtility: 3"&Err.Description) 
                        ...
                        <br><i>This number represents the total record count from the &quot;products&quot; table. It includes inactive and <a href="http://wiki.productcart.com/how_to/remove_all_products" target="_blank">deleted products</a> and can be useful when troubleshooting performance issues</i></li>
                        <%
    ...
    response.redirect "techErr.asp?error="& Server.Urlencode("Error in pcTSUtility: 3"&Err.Description) 
        ...
        <tr>
            <td>
                <h2><a id="rebundle" name="rebundle"></a>Developer Tools</h2>
                <div class="row">
                    <div class="col-xs-5">
                        <strong>Combine &amp; Minify JavaScript/ CSS</strong>
                        <div class="pcSmallText">
                            This task only needs completed if you have customized the software and "Enabled Combine &amp; Minify" under <a href="AdminSettings.asp">Store Settings</a>.
                        </div>
                    </div>
                    <div class="col-xs-7">
                        <button type="button" id="compileCSS" data-ng-click="GetRequest('/includes/utilities/bundle.asp?action=CSS');" class="btn btn-default">Combine &amp; Minify CSS</span></button>
                        &nbsp;
                        <button type="button" id="compileJS" data-ng-click="GetRequest('/includes/utilities/bundle.asp?action=JS');" class="btn btn-default">Combine &amp; Minify JS</button>
                        &nbsp;
                        <button type="button" id="compileALL" data-ng-click="GetRequest('/includes/utilities/bundle.asp?action=ALL');" class="btn btn-default">Combine &amp; Minify All</button>
                        &nbsp;
                        <span ng-show="processing == true">
                            Processing&nbsp;<i class="glyphicon glyphicon-refresh spinning"></i>
                        </span>
...
Function IsObjActive(strClassString)
Dim tmpResult,uploadpath,imagepath
	...
	tmpResult=true
		...
		if Ucase(strClassString)="PERSITS.UPLOAD" then
			...
			If err.number <> 0 Then
				CUmsg = " but cannot be used." '<br><b>Error:</b> " & err.description
				tmpResult=false
				err.number=0
				err.description=0
			End if
