...
PmAdmin=19
pageTitle = "ProductCart v4.x to v5.2 - Database Upgrade Completed"
Section = "" 
%>
		...
		<td>
            ...
            <% Else %>
                ...
                <div class="pcCPmessageSuccess">
                    Your store database was successfully updated. The version number will be updated to v5.0 the next time you load any Control Panel page.
                </div>
                ...
                <div class="bs-callout bs-callout-info">
                    ...
                    <p>
                        ...
                        Carefully review the remaining upgrade tasks in the <strong><a href="https://www.productcart.com/support/v5/article.asp?id=1" target="_blank">Upgrade Guide</a></strong>. 
                        We also recommend that you review the list of <strong><a href="https://www.productcart.com/support/v5/article.asp?id=2" target="_blank">Trending v5 Articles</a></strong>.
                    </p>
                </div>
