            	...
            	<tr>
                	<td> 
                      ...
                      <div style="width: 340px; margin: 10px; padding: 10px; border: 1px solid #CCC; float: left;">
                        ...
                        <div style="text-align: center;"><input type="button" class="btn btn-default"  value="Select" class="btn btn-primary" onClick="document.location.href='AddPayPalPaymentOpt.asp?gwchoice=PayPal&ppv=0'"></div>
                      </div>
                      ...
                      <div style="width: 340px; margin: 10px; padding: 10px; border: 1px solid #CCC; float: right;">
                        ...
                        <div style="text-align: center;"><input type="button" class="btn btn-default"  value="Select (US Merchants)" class="btn btn-primary" onClick="document.location.href='AddPayPalPaymentOpt.asp?gwchoice=PayPal&ppv=2'">&nbsp;<input type="button" class="btn btn-default"  value="Select (UK Merchants)" class="btn btn-primary" onClick="document.location.href='AddPayPalPaymentOpt.asp?gwchoice=PayPal&ppv=4'"></div>
                      </div>
                      
                      <div style="clear: both;" class="pcForms">
                      <hr>
                      	<form>
                        	<input type="button" class="btn btn-default"  value="Back" onClick="document.location.href='AdminPaymentOptions.asp'">
                        </form>
                      </div>
					</td>
				</tr>
            	...
            	<tr>
                	<td>
                      ...
                      <div>These payment systems typically <u>do not</u> require a separate Internet merchant account with a bank.</div>
                        ...
                        <% end if %>
                        <li><a href="pcConfigurePayment.asp?gwchoice=13">2Checkout</a> - <a href="http://www.2checkout.com/" class="pcSmallText" style="color:#999;" target="_blank">Learn more</a></li>
                        <li><a href="pcConfigurePayment.asp?gwchoice=10">WorldPay</a> - <a href="http://www.rbsworldpay.com/products/index.php?page=ecom&c=UK" class="pcSmallText" style="color:#999;" target="_blank">Learn more</a></li>
                      ...
                      <h3 style="margin-bottom: 0;">Payment gateways</h3>
                        ...
                        <div style="position: relative;">
                            <div style="float: right; margin: 30px 0 0 0;"><a href="pcConfigurePayment.asp?gwchoice=67"><img src="images/ei_logo_gradient_payment_gateway_175.jpg" alt="NetSource Commerce Payment Gateway" border="0" /></a></div>
                        </div>
                      <div>These payment systems require an <a href="AdminPaymentMerchantAccount.asp">Internet merchant account</a> account with a bank [<a href="AdminPaymentMerchantAccount.asp">get one</a>].</div>
                        ...
                        <li><a href="pcConfigurePayment.asp?gwchoice=67"><strong>NetSource Commerce Payment Gateway</strong></a> - <a href="https://www.productcart.com/nc-payment-gateway.asp" class="pcSmallText" style="color:#999;">Learn more</a></li>
                      ...
                      <hr>
                      	<form style="margin: 20px 0;">
                            <input type="button" class="btn btn-default"  value="I need a merchant account" onClick="document.location.href='AdminPaymentMerchantAccount.asp'">
                            <input type="button" class="btn btn-default"  value="View all payment options" onClick="document.location.href='AdminPaymentOptions.asp?mode=viewall'">
                          <input type="button" class="btn btn-default"  value="Back" onClick="document.location.href='AdminPaymentOptions.asp'">
                        </form>
                      </div>
				  </td>
