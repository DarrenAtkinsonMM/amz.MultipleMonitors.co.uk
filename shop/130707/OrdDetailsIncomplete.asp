...
<input type="hidden" name="idcustomer" value="<%=pidcustomer%>">
	<table class="pcCPcontent">
    	<tr>
            <td colspan="2">
                <div>Order #: <b><%=(scpre+int(qry_ID))%></b>&nbsp;|&nbsp;Order Date: <strong><%=porderdate%></strong>&nbsp;|&nbsp;Order Total: <strong><%=scCurSign&money(ptotal)%></strong>&nbsp;&nbsp;&nbsp;<input type="submit" name="UpdateDO" value="Update Order Status" class="btn btn-primary"></div>
                <div style="margin-top: 10px;"><a href="http://wiki.productcart.com/productcart/orders_status#incomplete_orders" target="_blank">Learn about <strong>incomplete orders</strong></a>. Incomplete orders <strong>are not displayed</strong> with other orders in the Control Panel. If you would like to change the status of this order so it is no longer treated as &quot;incomplete&quot;, click on &quot;Update Order Status&quot;. The order status will become <em>Pending</em>.</div>
            </td>
		</tr>
		<tr>
