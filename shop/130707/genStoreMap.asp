...
<td>  
<input type="text" name="fontcolor" id="fontcolor" size="10" value="#000000"> <input type="button" class="btn btn-default"  value="Choose" id="Choose" onClick="PcjsColorChooser('Choose','fontcolor','value')" name="button"></td>
</tr>
<tr> 
<td align="right">Link Color:</td>
<td>  
<input type="text" name="linkcolor" id="linkcolor" size="10" value="#0000FF"> <input type="button" class="btn btn-default"  value="Choose" id="Choose2" onClick="PcjsColorChooser('Choose','linkcolor','value')" name="button"></td>
</tr>
<tr> 
<td colspan="2">&nbsp;</td>
</tr>
...
<tr> 
<td colspan="2">  
<input name="submit" type="submit" class="btn btn-primary" value="Generate Store Map" onClick="pcf_Open_genStoreMap();">
</td>
</tr>
</table>
</form>
