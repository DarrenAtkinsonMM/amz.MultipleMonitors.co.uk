...
response.redirect "techErr.asp?error="& Server.Urlencode("Error occurred while updating table pcXMLPartners: "&Err.Description) 
		...
		'// Update Partner
		query="UPDATE pcXMLPartners SET pcXP_PartnerID='" &Session("pcAdminpcUser")& "',pcXP_Password='" &Session("pcAdminpcPassword")& "',pcXP_Key='" &Session("pcAdminpcUserKey")& "',pcXP_Name=N'" &Session("pcAdminpcPartnerName")& "',pcXP_Email='" &Session("pcAdminpcPartnerEmail")& "',pcXP_Company=N'" &Session("pcAdminpcPartnerCompany")& "',pcXP_Address=N'" &Session("pcAdminpcPartnerAddress")& "',pcXP_Address2=N'" &Session("pcAdminpcPartnerAddress2")& "',pcXP_City=N'" &Session("pcAdminpcPartnerCity")& "',pcXP_StateCode='" &Session("pcAdminpcPartnerStateCode")& "',pcXP_Province=N'" &Session("pcAdminpcPartnerProvince")& "',pcXP_Zip='" &Session("pcAdminpcPartnerPostalCode")& "',pcXP_CountryCode='" &Session("pcAdminpcPartnerCountryCode")& "',pcXP_Phone='" &Session("pcAdminpcPartnerPhone")& "',pcXP_Fax='" &Session("pcAdminpcPartnerFax")& "',pcXP_Status=" &Session("pcAdminpcUserStatus")& ",pcXP_ExportAdmin=" & Session("pcAdminExportAdmin") & ",pcXP_FTPHost='" & Session("pcAdminFTPHost") & "',pcXP_FTPDirectory='" & Session("pcAdminFTPDirectory") & "',pcXP_FTPUsername='" & Session("pcAdminFTPUsername") & "',pcXP_FTPPassword='" & Session("pcAdminFTPPassword") & "' WHERE pcXP_id=" &Session("adminidPartner")& ";"
	...
	<table class="pcCPcontent">	
		...
		<tr>
			...
			<td><p>
				...
				<br>
				<input type="button" class="btn btn-default"  name="genKey" value="Generate New Key" onClick="javascript: if (confirm('You are about to generate a new key for this XML partner. The existing key will no longer work. Make sure to communicate the new key to the company. Would you like to continue?')) GetPartnerKey(document.modPartner.pcUserKey);">
			</p></td>
		</tr>
		<tr>
			<td><p>
	...
	<%
		...
		<tr> 
			<td colspan="2" align="center"> 
				<input type="submit" name="Modify" value="Update Partner" class="btn btn-primary">&nbsp;
				<input type="button" class="btn btn-default"  name="Main" value="Manage Partners" onClick="location.href='AdminManageXMLPartner.asp'">&nbsp;
				<input type="button" class="btn btn-default"  name="Back" value="Back" onClick="javascript:history.back()">&nbsp;
				<input type="button" class="btn btn-default"  name="Welcome" value="XML Tools Manager" onClick="location='XMLToolsManager.asp';">
