			...
			<tr>
				...
				<td><p>
				 <select name="TaxZoneID">
					...
					<img src="images/pc_required.gif" alt="required" width="9" height="9">&nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-default"  name="Update" value="Add/View Zones" onClick="newWin('pcTaxViewZones.asp','window2')"></p></td>
			</tr>
			<%
			set rs=nothing
			%>
			...
			<tr> 
				...
				<td> 
				    <% if request("mode")="MOD" then %>
				        ...
				        <% end if %>
                       	<input name="button" type="button" class="btn btn-default"  onClick="location.href='manageTaxEptCust.asp?ZoneRateID=<%=idTaxZonesGroupID%>&mode=view '" value="View/Edit Customer Exemptions for This Tax">&nbsp;
				        <input type="button" class="btn btn-default"  name="back" value="Back" onClick="location.href='viewTax.asp'">
				  </td>
			</tr>
		<% else
			if ptaxCanada="1" then %>
				...
				<tr> 
					<td colspan="2">
						...
						<br>
					<input type="button" class="btn btn-default"  name="Update" value="Define A Zone" onClick="newWin('AdminTaxZones.asp','window2')" class="btn btn-primary"></p>	</td></tr>
			<% else %>
				<tr>
					<td colspan="2">&nbsp;</td>
					</tr>
				<tr> 
					<td colspan="2"><p>Activate Tax Zone Feature<br>
						<br>
							<input type="button" class="btn btn-default"  name="New" value="Activate Tax Zones" class="btn btn-primary" onClick="location.href='../includes/PageCreateTaxSettings.asp?ActivateZone=1'">
					</p>	</td>		</tr>
			<% end if %>
		<% end if %>
	</table>
