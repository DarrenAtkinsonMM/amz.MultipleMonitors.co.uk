...
<table class="pcCPsearch">
	...
	<tr>
    	<td></td>
		<td>
			<input name="Submit" type="submit" class="btn btn-primary" value="<%=src_Button1%>">
            <input name="Submit1" type="submit" class="btn btn-default" value="View All" onclick="javascript:document.ajaxSearch.key1.value='';document.ajaxSearch.key2.value='';document.ajaxSearch.key3.value='';document.ajaxSearch.key4.value='';document.ajaxSearch.key5.value='';">
		</td>
	</tr>
</table>
</div>
