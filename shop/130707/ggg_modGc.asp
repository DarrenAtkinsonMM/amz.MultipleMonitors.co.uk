...
<tr>
	<td colspan="2" align="center">
		...
		<input name="submit1" type="submit" value="Update" onclick="document.hForm.subdel.value='0';" class="btn btn-primary">&nbsp;
		<input name="submit2" type="submit" value="Delete" onclick="document.hForm.subdel.value='1';" class="btn btn-primary">&nbsp;
		<input type="button" class="btn btn-default"  name="back" value="Locate Another" onClick="location='ggg_AdmManageGCs.asp';">
	</td>
</tr>
</table>
<br>
