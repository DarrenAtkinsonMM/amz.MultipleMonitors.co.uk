...
<tr>
	<td colspan="4">
		...
		&nbsp;
		<input type="button" class="btn btn-default"  name="Button" value="Return to VAT Settings" onClick="javascript:location='AdminTaxSettings_VAT.asp'">
		&nbsp;
		<input type="button" class="btn btn-default"  name="Restore" value="Restore Default Settings" onClick="javascript:location='restoreEUStates.asp?action=update'">
	</td>
</tr>   
</table>
</form>
