<% 
PmAdmin=19
pageTitle = "ProductCart v5.1.00 - Database Update" 
Section = "" 
%>
...
<form action="upddb_v5.1.00.asp" method="post" name="form1" id="form1" class="pcForms">
<%
if mode="complete" then
	call closeDb()
	response.redirect "upddb_v5.1.00_complete.asp?CanUpd=" & CanUpd
	response.end()	
else 
%>
	<table class="pcCPcontent" style="width:600px;" align="center">
			...
			<tr>
				<td align="center">
					<p class="bs-callout bs-callout-warning">
                        From ProductCart v5.0, we don't use the field data type: 'NText' anymore for store database because the next versisons of MS SQL Server won't support it.<br>
		...
		<tr>
			<td>
                ...
                <h1 class="page-header">Welcome to ProductCart 5.1.00</h1>
                <p class="lead">
                    ProductCart 5.1.00 is a full service release that includes the latest version of FedEx, in addition to patches, and platform improvements. Be sure to read the <a href="https://productcart.desk.com/customer/portal/articles/2019359-updating-productcart-v5-x-to-v5-1-00" target="_blank">v5.1.00 Update Guide</a> prior to updating.
                </p>
                    ...
                    <div class="bs-callout bs-callout-info">
                        <h4>Read Me</h4>
                        <p>
                            Click "Update Now" to update your MS SQL Database to v5.1.00.  
                        </p>
                    </div>              
