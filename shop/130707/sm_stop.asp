...
response.redirect "sm_manage.asp"
	...
	<tr>
		<td>
			<input type="button" class="btn btn-default"  name="Run" value=" Stop Sale Now " onclick="javascript:if (confirm('You are about to stop the sale: <%=replace(tmpSaleName,"'","\'")%>. Are you sure you want to complete this action?')) location='sm_stop.asp?a=run&id=<%=pcSCID%>';" class="btn btn-primary">
		</td>
	</tr>
	</table>	
	<%end if
