...
<table class="pcCPcontent">
    ...
    <tr>
        <td>File name:
            ...
            &nbsp;<input type="button" class="btn btn-default"  name="back" value="Back" onClick="document.location.href='catindex_import.asp'">
        </td>
    </tr>
</table>
</form>
