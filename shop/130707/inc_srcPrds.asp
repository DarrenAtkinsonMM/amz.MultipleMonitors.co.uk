...
<div class="panel panel-default">
 <div class="panel-heading"><h3 class="panel-title"><%=src_FormTitle1%></h3></div>
...
set rsTempFP=Server.CreateObject("ADODB.Recordset")
...
%>
	...
	<tr>
		...
		<td valign="top">
        	<input type="checkbox" name="src_IncNormal" value="1" <%if src_checkPrdType="0" then%>checked<%end if%> onclick="javascript:runXML();" class="clearBorder">Standard Products
			<%if src_SM<>"1" then%>
			    &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="src_IncBTO" value="1" <%if src_checkPrdType="1" then%>checked<%end if%> onclick="javascript:runXML();" class="clearBorder">Configurable Products 
                &nbsp;&nbsp;&nbsp;&nbsp;
                <input type="checkbox" name="src_IncItem" value="1" <%if src_checkPrdType="2" then%>checked<%end if%> onclick="javascript:runXML();" class="clearBorder">Configurable-Only Items
			<%end if%>
			<%if src_SM=1 then%>
			&nbsp;&nbsp;&nbsp;&nbsp;
            <input type="checkbox" name="src_IncDown" value="1" <%if src_checkPrdType="3" then%>checked<%end if%> onclick="javascript:runXML();" class="clearBorder">Downloadable Products	
			&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="src_IncGC" value="1" <%if src_checkPrdType="4" then%>checked<%end if%> onclick="javascript:runXML();" class="clearBorder">Gift Certificates
...
%>
<tr> 
	<td><p>Active Status:</p></td>
	<td>
	<input type="radio" name="pinactive" value="0" onclick="javascript:runXML();" class="clearBorder">&nbsp;Active&nbsp;&nbsp;
    <input type="radio" name="pinactive" value="1" onclick="javascript:runXML();" class="clearBorder">&nbsp;Inactive&nbsp;&nbsp;
    <input type="radio" name="pinactive" value="-1" onclick="javascript:runXML();" class="clearBorder" checked>&nbsp;Both
	</td>
</tr>
<%else%>
...
<tr> 
	...
	<input name="runform" type="submit" class="btn btn-default" value="<%=src_Button1%>">
	</td>
</tr>  
</table>
</div>
