...
PmAdmin=19
pageTitle = "ProductCart v5.1.00 - Database Update Completed"
Section = "" 
%>
...
if scBTO=1 then
	pcStrScVersion="5.1.00b"
else
	pcStrScVersion="5.1.00"
end if
    ...
    <tr>
		<td>
            <div class="pcCPmessageSuccess">
                Your store database was successfully updated. The version number will be updated to v5.1.00 the next time you load any Control Panel page.
            </div>            
        </td>
    </tr>
    <tr>
