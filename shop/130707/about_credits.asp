...
<table class="pcCPcontent">
	...
	<tr>
		...
		<p>For information about Certified ProductCart Developers, <a href="http://www.productcart.com/partners.asp" target="_blank">visit</a> the NetSource Commerce Web site. These are companies who have become experts in providing custom ecommerce solutions based on ProductCart.</p>
		</td>
	</tr>
	<tr>        
		<td>
	...
	<tr>
		...
		&nbsp;
		<input type="button" class="btn btn-default"  name="" value="Start Page" onClick="location.href='menu.asp'">
		</form>
		</td>
	</tr>  
</table>
