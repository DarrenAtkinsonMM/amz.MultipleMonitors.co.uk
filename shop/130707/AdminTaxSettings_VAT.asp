...
<form name="form1" method="post" action="../includes/PageCreateTaxSettings.asp" class="pcForms">
	...
	<table class="pcCPcontent">	 
		<tr>
			<td colspan="2">
			<p>This feature allows online stores located in countries that use the Value Added Tax (VAT) to correctly display retail taxes (e.g. Europe). The use of VAT is based on a number of <a class="pcCPhelp" href="helpOnline.asp?ref=451')">assumptions</a>&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=451"></a></p>
			</td>
		</tr>	
		<tr>
		...
		<tr>					
			...
			Yes
			<div style="padding-bottom:4px">If set to &quot;Yes&quot;, ProductCart assumes that shipping charges include VAT. So when it calculates the total VAT applied to the order, it includes these charges in the equation.</div> </td>
		</tr>				  
		<tr> 
			...
			Yes
			<div style="padding-bottom:4px">If set to &quot;Yes&quot;, ProductCart assumes that handling fees include VAT. So when it calculates the total VAT applied to the order, it includes these fees in the equation. </div></td>
		</tr>				  
		<tr> 
		...
		<tr>
			<td>&nbsp;</td>
			<td>
				<input type="submit" name="Submit" value="Save Settings" class="btn btn-primary" onClick="javascript:setRefPage('AdminTaxSettings.asp');">&nbsp;
		...
		<tr> 
			<td colspan="2">
			<p>VAT categories allow you to use a different rate on different products&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=452"></a>. </p>
		...
		<tr> 
			...
			<td>
				...
				%>
				</select>&nbsp;&nbsp;&nbsp;<input type="button" class="btn btn-default"  name="Update" value="Manage EU States" onclick="location='ManageEUStates.asp'">
		...
		<tr>
			...
			<td>
				...
				%>
				<input type="submit" name="Submit" value="Save Settings" class="btn btn-primary" onClick="javascript:setRefPage('<%=pcv_strRefPage%>');">&nbsp;
				<% if ptaxVATRate_Code<>"" then %>
				<input type="button" class="btn btn-default"  name="ManageVATCategories" value="Manage VAT Categories" onclick="location='viewVAT.asp';">&nbsp;
				<% end if %>
				<input type="button" class="btn btn-default"  name="back" value="Finished" onClick="location.href='menu.asp'">
