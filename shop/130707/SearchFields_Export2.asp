	...
	<table class="pcCPcontent">
        ...
        <tr>
            <td colspan="2">
                ...
                <input type="button" class="btn btn-default"  name="backstep" value="<< Back to Step One" onClick="location='SearchFields_Export.asp?a=1<%=mtemp%>&export=<%=pcv_strExportType%>';">&nbsp; 
                <input type="submit" name="submit" value="Go to Step Three >>" class="btn btn-primary">            
        	</td>
        </tr>
    </table>
</form>
