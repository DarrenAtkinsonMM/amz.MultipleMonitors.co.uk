...
<%IF request("action")<>"" then 
	if request("action")="update" then
		...
		query="UPDATE productsOrdered SET pcPO_GWOpt=" & pcv_GWOpt & ",pcPO_GWNote=N'" & pcv_GWNote & "',pcPO_GWPrice=" & pcv_GWPrice & " WHERE idProductOrdered="&pidProductOrdered&";"
	...
	<tr>
		<td align="center">
			<input type="button" class="btn btn-default"  name="Back" value="Close Window" onClick="opener.location='AdminEditOrder.asp?ido=<%=request("idOrder")%>&action=upd'; self.close();">
		</td>
	</tr>
	</table>
<%ELSE%>
