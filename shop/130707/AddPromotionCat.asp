	...
	<table class="pcCPcontent">
		...
		<tr>
			<td>
				...
				&nbsp;&nbsp;<input type="button" class="btn btn-default"  name="back1" value=" View/Edit the Promotion " onclick="location='ModPromotionCat.asp?idcategory=<%=pidcategory%>&iMode=start';">
