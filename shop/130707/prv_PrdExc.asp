...
<form method="POST" action="prv_PrdExc.asp?action=update" name="checkboxform" class="pcForms">
	<table class="pcCPcontent">
		...
		<tr>
            <td colspan="3">
			<input type="button" class="btn btn-default"  value="Add Products to Exclusion List" onClick="location.href='prv_AddPrdExc.asp'" class="btn btn-primary">&nbsp;
			<%if DataEmpty<>1 then%>
		...
		<td align="left" colspan="3">
			...
			<input type="button" class="btn btn-default"  value="Product Review Settings" onClick="location.href='PrvSettings.asp'">
			</td>
		</tr>
	</table>
</form>
