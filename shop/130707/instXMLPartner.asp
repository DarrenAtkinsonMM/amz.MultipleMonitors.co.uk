...
response.redirect "techErr.asp?error="& Server.Urlencode("Error occurred while updating table pcXMLPartners: "&Err.Description) 
		...
		'// Insert Partner
		query="INSERT INTO pcXMLPartners (pcXP_PartnerID, pcXP_Password, pcXP_Key, pcXP_Name, pcXP_Email, pcXP_Company, pcXP_Address, pcXP_Address2, pcXP_City, pcXP_StateCode, pcXP_Province, pcXP_Zip, pcXP_CountryCode, pcXP_Phone, pcXP_Fax, pcXP_Status,pcXP_ExportAdmin,pcXP_FTPHost,pcXP_FTPDirectory,pcXP_FTPUsername,pcXP_FTPPassword) VALUES ('" &Session("pcAdminpcUser")& "','" &Session("pcAdminpcPassword")& "','" &Session("pcAdminpcUserKey")& "',N'" &Session("pcAdminpcPartnerName")& "','" &Session("pcAdminpcPartnerEmail")& "',N'" &Session("pcAdminpcPartnerCompany")& "',N'" &Session("pcAdminpcPartnerAddress")& "',N'" &Session("pcAdminpcPartnerAddress2")& "',N'" &Session("pcAdminpcPartnerCity")& "','" &Session("pcAdminpcPartnerStateCode")& "',N'" &Session("pcAdminpcPartnerProvince")& "','" &Session("pcAdminpcPartnerPostalCode")& "','" &Session("pcAdminpcPartnerCountryCode")& "','" &Session("pcAdminpcPartnerPhone")& "','" &Session("pcAdminpcPartnerFax")& "'," &Session("pcAdminpcUserStatus")& "," & Session("pcAdminExportAdmin") & ",'" & Session("pcAdminFTPHost") & "','" & Session("pcAdminFTPDirectory") & "','" & Session("pcAdminFTPUsername") & "','" & Session("pcAdminFTPPassword") & "');"
	...
	<table class="pcCPcontent">
		...
		<tr>
			...
			<td><p>
				...
				<br>
				<input type="button" class="btn btn-default"  name="genKey" value="Generate Key" onclick="javascript:GetPartnerKey(document.modPartner.pcUserKey);" class="btn btn-primary">
			</p></td>
		</tr>
		<tr>
			<td><p>
	...
	<%
		...
		<tr> 
			<td colspan="2" align="center"> 
				<input type="submit" name="Modify" value="Add XML Partner" class="btn btn-primary">&nbsp;
				<input type="button" class="btn btn-default"  name="Main" value="Manage XML Partners" onClick="location.href='AdminManageXMLPartner.asp'">&nbsp;
