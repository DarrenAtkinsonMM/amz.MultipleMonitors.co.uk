...
<%
Dim iXML,oXML,oRoot,tmpNode,tmpNode1,attNode,subNode,ChildNodes,iXML1,iRoot1
...
<%end if%>
<tr>
	<td><input type="button" class="btn btn-default"  name="Back" value="XML Tools Manager" onclick="location='XMLToolsManager.asp';">&nbsp;
