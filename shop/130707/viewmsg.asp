...
<tr>
	<td align="center">
		<input type="button" class="btn btn-default"  name=buttonnew value="Send to New List" onClick="location='germsg.asp?pagetype=<%=pcv_pageType%>&idnews=<%=intIdNews%>'">&nbsp;
		<input type="button" class="btn btn-default"  name=back value="Back" onClick="location='managenews.asp?pagetype=<%=pcv_pageType%>'">
	</td>
</tr>
<tr>
	<td align="center">&nbsp;</td>
