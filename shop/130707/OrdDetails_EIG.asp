...
%>
	...
	<tr>
		<td colspan="2">This section includes payment-related tasks that you can perform with the EI Gateway.&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=700"></a></td>
	</tr>	
    ...
    <tr>
        ...
        <div style="padding-bottom:4px;">
            ...
            <% if pcv_PaymentStatus<>6 AND pcv_PaymentStatus<>8 AND pcv_PaymentStatus<>1 then
                EIGbtns=1 
                %>					
                <input type="submit" name="SubmitEIG1" value=" Refund "  onClick="javascript: if (confirm('This action will NOT cancel the order, but rather refund the payment via the NetSource Commerce Gateway. You can separately cancel the order. Are you sure you want to continue?')) return true ; else return false ;" class="btn btn-primary">&nbsp;&nbsp;					
            <% end if %>
        </div>
