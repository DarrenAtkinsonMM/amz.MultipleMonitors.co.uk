...
<tr>
	<td></td>
	<td>
		<input type="radio" name="ExType" value="0" class="clearBorder" checked> Do not export sub-products<br>
		<input type="radio" name="ExType" value="1" class="clearBorder"> Only export sub-products<br>
		<input type="radio" name="ExType" value="2" class="clearBorder"> Include both
	</td>
</tr>
<% End If %>
<tr>
...
<tr>
	<td colspan="2"><input type="submit" name="Submit" value="Continue" class="btn btn-primary"></td>
</tr>
</table>
