...
<tr>
	...
	<td>Standard Products	<input type="checkbox" name="src_IncNormal" value="1" checked class="clearBorder">
		&nbsp;&nbsp;&nbsp;&nbsp;Configurable Products <input type="checkbox" name="src_IncBTO" value="1" class="clearBorder">&nbsp;&nbsp;&nbsp;&nbsp;Configurable Items	<input type="checkbox" name="src_IncItem" value="1" class="clearBorder">
	</td>
</tr>
<tr>
	<td colspan="2"><hr /></td>
...
<tr>
	...
	<td valign="top">
		<input type="text" id="pFromDate" name="pFromDate" class="datepicker" value="" size="13">
	</td>
</tr>
<tr>
	<td valign="top">To Date:</td>
	<td valign="top">
		<input type="text" id="pToDate" name="pToDate" class="datepicker" value="" size="13">
	</td>
</tr>
<tr>
	<td colspan="2"><hr /></td>
...
<tr>
	<td colspan="2">
		<input name="runform" type="submit" class="btn btn-default" value="Export Product XML File">
	</td>
</tr>  
</table>
</form>
