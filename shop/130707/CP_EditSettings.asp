    ...
    <form name="form1" method="post" action="CP_EditSettings.asp" class="pcForms">
        <table class="pcCPcontent">
            ...
            <tr> 
                ...
                <td width="85%"><input name="CP_Height" type="text" id="CP_Height" value="<%=CP_Height%>" size="4" maxlength="4"> cm.</td>
            </tr>
            <tr> 
                <td align="right">Width:</td>
                <td><input name="CP_Width" type="text" id="CP_Width" value="<%=CP_Width%>" size="4" maxlength="4"> cm.</td>
            </tr>
            <tr> 
                <td align="right">Length:</td>
                <td><input name="CP_Length" type="text" id="CP_Length" value="<%=CP_Length%>" size="4" maxlength="4"> cm. &nbsp;<span class="pcSmallText">This is the measurement of the longest side</span></td>
            </tr>
            <tr>
