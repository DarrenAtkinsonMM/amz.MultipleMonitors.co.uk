...
<title>Upload Images</title>
	...
	<form method="post" enctype="multipart/form-data" action="taxupl_popup.asp">
        <table width="100%" border="0" cellspacing="0" cellpadding="8" align="center">
          ...
          <tr> 
            <td height="18" colspan="2"><font face="Arial, Helvetica, sans-serif" size="2"> Select your file by using the &quot;Browse&quot; button. Then click on &quot;Upload&quot;. Your file will be automatically uploaded to the &quot;<b>store/pc/tax</b>&quot; folder on your Web server.</font></td>
          </tr>
          <tr> 
