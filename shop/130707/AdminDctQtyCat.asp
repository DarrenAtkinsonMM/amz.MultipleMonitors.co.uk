...
<% pageTitle="Add Category-based Quantity Discount (Tiered Pricing)" %>
<% Section="specials" %>
<%PmAdmin=3%>
...
<% 
Dim idcategory, discountdesc, percentage, baseproductonly, discountPerUnit1, discountPerWUnit1, quantityfrom1
