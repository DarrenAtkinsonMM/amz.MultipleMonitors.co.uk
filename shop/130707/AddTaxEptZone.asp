...
<tr><td align="center">&nbsp;</td>
  <td>
  	<input type="submit" name="submit" class="btn btn-primary" value="Add Rules">&nbsp;
    <input type="button" class="btn btn-default"  name="goback" value="Manage Existing Tax Exemptions" onClick="location='manageTaxEptZone.asp';">
