...
<form name="form1" method="post" action="<%=pcPageName%>" class="pcForms" onSubmit="return Form1_Validator(this)">
    <table class="pcCPcontent">
        ...
        <tr> 
          ...
          <td><input type="radio" name="AffAutoApprove" value="1" <%if scAffAutoApprove="1" Then Response.Write "checked"%> onClick="javascript:alert('Are you sure you want to automatically approve new affiliate accounts?')" class="clearBorder"> Yes <input type="radio" name="AffAutoApprove" value="0" <%if scAffAutoApprove="0" Then Response.Write "checked"%> class="clearBorder"> No &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=210"></a></td>
        </tr>
        <tr>
          <td>Default commission:</td>
          <td><input name="AffDefaultCom" type="text" id="AffDefaultCom" value="<%=scAffDefaultCom%>" size="6" maxlength="6"> % (e.g. for a 20% commission, enter 20) &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=211"></a></td>
        </tr>
        <tr>
          <td nowrap>Exclude wholesale customers:</td>
          <td><input name="ExcludeWholesaleAff" type="radio" id="ExcludeWholesaleAff" value="1" <%if scExcludeWholesaleAff="1" then Response.Write "checked"%> class="clearBorder"> Yes <input name="ExcludeWholesaleAff" type="radio" id="ExcludeWholesaleAff" value="0" <%if scExcludeWholesaleAff="0" then Response.Write "checked"%> class="clearBorder"> No &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=212"></a></td>
        </tr>
        <tr>
          <td>Save Affiliate ID:</td>
           <td><input type="radio" name="SaveAffiliate" value="0" <%if scSaveAffiliate="0" then Response.Write "checked"%> class="clearBorder"> No &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=208"></a></td>
        </tr>
        <tr> 
          <td></td>
          <td><input type="radio" name="SaveAffiliate" value="1" <%if scSaveAffiliate="1" then Response.Write "checked"%> class="clearBorder"> Yes - Enter the number of days after which the cookie expires:
            <input name="SaveAffiliateDays" type="text" id="scSaveAffiliateDays" value="<%=scSaveAffiliateDays %>" size="6" maxlength="6">&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=208"></a>
          </td>
        </tr>						
        <tr>
          <td nowrap>Max number of orders per customer:</td>
          <td><input name="AllowedAffOrders" type="text" id="AllowedAffOrders" value="<%=scAllowedAffOrders%>" size="4" maxlength="4"> order(s) on which commissions will be earned &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=209"></a></td>
        </tr>
        <tr> 
            <td colspan="2"><hr></td>
        </tr>
