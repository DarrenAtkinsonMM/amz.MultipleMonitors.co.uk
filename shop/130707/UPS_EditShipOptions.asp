...
%>
<% pageTitle="UPS&reg; Developer Kit Shipping Configuration - Edit Services" %>
<% Section="shipOpt" %>
            ...
            <form name="form1" method="post" action="UPS_EditShipOptions.asp" class="pcForms">
				<table class="pcCPcontent">                            
                    ...
                    <tr class="normal"> 
                        ...
                        <input type="submit" name="Submit" value="Update UPS Shipping Services" class="btn btn-primary">
                        &nbsp;
                        <input type="button" class="btn btn-default"  name="back" value="Back" onClick="document.location.href='viewShippingOptions.asp'"></td>
                    </tr>
                </table>
            </form>
		<% end if %>
        ...
        <hr>
        	<table>
                <tr>
                    ...
                    <td width="457" valign="top" bgcolor="#FFFFFF"><div align="center">UPS, the UPS Shield trademark, the UPS Ready mark, <br />the UPS Developer Kit mark and the Color Brown are trademarks of <br />United Parcel Service of America, Inc. All Rights Reserved.</div></td>
                </tr>
            </table>
        </td>
    </tr>
