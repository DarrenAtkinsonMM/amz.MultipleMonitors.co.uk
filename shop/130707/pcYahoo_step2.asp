...
IF pcv_HaveRecords=1 THEN
	...
	call pcs_SaveUTF8(strFile & ".txt",strFile & ".txt",StrResults)
...
<tr>
	<td>&nbsp;</td>
	<td>
		<input type="button" class="btn btn-default"  name="back" value="Back to Main Menu" onClick="javasccript:location='menu.asp';">
	</td>
</tr>
<%ELSE%>
<tr>
