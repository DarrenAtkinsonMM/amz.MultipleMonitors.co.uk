...
response.redirect pcStrPageName&"?msg="&pcv_strGenericPageError&"&pagetype=" & pcv_pageType
	Else
		...
		IF request("action")="add" then
			...
			query=query & ") VALUES (" & "'" & Session("pcAdminpcv_sdsUsername") & "','" & Session("pcAdminpcv_sdsPassword") & "',N'" & Session("pcAdminpcv_sdsFirstName") & "',N'" & Session("pcAdminpcv_sdsLastName") & "',N'" & Session("pcAdminpcv_sdsCompany") & "','" & Session("pcAdminpcv_sdsPhone") & "','" & Session("pcAdminpcv_sdsEmail") & "','" & Session("pcAdminpcv_sdsURL") & "',N'" & Session("pcAdminpcv_sdsFromAddress") & "',N'" & Session("pcAdminpcv_sdsFromAddress2") & "',N'" & Session("pcAdminpcv_sdsFromCity") & "',N'" & pcv_sdsFromStateProvinceCode & "','" & Session("pcAdminpcv_sdsFromZip") & "','" & Session("pcAdminpcv_sdsFromCountrycode") & "',N'" & Session("pcAdminpcv_sdsBillingAddress") & "',N'" & Session("pcAdminpcv_sdsBillingAddress2") & "',N'" & Session("pcAdminpcv_sdsBillingCity") & "',N'" & pcv_sdsBillingStateProvinceCode & "','" & Session("pcAdminpcv_sdsBillingZip") & "','" & Session("pcAdminpcv_sdsBillingCountrycode") & "','" & Session("pcAdminpcv_sdsNoticeEmail") & "'," & Session("pcAdminpcv_sdsNoticeType") & ",'" & Session("pcAdminpcv_sdsNoticeMsg") & "'," & Session("pcAdminpcv_sdsNotifyManually") & "," & Session("pcAdminpcv_sdsCustNotifyUpdates")
			if pcv_pageType="0" then
		...
		'// Update a Drop Shipper
			...
			query="UPDATE " & pcv_Table & "s SET " & pcv_Table & "_Username='" & Session("pcAdminpcv_sdsUsername") & "'," & pcv_Table & "_Password='" & Session("pcAdminpcv_sdsPassword") & "'," & pcv_Table & "_FirstName=N'" & Session("pcAdminpcv_sdsFirstName") & "'," & pcv_Table & "_LastName=N'" & Session("pcAdminpcv_sdsLastName") & "'," & pcv_Table & "_Company=N'" & Session("pcAdminpcv_sdsCompany") & "'," & pcv_Table & "_Phone='" & Session("pcAdminpcv_sdsPhone") & "'," & pcv_Table & "_Email='" & Session("pcAdminpcv_sdsEmail") & "'," & pcv_Table & "_URL='" & Session("pcAdminpcv_sdsURL") & "'," & pcv_Table & "_FromAddress=N'" & Session("pcAdminpcv_sdsFromAddress") & "'," & pcv_Table & "_FromAddress2=N'" & Session("pcAdminpcv_sdsFromAddress2") & "'," & pcv_Table & "_FromCity=N'" & Session("pcAdminpcv_sdsFromCity") & "'," & pcv_Table & "_FromStateProvinceCode=N'" & pcv_sdsFromStateProvinceCode & "'," & pcv_Table & "_FromZip='" & Session("pcAdminpcv_sdsFromZip") & "'," & pcv_Table & "_FromCountryCode='" & Session("pcAdminpcv_sdsFromCountrycode") & "'," & pcv_Table & "_BillingAddress=N'" & Session("pcAdminpcv_sdsBillingAddress") & "'," & pcv_Table & "_BillingAddress2=N'" & Session("pcAdminpcv_sdsBillingAddress2") & "'," & pcv_Table & "_BillingCity=N'" & Session("pcAdminpcv_sdsBillingCity") & "'," & pcv_Table & "_BillingStateProvinceCode=N'" & pcv_sdsBillingStateProvinceCode & "'," & pcv_Table & "_BillingZip='" & Session("pcAdminpcv_sdsBillingZip") & "'," & pcv_Table & "_BillingCountryCode='" & Session("pcAdminpcv_sdsBillingCountrycode") & "'," & pcv_Table & "_NoticeEmail='" & Session("pcAdminpcv_sdsNoticeEmail") & "'," & pcv_Table & "_NoticeType=" & Session("pcAdminpcv_sdsNoticeType") & "," & pcv_Table & "_NoticeMsg=N'" & Session("pcAdminpcv_sdsNoticeMsg") & "'," & pcv_Table & "_NotifyManually=" & Session("pcAdminpcv_sdsNotifyManually") & "," & pcv_Table & "_CustNotifyUpdates=" & Session("pcAdminpcv_sdsCustNotifyUpdates")
			if pcv_pageType="0" then
	...
	if (pcv_pageType="0") and (request("action")="upd") and (Session("pcAdminpcv_sdsIsDropShipper")="0") then
		...
		do while not rs.eof
			...
			call pcs_hookProductModified(rs("idproduct"), "")
...
<form name="form1" action="<%=pcStrPageName%>?action=add" method="post" class="pcForms" onSubmit="return Form1_Validator(this)">
	<table class="pcCPcontent">
		...
		<tr>
			...
			<td>
			<p>
			Enable Drop-Shipping <a class="pcCPhelp" href="helpOnline.asp?ref=101"></a>
			</p>
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				...
				<tr>
					<th colspan="2">Ship-From Address <a class="pcCPhelp" href="helpOnline.asp?ref=102"></a></th>
				</tr>
				<tr>
					<td class="pcCPspacer" colspan="2"></td>
				</tr>				
				...
				<tr>
					<th colspan="2">Login Information <a class="pcCPhelp" href="helpOnline.asp?ref=103"></a></th>
				</tr>
				<tr>
					<td class="pcCPspacer" colspan="2"></td>
				</tr>
				...
				<tr>
					...
					<td>
					<p>
					Notify customer when order is updated <a class="pcCPhelp" href="helpOnline.asp?ref=104"></a>
					</p>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td nowrap="nowrap"><p>Order Notification E-mail: <a class="pcCPhelp" href="helpOnline.asp?ref=106"></a></p></td>
					<td>
				...
				<tr valign="top">
					<td nowrap="nowrap"><p>Order Notification Content: <a class="pcCPhelp" href="helpOnline.asp?ref=107"></a></p></td>
					<td>
...
[/BODY]</textarea>&nbsp;<img src="images/pc_required.gif" alt="required field" width="9" height="9" align="top"></p></td>
				...
				<tr>
					...
					<td><p>Only Notify Manually <a class="pcCPhelp" href="helpOnline.asp?ref=105"></a></p></td>
				</tr>
				</table>
			</td>
		</tr>
		...
		<tr> 
			...
			&nbsp;
			<input type="submit" name="modify" value="Add <%=pcv_Title%>" class="btn btn-primary">
			</td>
		</tr>
	</table>
