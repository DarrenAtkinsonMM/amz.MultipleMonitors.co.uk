...
%> 
	...
	<tr> 
		<td colspan="3" align="center"> 
			<input type="submit" value="Remove Checked" name="submit" class="btn btn-primary">&nbsp;
			<input type="button" class="btn btn-default"  name="back" value="Back" onClick="location.href='manageOptions.asp'">
		</td>
	</tr>
<% End If %>
