...
<% 
dim pcv_strOrderID, pcv_strSessionOrderID, pcv_intOrderID, pcPageName
...
response.redirect pcPageName & "?msg=" & pcv_strGenericPageError
	Else
		...
		if UPS_TESTMODE="1" then
			...
			UPS_URL="https://onlinetools.ups.com/ups.app/xml/Void"
		end if
...
response.redirect "UPS_ManageShipmentsResults.asp?id=" & pcv_intOrderID & "&msg=Your Shipment has been deleted.&del=YES"
			...
			<table class="pcCPcontent">
				...
				<tr>
					<th colspan="2">UPS&reg; Developer Kit Shipping - Shipment Canceled</th>
				</tr>
				<tr>
					<td colspan="2" class="pcCPspacer"></td>
				</tr>	
...
<table class="pcCPcontent">
	...
	<tr>
		<th colspan="2">UPS&reg; Developer Kit Shipping - Void Shipment Request</th>
	</tr>
    <% if UPS_TESTMODE="1" then %>
        <tr>
            <td colspan="2" class="pcCPspacer"></td>
...
<table class="pcCPcontent">
	...
	<input name="id" type="hidden" value="<%=pcv_intOrderID%>">
		...
		<tr>
			<td></td>
			<td>
			<input type="submit" class="btn btn-default" name="submit" value="Request Void Shipment">
			</td>
		</tr>
	</form>
</table>
