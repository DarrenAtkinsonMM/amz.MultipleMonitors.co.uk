	...
	<tr>
		<td>
			<% if request.form("submit")<>"" then
				...
				Session("ship_USPS_AddressValidation")=request.form("AddressValidation")
				If Session("ship_USPS_AddressValidation")="" Then
					Session("ship_USPS_AddressValidation") = "0"
				End If
				
				' Retrieve USPS user id and secure server URL
				query="SELECT userID, AccessLicense FROM ShipmentTypes WHERE idshipment=4;"
...
response.redirect "techErr.asp?err="&pcStrCustRefID
				...
				Session("ship_USPS_UserId")=trim(rs("userID"))
				Session("ship_USPS_AccessLicense")=trim(rs("AccessLicense"))
				set rs=nothing
...
Priority Mail Medium   Flat Rate Box, 13-5/8" x 11-7/8" x 3-3/8"</td>
                    ...
                    <tr>
                      <th colspan="2">Address Validation</th>
                    </tr>
                    <tr>
                      <td class="pcCPspacer" align="center" colspan="2"></td>
                    </tr>
                    <tr>
                        <td colspan="2">Enable Address Validation :
                            <input name="AddressValidation" type="checkbox" value="1" <% If USPS_AddressValidation="1" then%>checked<% end if %>>
                        </td>
                    </tr>
                    <tr>
