...
<tr>
    ...
    <tr>
        <td colspan="2">           
            ...
            <input type="button" class="btn btn-default"  name="backstep" value="<< Back to Step 2" onClick="location='cwstep2-xls.asp?a=1<%=mtemp%>';">
            &nbsp; <input type="submit" name="submit" value="Go to Step 4 >>" class="btn btn-primary">
        </td>
    </tr>
</table>   
</form>
