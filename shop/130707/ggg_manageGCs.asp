...
<tr>
    ...
    <form name="hForm" method="post" action="ggg_manageGCs.asp">
        ...
        <br><br>
        <input name="SubmitRequest" type="submit" id="SubmitRequest" value="Update Settings" class="btn btn-primary">
        <br><br>
    </form>
</td>
</tr>
        ...
        <table class="pcCPcontent">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input name="submit1" type="submit" value="Search" class="btn btn-primary">&nbsp;
                    <input name="submit2" type="button" class="btn btn-default"  value="View All" onclick="location='ggg_srcGCb.asp?iPageSize=99999&submit2=viewall';">
                </td>
            </tr>
        </table>
        </form>
