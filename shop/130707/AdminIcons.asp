...
<tr> 
	<th colspan="2">Upload New Icons&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=435"></a></th>
...
&nbsp;                           
<input name="default" type="button" class="btn btn-default"  onClick="document.location.href='setIconDefault.asp'" value="Set back to default settings">
&nbsp;
