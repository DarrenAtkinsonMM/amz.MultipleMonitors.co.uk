...
<html>
<head>
	<title>Online Sales Report - Sales by Affiliate</title>
...
End Select
	...
	If rs.EOF Then
		...
		<div class="pcCPmessage">Sorry, no records match your query</div>
	...
	<% Else %>
        ...
        <tr> 
			<td colspan="8">
					...
					recorded<%if strTDateVar<>"" then%>&nbsp;from:&nbsp;<%=strTDateVar%><%end if%><%if strTDateVar2<>"" then%>&nbsp;to:&nbsp;<%=strTDateVar2%><%end if%><br><%end if%>
                    </h2>
			</td>
        </tr>
        <tr> 
		...
		<tr> 
			<th valign="top" align="left" width="12%" nowrap><b><%=tmpD2%></b></th>
			<th valign="top" align="left" width="8%" nowrap><b>ORDER #</b></th>
			<th valign="top" align="left" width="60%"><b>ORDER DETAILS</b></th>
			<th valign="top" align="left" nowrap width="10%"><b>TOTAL SALES</b></th>
			<th valign="top" align="left" nowrap width="10%"><b>ORDER TOTAL</b></th>
			<th valign="top" align="left" nowrap width="10%"><b>SHIPPING</b></th>
			<th valign="top" align="left" nowrap width="10%"><b>TAX</b></th>
			<th valign="top" align="left" nowrap width="10%"><b>COMMISSION</b></th>
		 </tr>
		<% 
		gTotalsales=0
		gTotalOrder=0
...
gSubOrder=gSubOrder-gSubTax
        ...
        <table class="table table-striped">
            <tr bgcolor="#e1e1e1">
                <th colspan="3">&nbsp;</td>
                <th nowrap> <div align="right"><b>Total Sales</b></div></th>
                <th nowrap> <div align="right"><b>Total Orders</b></div></th>
                <th nowrap> <div align="right"><b>Total Shipping</b></div></th>
                <th nowrap> <div align="right"><b>Total Taxes</b></div></th>
                <th nowrap> <div align="right"><b>Total Commissions</b></div></th>
            </tr>
            <tr> 
