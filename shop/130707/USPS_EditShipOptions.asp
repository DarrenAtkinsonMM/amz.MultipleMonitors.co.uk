				...
				<form name="form1" method="post" action="USPS_EditShipOptions.asp">
                    <table class="pcCPcontent">
                        ...
                        do until rs.eof
							...
							case "9901","9902","9904","9905","9906","9907","9908","9909","9910","9911","9912","9914","9915","9916","9917"
							...
							case "9903"
								pTempString=replace(pTempString,"XXXX",pServiceCode)
								pTempString=replace(pTempString,"||||||||||","<tr><td bgcolor='F1F1F1'></td><td colspan='2' bgcolor='F1F1F1'><div class='pcCPmessageInfo' style='margin-right: 10px'><strong>NOTE: </strong> As of January 2016, USPS has renamed 'Standard Post' to 'Retail Ground'. In addition, Retail Ground is not available in Zones 1-4 for anything except hazardous materials, live animals, or cremated remains. As an alternative, they recommend Priority Mail for shipping within Zones 1-4.<br/><br/>For more information on Retail Ground, please visit the <a href='https://www.usps.com/ship/mail-shipping-services.htm' target='_blank'>official page</a> on the USPS website.</div></td></tr>")
								pcv_FormString=pcv_FormString&pTempString
							end select
