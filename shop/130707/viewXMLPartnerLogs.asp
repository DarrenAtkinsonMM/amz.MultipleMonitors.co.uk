...
<table class="pcCPcontent">
	...
	<tr>
		<td class="pcCPspacer">
			<%if Count>0 then%>
				<input type="submit" name="delTrans" value="Delete Selected" class="btn btn-primary" onclick="if (confirm('You are about to remove XML Transaction logs from your database. Are you sure you want to complete this action?')) {return(true)} else {return(false)}">&nbsp;
			<%end if%>
			<input type="button" class="btn btn-default"  name="Main" value="Manage Partners" onClick="location.href='AdminManageXMLPartner.asp'">&nbsp;
					<input type="button" class="btn btn-default"  name="Back" value="XML Tools Manager" onclick="location='XMLToolsManager.asp';"></td>
	</tr>
</table>
</form>
