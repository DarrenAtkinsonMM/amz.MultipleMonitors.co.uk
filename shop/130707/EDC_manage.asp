...
<%IF EDCReg<>"1" then%>
	...
	<tr>
		<td colspan="2">
			<input type="submit" name="submitFormA" value=" Submit " class="btn btn-primary">
		</td>
	</tr>
	</table>
<%ELSE%>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="submit" name="submit1" value=" Update Pass Phrase" class="btn btn-primary">&nbsp;<input type="button" class="btn btn-default"  name="Another" value=" Use another Endicia Account " onclick="location='EDC_manage.asp?action=reenable';"></td>
</tr>
</form>
<tr>
	<td colspan="2" class="pcCPspacer"></td>
...
If (EDCReg="1") AND (EDCUserID>"0") then
    ...
    %>
        ...
        <form action="EDC_manage.asp" name="form2">
        <tr valign="top">
            <td>Refill Amount:</td>
        ...
        <tr>
            ...
            <input type="button" class="btn btn-default"  name="refillbtn" class="btn btn-primary" value=" Refill Account " onclick="if (checkNumber(document.form2.edcrefill)) location='<%=pcPageName%>?edcaction=refill&amount='+document.form2.edcrefill.value;"></td>
        </tr>
        </form>
        <tr>
            <td colspan="2" class="pcCPspacer"></td>
...
<tr>
	<td>&nbsp;</td>
	<td><input type="submit" name="submit2" value=" Update Settings " class="btn btn-primary"></td>
</tr>
<tr>
	<td colspan="2" class="pcCPspacer"></td>
</tr>
