    ...
    <tr>  
    	...
    	<% if (request.querystring("nextstep")=1) then %>
            ...
            <form action="ship-step2.asp" method="post" class="pcForms">
                <table class="pcCPcontent">
                    ...
                    <tr>
                        <td>
                         <input type="submit" name="Go" value="Go to Step 2 >>" class="btn btn-primary">
                        </td>
                    </tr>
                </table>
            </form>
		...
		<%else%>
            ...
            <table class="pcCPcontent">
                ...
                <tr>
                    <td colspan="2"><input type="submit" name="submit" value="Select" class="btn btn-primary"></td>
                </tr>
            </table>
            </form>
        <%end if%>
