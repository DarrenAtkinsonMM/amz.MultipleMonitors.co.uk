...
<table class="pcCPcontent">
    ...
    <tr>
        ...
        &nbsp;&nbsp;<input type="submit" name="Submit1" value="Update Setting" class="btn btn-primary"></td>
    </tr>
    <tr>
        <td colspan="2" class="pcCPspacer"></td>
    </tr>
    ...
    <tr>
        <td colspan="2" class="pcCPspacer"></td>
				...
				<tr>
					<td colspan="2"><input type="submit" name="Submit3" value="Add new" class="btn btn-primary">
