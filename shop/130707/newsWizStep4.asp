...
<tr>
	<td align="center" colspan="2">
		<input type="submit" name="submit" value="Test message" class="btn btn-primary">&nbsp;
		<input type="button" class="btn btn-default"  name="forward" value="Continue Without Testing" onClick="location='newsWizStep5.asp?pagetype=<%=pcv_PageType%>'">&nbsp;
		<input type="button" class="btn btn-default"  name="back" value="Back" onClick="location='newsWizStep3.asp?pagetype=<%=pcv_PageType%>'">
	</td>
</tr>
<tr>
	<td align="center" colspan="2">&nbsp;</td>
