...
response.redirect "AddCountries.asp?s=0&msg=This Country Code is already in use in this system"
	...
	query="insert into Countries (CountryName,CountryCode) values (N'" & CountryName & "','" & CountryCode & "')"
	set rs=connTemp.execute(query)
	set rs=nothing
...
<table class="pcCPcontent">
	...
	<tr>
		<td>
		<input type="submit" name="submit" value="Add New Country" class="btn btn-primary"> 
		<input type="button" class="btn btn-default"  name="Button" value="Back" onClick="location='manageCountries.asp';">
		</td>
	</tr>             
</table>
</form>
