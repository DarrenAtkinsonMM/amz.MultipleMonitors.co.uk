...
if request("action")="create" then
	...
	query="Insert Into pcPriority (pcPri_Name,pcPri_Img,pcPri_ShowImg) values (N'" & strPName &"','" & strPImg &"'," & intPriShowImg & ")"
	set rs=connTemp.execute(query)
	set rs=nothing
...
<table class="pcCPcontent">
  ...
  <tr>
    ...
    <td>
		...
		&nbsp;<input type="button" class="btn btn-default"  name="back" value=" Back " onClick="location='adminFBPriorityManager.asp';">
	</td>
  </tr>
</table>
</form>
