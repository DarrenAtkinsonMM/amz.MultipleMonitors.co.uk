...
if request.form("submit")<>"" then
	...
	query="UPDATE ShipmentTypes SET shipServer='"&USPSServer&"', userID='"&USPSID&"', AccessLicense='"&USPSLabelServer&"' WHERE idShipment=4;"
	set rs=connTemp.execute(query)
	set rs=Nothing

	call closeDb()
	response.redirect "USPS_EditShipOptions.asp"
else %>
