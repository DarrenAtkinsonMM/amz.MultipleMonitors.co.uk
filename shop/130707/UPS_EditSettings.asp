...
%>
<% pageTitle="UPS&reg; Developer Kit Shipping Configuration - Edit Settings" %>
<% Section="shipOpt" %>
<%PmAdmin=4%>
...
*Use	only	alphanumeric	Characters	- &quot;&amp;&quot; symbols are not allowed.</p></td>
					...
					<tr> 
						<td colspan="2" align="center"><input type="submit" name="Submit" value="Update Settings" class="btn btn-primary"></td>
					</tr>
					<tr> 
						<td colspan="3" class="pcCPspacer"></td>
					</tr>
