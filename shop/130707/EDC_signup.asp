...
<div style="margin: 10px; padding: 10px; border: 1px dashed #CCC; font-size: 13px;">
  ...
  <ul>
    ...
    <li> <a href="http://wiki.productcart.com/productcart/shipping-usps#integration_with_endicia" target="_blank">More information</a> on this service.</li>
  </ul>
</div>
...
<tr>
	<td colspan="2" align="center"><input type="submit" name="submit1" value=" Sign-up " class="btn btn-primary"></td>
</tr>
<tr>
	<td colspan="2" class="pcCPspacer"></td>
</tr>
