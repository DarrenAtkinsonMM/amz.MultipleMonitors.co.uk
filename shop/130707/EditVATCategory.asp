...
<table class="pcCPcontent">
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" class="btn btn-default"  name="ManageVATCategories" value="Manage VAT Categories" onclick="document.location.href='viewVAT.asp';">&nbsp;
			<% end if %>
			<input type="button" class="btn btn-default"  name="Button" value="Manage VAT Settings" onClick="document.location.href='AdminTaxSettings_VAT.asp';">
			<input type="button" class="btn btn-default"  name="Button" value="Add/Remove Products" onClick="document.location.href='manageVATCategories.asp?VATID=<%=pcv_intVATID%>';">	
		</td>
	</tr>           
</table>
</form>
