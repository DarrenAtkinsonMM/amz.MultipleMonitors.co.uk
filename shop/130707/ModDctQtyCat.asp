...
<%
Dim idcategory, discountdesc, percentage, baseproductonly, discountPerUnit1, discountPerWUnit1, quantityfrom1, 	nquantityfrom, nquantityUntil, ndiscountPerUnit
...
<table class="pcCPcontent">
       <tr>
		...
		<tr>
			<td>
				<input type="button" class="btn btn-default"  name="back" value=" Category Quantity Discounts " onclick="location='viewCatDisc.asp';">
...
<form method="POST" action="ModDctQtyCat.asp" class="pcForms">		
		...
		<td colspan="5" align="center">
			...
			<input type="button" class="btn btn-default"  name="Delete" value="Delete discount" onClick="javascript:if (confirm('You are about to permanantly delete this discount from the database. Are you sure you want to complete this action?')) location='moddctQtyCat.asp?Delete=Yes&idcategory=<%=idcategory%>'">
		</td>
		</tr>
		<tr>
			<td colspan="5"><hr></td>
		...
		<tr> 
			<td colspan="5" align="center">
			<input type="button" class="btn btn-default"  name="Apply" value="Apply to Other Categories" onClick="location.href='ApplyDctToCats.asp?idcategory=<%=idcategory%>'">&nbsp;
			<input type="button" class="btn btn-default"  value="Locate Another Category" onClick="location.href='viewCatDisc.asp'">
			</td>
		</tr>
		<tr>
			<td colspan="5" class="pcCPspacer"></td>
