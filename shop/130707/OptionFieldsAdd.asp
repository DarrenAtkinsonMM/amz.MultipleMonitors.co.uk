...
if request.form("Add")="Add" then
	...
	mySQL="Insert into customCardRules (idCustomCardType,ruleName,intruleRequired, intlengthOfField,intMaxInput, intOrder) values ("&pidcustomcardtype&",N'"&ruleName&"',"&intruleRequired&", "&intlengthOfField&", "&intMaxinput&", 0)"
