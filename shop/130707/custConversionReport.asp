...
<head>
	...
	<link href="../pc/css/bootstrap.min.css" media="screen" rel="stylesheet" type="text/css">
...
<div id="pcCPmain" style="background-image: none;">
	<div class="table-responsive">
        ...
        <tr>
            ...
            <th nowrap>Total Customers</th> 
            <th nowrap>Total Orders</th> 
            <th nowrap>Total Drop-Off</th>
            <th nowrap>Drop-Off Percent</th>
            <th nowrap>Total Drop-Off Units</th> 
            <th nowrap>Total Drop-Off Amount</th>
        </tr>
        <%
		...
		for lCnt=0 to ubound(custArr)
			...
			<tr>
				...
				<td nowrap><%=pcv_Customers%></td> 
				<td nowrap><%=pcv_Total%></td> 
				<td nowrap><%=pcv_Incomp%></td> 
				<%
					dropOffPercent=0
		...
		%>
			<tr bgcolor="#e1e1e1">
				...
				<td nowrap><%=gCustomers%></td> 
				<td nowrap><%=gTotal%></td> 
				<td nowrap><%=gIncomp%></td> 
				<%
					dropOffPercent=0
				...
				%>
				<td nowrap><%=dropOffPercent%>%</td> 
				<td nowrap><%=gTotalQty%></td>
				<td nowrap><%=scCurSign&money(gTotalsales)%></td>
			</tr>
			<tr>         
