	...
	<table class="pcCPcontent">
		...
		<tr> 
			...
			<td width="40%" align="center" valign="middle"> 
				<input id="up" type="button" class="btn btn-default"  value="Move Up" onClick="moveSelected(dest,false)" />
				<br /><br />		
				<input id="down" type="button" class="btn btn-default"  value="Move Down" onClick="moveSelected(dest,true)" />
				<br /><br />
				<input type="hidden" name="destItems" />
				<input  name="submit" type="submit" onClick="return setHidden(this.form)" value="Save" class="btn btn-primary"/>
			</td>
		</tr>
		<tr>
			<td class="pcCPspacer"></td>
		...
		<tr>           
			<td align="center" colspan="2">
				<input type="button" class="btn btn-default"  value="Shipping Options Summary" onClick="location.href='viewShippingOptions.asp'">
				&nbsp;
