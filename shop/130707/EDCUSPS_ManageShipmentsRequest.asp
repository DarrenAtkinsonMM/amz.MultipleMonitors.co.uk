	...
	if pcv_shipmentDetails<>"" then
		...
		if UCase(tmpArr(0))="USPS" then
			if tmpArr(5)<>"" then
				...
				Case "9902": tmpEDCShipMethod="PriorityExpress"
				Case "9903": tmpEDCShipMethod="StandardPost"
				Case "9904": tmpEDCShipMethod="First"
				Case "9905": tmpEDCShipMethod="PriorityMailExpressInternational"
				Case "9906": tmpEDCShipMethod="PriorityMailExpressInternational"
				...
				Case "9910": tmpEDCShipMethod="PriorityMailExpressInternational"
				Case "9911":
							tmpEDCShipMethod="PriorityMailExpressInternational"
							tmpEDCPackType="FlatRateEnvelope"
				Case "9912": tmpEDCShipMethod="FirstClassMailInternational"
				Case "9914": tmpEDCShipMethod="PriorityMailExpressInternational"
		...
		<td>
			...
			IF (request.form("submit")<>"") THEN
				...
				if (session("pcEDCMailClass")="") then
					session("pcEDCMailClass")="PriorityExpress"
				end if
				...
				For pcv_xCounter = 1 to pcPackageCount
					...
					if session("pcEDCLabelType")<>"Default" OR session("pcEDCMailClass")="PriorityExpress" then
					...
					IF (tmpCode=1) AND (EDC_ErrMsg="") THEN
						...
						'// SAVE all data to the database
								...
								if session("pcAdminMarkedAsShipped")="1" then
									query="UPDATE pcPackageInfo SET pcPackageInfo_ShippedDate='" & dtShippedDate & "', pcPackageInfo_Comments=N'" & Session("pcAdminAdmComments") & "' WHERE idOrder="&pcv_intOrderID&" AND pcPackageInfo_ID="&pcv_PackageID&";"
									set rs=connTemp.execute(query)
									set rs=nothing
                            ...
                            <tr>
                              <td colspan="2" class="pcCPspacer"><p>Postage for this shipment was calculated successfully and is shown below. Click the &quot;Process Shipment&quot; button to purchase this postage from Endicia and print the shipping label. If there is a problem with the shipment, you can request a refund.
                                ...
                                <div style="text-align: center; margin-top: 15px;">
                                	<input type="button" class="btn btn-default"  name="submit" value="Process Shipment" class="btn btn-primary" onclick="javascript:DisableButton(this);pcf_Open_EndiciaPop();document.location.href='<%=pcPageName%>?endicia=buypostage'">
                                    &nbsp;
                                    <input type="button" class="btn btn-default"  name="Button" value="Change Shipment Settings" onClick="document.location.href='<%=pcPageName%>'">&nbsp;
                                    <input type="button" class="btn btn-default"  name="Button" value="Go Back To Order Details" onClick="document.location.href='OrdDetails.asp?id=<%=Session("pcAdminOrderID")%>'">
                                </div>
                                </p>
                              </td>
                            </tr>
							...
							<td valign="top">
								...
								<table class="pcCPcontent">
									...
									<tr>
										...
										<input type="button" class="btn btn-default"  name="refillbtn" class="btn btn-primary" value=" Refill Account " onclick="if (checkNumber(document.form1.edcrefill)) location='<%=pcPageName%>?edcaction=refill&amount='+document.form1.edcrefill.value;"></td>
									</tr>
									<%end if%>
									<%else%>
									<tr>
								...
								<table class="pcCPcontent">
									...
									<tr>
                                        ...
                                        <b>Domestic:</b>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="PriorityExpress" <%if (session("pcEDCMailClass")="PriorityExpress") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/priority-mail-express.htm" target="_blank">Priority Mail Express</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('DestinationConfirm',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="FirstLetter" <%if (session("pcEDCMailClass")="FirstLetter") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/first-class.htm" target="_blank">First-Class, Letter</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('DestinationConfirm',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="FirstEnvelope" <%if (session("pcEDCMailClass")="FirstEnvelope") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/first-class.htm" target="_blank">First-Class, Large Envelope</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="First" <%if (session("pcEDCMailClass")="First") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/first-class.htm" target="_blank">First-Class, Package</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="LibraryMail" <%if (session("pcEDCMailClass")="LibraryMail") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/business/library-mail-for-business.htm" target="_blank">Library Mail</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="MediaMail" <%if (session("pcEDCMailClass")="MediaMail") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/media-mail.htm" target="_blank">Media Mail</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="StandardPost" <%if (session("pcEDCMailClass")="StandardPost") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/standard-post.htm" target="_blank">Standard Post</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="ParcelSelect" <%if (session("pcEDCMailClass")="ParcelSelect") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/business/parcel-select.htm" target="_blank">Parcel Select</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="Priority" <%if (session("pcEDCMailClass")="Priority") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/priority-mail.htm" target="_blank">Priority Mail</a>
                                        </td>
                                        <td style="padding: 15px;" valign="top">
                                        <b>International:</b>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="PriorityMailExpressInternational" <%if (session("pcEDCMailClass")="PriorityMailExpressInternational") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/priority-mail-express-international.htm" target="_blank">Priority Mail Express International</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="FirstClassMailInternational" <%if (session("pcEDCMailClass")="FirstClassMailInternational") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/first-class-international.htm" target="_blank">First-Class Mail International</a>
                                        <br />
                                        <input type="radio" name="edcMailClass" onClick="javascript:setMSOptions1('Default',this.value);ShowHideExServices(this.value);ShowHideSCServices(this.value);" value="PriorityMailInternational" <%if (session("pcEDCMailClass")="PriorityMailInternational") then%>checked<%end if%> class="clearBorder"> <a href="https://www.usps.com/ship/priority-mail-international.htm" target="_blank">Priority Mail International</a>
                                        </td>
									</tr>
									<tr>
                                        <td colspan="2" class="pcCPspacer"></td>
...
response.redirect "techErr.asp?err="&pcStrCustRefID
									...
									<div id="tab<%=4+int(k)%>" class="panes">				
                                    	<table class="pcCPcontent">
                                        	...
                                        	if pcLocalArray(k-1) <> "shipped" then %>
												...
												<tr>
													...
													if (session("pcEDCShape" & k)="") then
														if tmpEDCPackType="" then
															if session("pcEDCMailClass")="PriorityExpress" then
													  ...
													  <script type=text/javascript>
															...
															{ 
																...
																if (lt == "Default")
																{
																	...
																	if (mc == "PriorityMailExpressInternational")
																	{
																		select2.options[select2.options.length] = new Option("Flat","Flat");
																		select2.options[select2.options.length] = new Option("Parcel","Parcel");
																		select2.options[select2.options.length] = new Option("Flat Rate Envelope","FlatRateEnvelope");
																...
																if (lt == "International")
																{
																	...
																	if ((mc != "PriorityMailExpressInternational") && (mc != "FirstClassMailInternational") && (mc != "PriorityMailInternational"))
																	{
																		select2.options[select2.options.length] = new Option("Parcel","Parcel");
																	}
																}
															...
															{
																if ((tmpValue=="PriorityExpress") || (tmpValue=="FirstLetter") || (tmpValue=="FirstEnvelope"))
																{
												...
												<tr>
													<td colspan="2">
													<table id="signCon" <%if session("pcEDCLabelType")<>"Default" OR session("pcEDCMailClass")="PriorityExpress" then%>style="display:none"<%end if%> class="pcCPcontent" style="width: 100%; margin: 0;">
													<tr>
														<td colspan="2" class="pcCPspacer"></td>
													</tr>
													<tr>
												...
												<tr>
													<td colspan="2">
													<table id="ExServices" <%if (session("pcEDCMailClass")<>"PriorityExpress") then%>style="display:none"<%end if%> class="pcCPcontent" style="width: 100%; margin: 0;">
													<tr>
														<td colspan="2" class="pcCPspacer"></td>
													</tr>
													<tr valign="top">
                                ...
                                %>
                                <div align="center">
                                   <input type="submit" name="submit" value="<%if (EDCTestMode="1") then%>Process Shipment<%else%>Calculate Postage Price<%end if%>" onClick="javascript:pcf_Open_EndiciaPop();" <%if tmpEDC<>"1" then%>disabled<%end if%> class="btn btn-primary">
                                   &nbsp;
