...
<table class="pcCPcontent">
    ...
    <tr>
    	<td colspan="2">
            ...
            <div style="padding-top:6px;">ProductCart can create an XML sitemap of your store, based on that protocol. <a href="http://wiki.productcart.com/productcart/marketing-generate_sitemaps" target="_blank"><img src="images/pcv3_infoIcon.gif" width="16" height="16" alt="More information on this feature"></a></div>
        </td>
	</tr>
	<tr>
    	<td colspan="2" class="pcCPspacer"></td>
...
response.redirect "techErr.asp?error="& Server.Urlencode("Error in retreiving categories from database on genGoogleSiteMap.asp: "&Err.Description) 
    ...
    <tr>
        ...
        <td>
            For example, non-ProductCart pages. <a href="http://wiki.productcart.com/productcart/marketing-generate_sitemaps" target="_blank">See the documentation</a> about the location of the Sitemap file.<br /><u>Note</u>: Enter one URL per line
            <div style="padding-top: 6px">
        	<%
            URLList=""
    ...
    <tr> 
        <td colspan="2" align="center">  
        	<input name="submit" type="submit" class="btn btn-primary" value="Generate Site Map">
        </td>
    </tr>
</table>
</form>
