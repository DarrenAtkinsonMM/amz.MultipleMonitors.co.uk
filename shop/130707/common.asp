...
For i=1 to request("validfields")
	...
	BLine=23
	Case "Alt Tag Text": alttagtextid=request("P" & i)
	BLine=144
	...
	'APP-S
  	 Case "Apparel product": ApparelID=request("P" & i)
	BLine=59
  	 Case "Show out of stock items": ShowoutID=request("P" & i)
	BLine=60
  	 Case "Out of stock items message": OutMsgID=request("P" & i)
	BLine=61

  	 Case "Display type": DTypeID=request("P" & i)
	BLine=63
  	 Case "Size chart text link": ChartTextID=request("P" & i)
	BLine=64
  	 Case "Size chart description": ChartDescID=request("P" & i)
	BLine=65
  	 Case "Size chart image file": ChartImgID=request("P" & i)
	BLine=66
  	 Case "Size chart image URL": ChartIURLID=request("P" & i)
	BLine=67
	'APP-E
	...
	BLine=101
	Case "Hide Configurator Price": hidebtopriceid=request("P" & i)
	BLine=102
	...
	BLine=113
	Case "Meta Tags - Title": mt_titleID=request("P" & i)
	BLine=114
	Case "Meta Tags - Description": mt_descID=request("P" & i)
	BLine=115
	Case "Meta Tags - Keywords": mt_keyID=request("P" & i)
	BLine=116
	...
	Case "Hide Additional Images": hideaddimagesid=request("P" & i)
	BLine=143
	...
	Case "Product Layout - Top Area": layTopId=request("P" & i)
	BLine=132
	
	Case "Product Layout - Top-Left Area": layTopLId=request("P" & i)
	BLine=133
	
	Case "Product Layout - Top-Right Area": layTopRId=request("P" & i)
	BLine=134

	Case "Product Layout - Middle Area": layMiddleId=request("P" & i)
	BLine=135
	
	Case "Product Layout - Tabs Area": layTabsId=request("P" & i)
	BLine=136
	
	Case "Product Layout - Bottom Area": layBottomId=request("P" & i)
	BLine=137
	
	Case "Pricing Category (1)": pricecatsid(0)=request("P" & i)
	BLine=138
	Case "Pricing Category (2)": pricecatsid(1)=request("P" & i)
	BLine=139
	Case "Pricing Category (3)": pricecatsid(2)=request("P" & i)
	BLine=140
	Case "Pricing Category (4)": pricecatsid(3)=request("P" & i)
	BLine=141
	Case "Pricing Category (5)": pricecatsid(4)=request("P" & i)
	BLine=142
