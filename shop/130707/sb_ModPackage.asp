...
' END show message 
%>
<form id="form1" name="form1" method="post" action="<%=pcv_strPageName%>" onSubmit="return Form1_Validator(this)" class="pcForms">
<table class="pcCPcontent">
    ...
    <tr>
        <td>
            ...
            <input type="submit" name="submit1" value=" Update Package " class="btn btn-primary">&nbsp;
            <input type="button" class="btn btn-default"  name="back" value=" Modify Package Settings " onclick="location='sb_ModPackSettings.asp?idmain=<%=pcv_intIDMain%>';">&nbsp;
            <input type="button" class="btn btn-default"  name="back" value="Back to Main Menu" onclick="location='sb_Default.asp';">
        </td>
    </tr>
    <% end if %>
</table>
