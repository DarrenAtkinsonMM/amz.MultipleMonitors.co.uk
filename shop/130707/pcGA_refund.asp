...
dim pOID, pcGAtransaction, paffiliateName, paffiliateCompany, ptaxAmount, ptaxDetails, pshipmentDetails, ptotal, pGetItems, pcItemArray, pcItemArrayCount, iCount, itemInfo, pExistsInLog
		...
		IF (pOID<>"" and pNextAction="YES") OR (pOID<>"" and pExistsInLog<>1) THEN ' 1
				...
				<form action="pcGA_refundSubmit.asp" class="pcForms" method="post" name="GArefund">
					...
					<table class="pcCPcontent">
						...
						<tr>
							<th colspan="4">Order #: <%=(scpre+int(pIdOrder))%> - General Information&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=315"></a></th>
						</tr>
						<tr>
					...
					<table class="pcCPcontent">
						...
						<tr>
							<th colspan="4">Order #: <%=(scpre+int(pIdOrder))%> - Item Information&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=315"></a></th></th>
						</tr>
						<tr>
							<td colspan="4" class="pcCPspacer"></td>
						</tr>
						...
						<tr>
							<td colspan="4">
								<input type="submit" class="btn btn-primary" value="Post Adjustments">&nbsp;
				...
				<table class="pcCPcontent">
					<tr> 
						...
						<form action="pcGA_refund.asp" method="post" class="pcForms">
							...
							<input type="button" class="btn btn-default"  value="View Logs" onClick="document.location.href='pcGA_logs.asp'">
						</form>			
						</td>
					</tr>
				</table>
