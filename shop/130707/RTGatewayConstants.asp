...
pcGWArray="//,88,13,39,1,57,29,33,52,32,60,67,65,42,54,31,37,58,30,5,8,11,27,55,59,64,12,47,48,4,26,40,49,63,70,24,35,56,10,9,1101,1103,//"
...
function gwShowDesc()
	select case varNonActive
		...
		case 40
			gwNETOne="1"
			pcGWPaymentDesc="Sage Payment Solutions"
		...
		case 67	
			...
			pcGWPaymentURL="http://www.productcart.com/"
			pcGWClassification="BANK"
		case 70
		 	gwTXP="1"
		...
		case 46
			gwPPPDP="1"
			pcGWPaymentDesc="PayPal Payments Pro (Direct Payments)"
			pcGWPaymentURL="http://www.PayPal.com"
		case 53
			gwPPP="1"
		...
		case 1113
			gwBrainT="1"
			pcGWPaymentDesc="BrainTree Gateway"
			pcGWPaymentURL="https://www.braintreepayments.com/"
		case 88
			gwAMZP="1"
			pcGWPaymentDesc="Pay with Amazon"
			'pcGWPaymentURL="http://services.amazon.com/amazon-payments/payments-home.html"
			pcGWPaymentURL="https://developer.amazonservices.com/gp/mws/"
		case 0
			pcGWPaymentDesc=""
			pcGWPaymentURL=""
			pcGWClassification=""
		case 1101
			gwPayEzy="1"
			pcGWPaymentDesc="Payeezy Gateway"
			pcGWPaymentURL="http://www.firstdatapartners.com/ecommerce/?partner=product-cart"
		case 1103
			gwaDPM="1"
			pcGWPaymentDesc="Authorize.Net Direct Post Method (DPM) Gateway"
			pcGWPaymentURL="http://developer.authorize.net/api/dpm/"
			pcGWClassification="BANK"
		end select
end function
