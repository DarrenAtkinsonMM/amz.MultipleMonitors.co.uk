...
Dim CSVRecord(300),f, rstemp1,TopRecord(100), IDcustom(2), Customcontent(2)
Dim IDPriceCat(4)
...
<%
	...
	if (pricecatsid(0)>-1) OR (pricecatsid(1)>-1) OR (pricecatsid(2)>-1) OR (pricecatsid(3)>-1) OR (pricecatsid(4)>-1) then
		...
		if pricecatsid(0) > -1 then
			pricecatsname(0)=B(pricecatsid(0))
		...
		if pricecatsid(1) > -1 then
			pricecatsname(1)=B(pricecatsid(1))
		...
		if pricecatsid(2) > -1 then
			pricecatsname(2)=B(pricecatsid(2))
		...
		if pricecatsid(3) > -1 then
			pricecatsname(3)=B(pricecatsid(3))
		...
		if pricecatsid(4) > -1 then
			pricecatsname(4)=B(pricecatsid(4))
