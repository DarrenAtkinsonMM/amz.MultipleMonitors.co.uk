...
if validNum(lngIDOrder) then
	...
	IF rstemp.eof Then
		...
		call closeDb()
		Session("message") = dictLanguage.Item(Session("language")&"_viewPostings_a")
...
<table class="pcCPcontent">
	<tr>
		...
		<th nowrap>Order #<a href="adminviewallmsgs.asp?Order=pcComm_IDOrder&Sort=Desc<%=addQueryString%>"><img src="images/sortdesc.gif" width="14" height="14" alt="Sort Descending" border="0"></a><a href="adminviewallmsgs.asp?Order=pcComm_IDOrder&Sort=Asc<%=addQueryString%>"><img src="images/sortasc.gif" width="14" height="14" alt="Sort Ascending" border="0"></a></th>
		<th nowrap>Priority<a href="adminviewallmsgs.asp?Order=pcComm_Priority&Sort=Desc<%=addQueryString%>"><img src="images/sortdesc.gif" width="14" height="14" alt="Sort Descending" border="0"></a><a href="adminviewallmsgs.asp?Order=pcComm_Priority&Sort=Asc<%=addQueryString%>"><img src="images/sortasc.gif" width="14" height="14" alt="Sort Ascending" border="0"></a></th>
...
<div style="margin-top: 20px;">
    ...
    <table class="pcCPcontent">
        ...
        <tr>
            <td width="10%">Date:</td>
            <td width="90%">From: <input type=text name="FromDate" class="datepicker" size="10" value="<%=FromDate%>"> To: <input type=text name="ToDate" class="datepicker" size="10" value="<%=ToDate%>"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <input type="button" class="btn btn-default"  value="Write New Message" onClick="location.href='adminaddfeedback.asp?type=1&IDOrder=<%=tmpIDOrder%>'">&nbsp;
            <input type="button" class="btn btn-default"  value="Manage Help Desk" onClick="location.href='adminFBsettings.asp'">
            </td>
        </tr>
    </table>
    </form>
