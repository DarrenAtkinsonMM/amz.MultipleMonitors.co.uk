...
If session("ForgotAttackCount") < 5 Then
    ...
    <div id="callout-alerts-no-default" class="bs-callout bs-callout-info">
        <h4>Note:</h4>
        <p>The "Forgot User Name" feature is limited to the store administrator. If you are not the store administrator, then you must contact the store administrator to obtain a username.</p> 
    </div>
		  
	<form action="forgot_username.asp" method="post" name="forgot_username" class="pcForms">
