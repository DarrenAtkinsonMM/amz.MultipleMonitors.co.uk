		...
		<form name="form1" method="post" action="creditCardPurge.asp" class="pcForms">
			...
			<table class="pcCPcontent" style="width: 400px;">
				...
				<% else %>
                    ...
                    <tr>
                        <td colspan="3">
                            <input name="PurgeNumbers" type="submit" class="btn btn-primary" value="Purge Credit Card Numbers">
                            &nbsp;&nbsp;
                            <input type="button" class="btn btn-default" value="Back" onClick="location='creditCardPurge.asp';">
                        </td>
                    </tr>
				<% end if %>
			</table>
                    ...
                    <form action="creditCardPurge.asp" method="post"  name="CCPurgeSearch" class="pcForms">
                        ...
                        <table cellpadding="4" cellspacing="2">
                            ...
                            <tr>
                                <td>&nbsp;</td>
                                <td>
                                	<input type="submit" name="search1" value="View " class="btn btn-primary">
									&nbsp;&nbsp;
                        			<input type="button" class="btn btn-default" value="Back" onClick="location='creditCardPurge_index.asp';">
                                </td>
                            </tr>
                    	</table>
					</form>
