...
if request("action")="add" then
	...
	query="INSERT INTO pcGWOptions (pcGW_OptName,pcGW_OptImg,pcGW_OptPrice,pcGW_OptActive,pcGW_OptOrder) values (N'" & OptName & "','" & OptImg & "'," & OptPrice & "," & OptActive & "," & OptOrder & ");"
...
<tr> 
	<td align="center" colspan="2">
		<br>
		<input name="add" type="submit" class="btn btn-primary" value=" Add option ">
		&nbsp;
		<input name="back" type="button" class="btn btn-default"  onClick="location='ggg-GiftWrapOptions.asp';" value="Back">
	</td>
</tr>
</table>
</form>
