...
<tr>
	<td>
		...
		<ul class="pcListIcon">
            <li><a href="AdminSettings.asp?tab=6">Turn Help Desk On/Off</a></li>
...
<tr>
	<td>
		...
		<form method="post" name="filter" action="adminviewallmsgs.asp">
			<input type=hidden name="Type" value="1">
			<p style="padding-top:10px;">Date From: <input type="text" class="datepicker" name="FromDate" size="10" value="<%=dtInputStrStart%>"> To: <input type="text" class="datepicker" name="ToDate" size="10" value="<%=dtInputStr%>"></p>
			<p style="padding-top:10px;">Show <input type="text" name="FBPerpage" size="5" value="25"> postings per page</p>
			<p style="padding-top:10px;"><input type="submit" name="submit" value="View Messages" class="btn btn-primary">&nbsp;
			<input type="button" class="btn btn-default"  value="Write New Message" onClick="location.href='adminaddfeedback.asp?type=1'"></p>
		</form>
		</td>
	</tr>
</table>
