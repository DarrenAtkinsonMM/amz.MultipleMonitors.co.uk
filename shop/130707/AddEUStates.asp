...
response.redirect "AddEUStates.asp?s=0&msg=" & Server.URLEncode("This EU Member State already exists in this system")
		...
		query="INSERT INTO pcVATCountries (pcVATCountry_State, pcVATCountry_Code) VALUES (N'" & StateName & "','" & Country & "')"
		set rs=connTemp.execute(query)
		set rs=nothing
...
<table class="pcCPcontent">
	...
	<tr>
		<td colspan="2">
			...
			<input type="button" class="btn btn-default"  name="Button" value="Back" onClick="location='manageEUStates.asp';">
		</td>
	</tr>       
</table>
</form>
