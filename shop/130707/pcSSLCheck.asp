...
<div id="pcCPmain" style="width:275px;">
<form action="pcSSLCheck.asp" name="form1" method="post" class="pcForms">
    	...
    	<td>
			...
			<table>
				<tr> 
					...
					<td width="96%">Your Store's SSL is <b>NOT</b> configured properly. Make sure that the kind of SSL certificate used on your store is in compliance with the <a href="http://www.productcart.com/system-requirements.asp#SSL" target="_blank">ProductCart system requirements</a>.</td>
				</tr>
			</table>
			<%
			end if
