...
<table class="pcCPcontent">
    ...
    <tr>
        <td>
            ...
            <input type="submit" name="submit1" value=" Update Settings " class="btn btn-primary">&nbsp;
            <input type="button" class="btn btn-default"  name="back" value=" Modify Package " onclick="location='sb_ModPackage.asp?idmain=<%=pcv_intIDMain%>';">&nbsp;
