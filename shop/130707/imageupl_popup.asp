...
'//DETAILED MSG
dim pcTmpErr, pcTmpErrSize, pcUploadAllowed
pcTmpErr = Cstr("")
pcTmpErrSize = Cint(0)
...
If InValidImage > 0 then
	...
	if pcTmpErrSize = 1 then
		...
		if pcUploadAllowed = false then
			response.write "<br><div align=center><font face=arial size=2>" & InValidImage & " of your " & ImageCnt & " images have a filename that is not allowed in ProductCart. Please check the filename(s) and make sure they don't include any of the blacklisted characters.<br><br>Blacklisted Characters:<br><br><strong>" & Join(BlackList, "</strong>&nbsp;&nbsp;<strong>") & "</strong><br><br><a href=""javascript:history.go(-1)""><font face="&Link&">Back</font></a></font></div>"
		else
