    ...
    <table class="pcCPcontent">
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;<input type="button" class="btn btn-default"  name="Button" value=" Back " onClick="location='<%if request("mode")="all" then%>ggg_AdmManageGCs.asp<%else%>ggg_AdmSrcGCb.asp<%end if%>';">
            </td>
        </tr>
    </table>
</form>
