...
%>
			...
			<tr> 
				<td align="center">
				<form class="pcForms">
					<input type="button" class="btn btn-default"  name="addnew" value="Create New Registry" onclick="javascript:location='ggg_instGR.asp?idcustomer=<%=pcv_IdCustomer%>';" class="btn btn-primary">
					&nbsp;
					<input type="button" class="btn btn-default"  name="back" value="View/Edit Customer" onclick="location.href='modcusta.asp?idcustomer=<%=pcv_IdCustomer%>';">
				</form>
				</td>
			</tr>
	<% else %>
