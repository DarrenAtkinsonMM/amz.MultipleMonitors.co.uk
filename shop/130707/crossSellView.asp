...
END IF
	...
	if pcIntCategoryID = "" then
		pcIntCategoryID = 0
	end if
	
	if validNum(pcIntCategoryID) and pcIntCategoryID > 0 then
	...
	<table class="pcCPcontent">
		<tr>
			<td colspan="4" align="right">
                ...
                Results per page:
                <select name="iPageSize" onchange="javascript:location='crossSellView.asp?idcat=<%=pcIntCategoryID%>&iPageSize='+document.checkboxform.iPageSize.value;">
                ...
                cat_StoreFront="0"
                cat_ShowParent="1"
                cat_DefaultItem="All Products"
                cat_SelectedItems="0," & pcIntCategoryID
                cat_ExcItems=""
                cat_ExcSubs="0"
...
%>								
	...
	<tr> 
		...
		<input type="submit" value="Delete selected" name="submit1" class="btn btn-primary" onclick="return(confirm('You are about to completely remove the selected cross selling relationships. If you only want to remove one or more products from a specific relationship, click CANCEL and then select EDIT for that cross selling relationship. Click OK to confirm the removal.'));">&nbsp;
		<input type="button" class="btn btn-default"  value="Add new" onClick="location.href='crossSellAdd.asp'">&nbsp;
		<input type="button" class="btn btn-default"  value="Edit Settings" onClick="location.href='crossSellSettings.asp'">&nbsp;
		</td>
	</tr>
