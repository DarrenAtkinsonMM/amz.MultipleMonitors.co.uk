...
dim rstemp2, strtext, File1, pcv_rootCat, strParent, intIdProduct
                ...
                <td>
                    ...
                    <% Else %>
                        <table class="pcCPcontent">
                            ...
                            <tr>
                                <td colspan="4">
                                    <input type="submit" name="Submit1" value="Generate Bing Cashback Bulk Upload File" onClick="pcf_Open_GoogleBase();" class="btn btn-primary">
									<%
									'// Loading Window
...
IF request("action")="gen" THEN
	...
	File1 = File1 & ".txt"
	call pcs_SaveUTF8(File1, File1, strtext)
	%>
	<table class="pcCPcontent">
		<tr>
			<td>
				...
				<br>
				<form class="pcForms">
					<input type="button" class="btn btn-default" name=back value="Create Another File" onClick="location='exportCashBack.asp'">&nbsp;
...
IF request("action")<>"add" AND request("action")<>"gen" THEN
    ...
    <form name="form1" method="post" action="exportCashBack.asp?action=add" onSubmit="return Form1_Validator(this)" class="pcForms">
        ...
        <table class="pcCPcontent">
          ...
          <tr>
          	<td>ProductCart can help you upload product information to your Microsoft Bing Cashback merchant account. For more information about submitting your products to Bing Cashback, please <a href="http://wiki.productcart.com/productcart/marketing-generate_cashback_file" target="_blank">consult our documentation</a>.
            <br /><br />
          ...
          <tr>
          	<td class="pcCPsectionTitle">Product Title</td>
					...
					<tr>
            <td>
                You need to create your own <strong>Title</strong> using the 3 options below. Each option will be separated by ">>>". Click here to learn more &nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=213"></a>.
                <br />
                <br />
...
<strong>Select the categories</strong> that you would like to include in the Cashback Base Bulk Upload file. Press down the CTRL key on your keyboard to select multiple entries. DO NOT select &quot;All Categories&quot; if your store has thousands of products.<br /><br />
        ...
        <tr>
            <td align="center">
                <input type="submit" name="Submit" value="Generate Bing Cashback Data Feed" onClick="pcf_Open_GoogleBase2();" class="btn btn-primary">
				<%
				'// Loading Window
				'	>> Call Method with OpenHS();
