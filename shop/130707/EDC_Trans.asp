...
<tr>
	<td>&nbsp;</td>
	<td><%if HaveRecords=1 then%><input type="button" class="btn btn-default"  name="del" value=" Remove All Transaction Log(s) " onclick="javascript:location='EDC_Trans.asp?action=removeall';" class="btn btn-primary">&nbsp;&nbsp;<%end if%><input type="button" class="btn btn-default"  name="back" value=" Back to Manage Endicia Settings " onclick="javascript:location='EDC_manage.asp';" class="btn btn-primary"></td>
</tr>
</table>
