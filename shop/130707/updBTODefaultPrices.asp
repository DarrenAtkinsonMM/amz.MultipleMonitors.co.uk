...
<% pageTitle = "Quickly update all Configurable Product default prices" %>
<% Section = "" %>
<%PmAdmin=2%>
...
<tr>
	<td>
		...
		<br>
		<br>
        <input type="button" class="btn btn-default"  name="updateDefault" value="Update Base Prices" onClick="document.location.href='updBTOPrdPrices.asp'">&nbsp;
        <input type="button" class="btn btn-default"  name="updateDefault" value="Update Configuration Prices" onClick="document.location.href='updateBTOprices.asp'">&nbsp;
	</td>
</tr>
</table>
<%ELSE%>
...
<tr>
	<td>
		Select <strong>Update Configurable Product default prices</strong> to update all the default prices. See <a href="http://wiki.productcart.com/bto/btoaddnew#understanding_base_and_default_price" target="_blank">Understanding Base and Default Prices</a> for details on what a Default Price is.
	</td>
</tr>
<tr>
	<td><hr></td>
...
<tr>
	<td align="center">
		<input type="submit" name="submit" value="Update Configurable Product default prices" class="btn btn-primary">&nbsp;
        <input type="button" class="btn btn-default"  name="updateDefault" value="Update Base Prices" onClick="document.location.href='updBTOPrdPrices.asp'">&nbsp;
        <input type="button" class="btn btn-default"  name="updateDefault" value="Update Configuration Prices" onClick="document.location.href='updateBTOprices.asp'">&nbsp;
	</td>
</tr>
