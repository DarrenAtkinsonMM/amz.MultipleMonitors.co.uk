...
response.redirect "ModAllDctQtyCat.asp?idcategory="&idcategory&"&msg="&msg
		...
		<tr> 
			...
			<input type="button" class="btn btn-default"  name="Delete" value="Delete discount" onClick="javascript:if (confirm('You are about to permanantly delete this discount from the database. Are you sure you want to complete this action?')) location='modAllDctQtyCat.asp?Delete=Yes&idcategory=<%=idcategory%>'">&nbsp;
