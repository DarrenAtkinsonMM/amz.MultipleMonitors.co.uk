			...
			<td valign="top">
				<table class="pcCPcontent">
					...
					<tr>
						...
						<td>
						<p>
							<input type="submit" name="submit" value="Add New Zone" class="btn btn-primary">&nbsp;
						  <input name="button" type="button" class="btn btn-default"  onClick="location.href='pcTaxViewZones.asp'" value="Back">&nbsp;
