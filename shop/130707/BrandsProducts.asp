        ...
        <table class="pcCPcontent">
			...
			%>
                <tr onMouseOver="this.className='activeRow'" onMouseOut="this.className='cpItemlist'" class="cpItemlist"> 
                    ...
                    <td><%=pcStrSku%></td>
                    <td><a href="FindProductType.asp?idproduct=<%=IDProduct%>" target="_blank"><%=pcStrDesc%></a> <%if serviceSpec<>0 then%>(Configurable)<%end if%></td>
                </tr>
            <%
				next
			end if
            ...
            <tr>
            	<td colspan="3">
                    ...
                    <input type="submit" name="submit" value="Remove Unchecked" class="btn btn-primary">&nbsp;
                    <% end if %>
                    <input type="button" class="btn btn-default"  value="Assign Other Products" onClick="location='BrandsAssign.asp?idbrand=<%=pcIntBrandID%>';">&nbsp;
                    <input type="button" class="btn btn-default"  value="Manage Brands" onClick="location='BrandsManage.asp';">
                </td>
             </tr>            
		</table>
	</form>
