...
<form method="post" action="pcSecureKeyUpdate.asp" class="pcForms">
    <table class="pcCPcontent">
        ...
        <tr>
            <td>
            <hr />
            <input type="submit" name="submit" value="Generate New Encryption Key" class="btn btn-primary">
            </td>
        </tr>           
    </table>
</form>
