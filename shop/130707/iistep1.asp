...
<table class="pcCPcontent">
    ...
    <tr>
        <td><input type="submit" name="submit" value="Import Data" class="btn btn-primary"></td>
    </tr>
	<%end if%>
</table>
</form>
