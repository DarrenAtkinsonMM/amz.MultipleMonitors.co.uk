...
response.redirect "techErr.asp?err="&pcStrCustRefID
        ...
        <div style="float: right; margin: 40px 20px 20px 20px;"><a href="https://www.productcart.com/nc-payment-gateway.asp" target="_blank"><img src="images/ei_logo_gradient_payment_gateway_175.jpg" alt="NetSource Commerce Payment Gateway" style="border: none;" /></a></div>
        ...
        <ul>
        	<li><a href="https://www.productcart.com/nc-payment-gateway.asp" target="_blank">Learn more about the NetSource Commerce Payment Gateway</a></li>
            <li><a href="pcConfigurePayment.asp?gwchoice=67">Activate now</a></li>
        </ul>
        <% else %>
        <p>The NetSource Commerce Payment Gateway is active.
        <ul>
            <li><a href="pcConfigurePayment.asp?mode=Edit&id=3&gwchoice=67">Edit settings</a></li>
            <li><a href="https://www.productcart.com/nc-payment-gateway.asp" target="_blank">Login</a></li>
        	<li><a href="http://wiki.productcart.com/productcart/early_impact_payment_gateway" target="_blank">Documentation</a></li>
        </ul>
        <% end if %>
