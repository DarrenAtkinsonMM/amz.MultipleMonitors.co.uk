...
<div style="float: left;">
        <ul class="pcListIcon">
            ...
            <li><a href="ReverseImport_step1.asp">Advanced product export (Reverse Import Wizard)</a>&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=438"></a></li>
            <li><a href="ReverseCatImport_step1.asp">Advanced category export (Reverse Import Wizard)</a>&nbsp;<a href="http://wiki.productcart.com/productcart/export-import-categories" target="_blank"><img src="images/pcv3_infoIcon.gif" alt="More information about exporting categories"></a></li>
            <li><a href="exportFroogle.asp">Create data feed for Google Shopping</a>&nbsp;<a href="http://wiki.productcart.com/productcart/marketing-generate_google_base_file" target="_blank"><img src="images/pcv3_infoIcon.gif" alt="More information on this feature" title="More information about creating a Google Shopping data feed"></a></li>
            <li><a href="pcNextTag_step1.asp">Create data feed for NextTag</a>&nbsp;<a href="http://wiki.productcart.com/productcart/marketing-generate_nextag_data_feed" target="_blank"><img src="images/pcv3_infoIcon.gif" alt="More information on this feature" title="More information about creating a NexTag product data feed"></a></li>
            <li><a href="pcYahoo_step1.asp">Create data feed for Yahoo! Search Marketing</a>&nbsp;<a href="http://wiki.productcart.com/productcart/marketing-generate_yahoo_data_feed" target="_blank"><img src="images/pcv3_infoIcon.gif" alt="More information on this feature" title="More information about Yahoo! Search Marketing product data feeds"></a></li>
        </ul>
</div>
...
<td colspan="2">
    ...
    &nbsp;<input type="button" class="btn btn-default"  value="Back to the Top" onClick="document.location.href='#top';">
 </td>
</tr>
<tr> 
	<td colspan="2" class="pcCPspacer"></td>
...
<tr> 
<td colspan="2">
<input type="Submit" name="Submit5" value="Submit" class="btn btn-primary">
&nbsp;<input type="button" class="btn btn-default"  value="Back to the Top" onClick="document.location.href='#top';">
</td>
</tr>
<tr> 
...
<% If statusAPP="1" OR scAPP=1 Then %>
	...
	<td>&nbsp;</td>
	<td>
		<input type="radio" name="incApp" value="0" checked class="clearBorder"> Include Parent products only<br>
		<input type="radio" name="incApp" value="1" class="clearBorder"> Include Sub-products only<br>
		<input type="radio" name="incApp" value="2" class="clearBorder"> Include All products
	</td>
	</tr>
<% End If %>
<td colspan="2">Export format: 
...
<td width="6%">&nbsp;</td>
<td width="94%">
<input type="Submit" name="goUPS" value="Submit" class="btn btn-primary">
&nbsp;<input type="button" class="btn btn-default"  value="Back to the Top" onClick="document.location.href='#top';">
</td>
</tr>
<tr> 
...
<tr> 
<td>&nbsp;</td>
<td><input type="Submit" name="goUPS" value="Submit" class="btn btn-primary">
    &nbsp;<input type="button" class="btn btn-default"  value="Back to the Top" onClick="document.location.href='#top';">
</td>
</tr>
<tr> 
...
<tr> 
	...
	<td width="94%">Product Configuration</td>
</tr>
<%end if%>
<tr> 
	<td width="6%">
