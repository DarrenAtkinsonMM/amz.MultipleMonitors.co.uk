...
<tr align="center">
	<td colspan="2">
		<input type="submit" name="Preview" value="Preview Sale" class="btn btn-primary">&nbsp;
		<input type="button" class="btn btn-default"  name="Back" value="Review Products Selection" onclick="location='sm_addedit_S1.asp?a=rev';">
	</td>
</tr>
</table>
</form>
