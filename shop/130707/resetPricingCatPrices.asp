...
<table class="pcCPcontent">
	...
	<tr> 
		...
		<td>Reset Prices and Configurable Product Prices</td>
	</tr>
	<%
	Else
	%>
	...
	<tr>
		...
		<td>
            ...
            &nbsp;
            <input type="button" class="btn btn-default"  name="back" value="Manage Pricing Categories" onClick="document.location.href='AdminCustomerCategory.asp'">
		</td>
	</tr>
	<tr>
		<td colspan="2"><hr></td>
	...
	<tr>
		<td colspan="2">Technical Note: all records associated with the selected pricing category are removed from the <em>pcCC_Pricing</em> table (and <em>pcCC_BTO_Pricing</em> table if that option is selected on a Configurator store).</td>
	</tr>
</table>
</form>
