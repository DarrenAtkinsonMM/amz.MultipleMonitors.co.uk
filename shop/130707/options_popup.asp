...
Dim xOptionsCnt, pcv_strNumberValidations, pcv_strRemoveFeature, xOtionrequired, pcv_strReqOptString
%>
...
pcv_strRemoveFeature="0" '// Activate the Remove Option Feature.
...
Dim pcv_Apparel
pcv_Apparel=0
query="SELECT Products.pcProd_Apparel,ProductsOrdered.quantity, ProductsOrdered.unitPrice, ProductsOrdered.QDiscounts, ProductsOrdered.pcPrdOrd_OptionsPriceArray FROM Products INNER JOIN ProductsOrdered ON Products.idProduct=ProductsOrdered.idProduct WHERE idProductOrdered="&pidProductOrdered
...
<form name="additem" method="post" action="options_popup.asp" class="pcForms">
		...
		<td>		
			<table width="98%" border="0" align="center" cellpadding="4" cellspacing="0">
                ...
                <!--#include file="../includes/javascripts/pcValidateFormViewPrd.asp"-->
			  	<tr>
					<td align="center">
					<input type="submit" name="Submit" value="Save" <% if xOtionrequired = "1" then %>onClick="javascript: cdDynamic(<%=pcv_strReqOptString%>,0); return false;"<% end if %>>
