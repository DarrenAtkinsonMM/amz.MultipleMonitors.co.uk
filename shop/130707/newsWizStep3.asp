...
<tr>
	...
	<td>
		<textarea class="htmleditor" name="details" id="details" cols="80" rows="10"><%=session("News_Msgbody")%></textarea>
	</td>
</tr>
<tr>
	<td>Send as:</td>
...
<tr>
	...
	&nbsp;
	<input type="button" class="btn btn-default"  name="back" value="Back" onClick="location='newsWizStep2.asp?pagetype=<%=pcv_PageType%>'">
</td>
</tr>
</table>
</form>
