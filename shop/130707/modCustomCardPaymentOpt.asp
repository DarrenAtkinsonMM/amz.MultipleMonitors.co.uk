...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	End If
	query="UPDATE customCardTypes SET customCardDesc=N'"&customCardDesc&"' WHERE idcustomCardType="&pidCustomCardType&";"
	set rstemp=Server.CreateObject("ADODB.Recordset")     
	set rstemp=conntemp.execute(query)
	if err.number <> 0 then
			strErrorDescription=err.description
...
response.redirect "techErr.asp?error="& Server.Urlencode("Error: "&strErrorDescription) 
	...
	query="UPDATE payTypes SET pcPayTypes_processOrder=" & pcv_processOrder & ",pcPayTypes_setPayStatus=" & pcv_setPayStatus & ",paymentDesc=N'"&customCardDesc&"', Cbtob="&Cbtob&", priceToAdd="&pPriceToAdd&", percentageToAdd="&pPercentageToAdd&" WHERE idpayment="&pidPayment&";"
...
<form method="post" name="form1" action="modCustomCardPaymentOpt.asp" class="pcForms">
	<table class="pcCPcontent">
		...
		<tr>
			<td colspan="2">Enter a description for this payment option and specify whether it applies to all customers or only wholesale customers.&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=303"></a></td>
		</tr>
		<tr>
			<td colspan="2">
		...
		<tr>
			...
			<tr>
				...
				<td colspan="2">
					...
					<input name="SubmitOrder" type="submit" id="SubmitOrder" value="Update Order" class="btn btn-primary">
				</td>
			</tr>
			</table>
			</td>
		...
		<tr> 
			<td colspan="2">You have the option to charge a processing fee for this payment option.&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=304"></a></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">Process orders when they are placed: <input type="checkbox" name="pcv_processOrder" value="1" <%if pcv_processOrder="1" then%>checked<%end if%> class="clearBorder">&nbsp;<a class="pcCPhelp" href="helpOnline.asp?ref=301"></a></td>
		</tr>
		<tr>
	...
	<input type="hidden" name="gwCode" value="<%=gwCode%>">
		...
		<tr> 
			<td colspan="2" align="center"> 
				...
				&nbsp;<input type="button" class="btn btn-default"  value="Payment Options Summary" onClick="location.href='PaymentOptions.asp'">
			</td>
		</tr>
	</table>
	</form>
