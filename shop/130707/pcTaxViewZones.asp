...
response.redirect "AdminTaxZones.asp"		
			...
			<table class="pcCPcontent">
				...
				<tr>
					<td colspan="2"><p><a href="AdminTaxZones.asp">
					  <input type="button" class="btn btn-default"  name="New2" value="Add New Zone" class="btn btn-primary" onClick="location.href='AdminTaxZones.asp'">
					</a></p></td>
				</tr>
				<tr>
					<td colspan="2" class="pcCPspacer"></td>
	...
	<table class="pcCPcontent">
		...
		<tr>
			<td colspan="2" align="center"><p><input type="button" class="btn btn-default"  name="New" value="Add New Zone" class="btn btn-primary" onClick="location.href='AdminTaxZones.asp'">
			&nbsp;
			<% if request("success")="1" then %>
				<input type="button" class="btn btn-default"  name="Complete" value="Complete Tax Zone Configuration" class="btn btn-primary" onClick="opener.location.reload(); self.close();">
			<% else %>
