...
if request("action")="add" then
	...
	query="INSERT INTO Admins (IDadmin,AdminName,AdminPassword,AdminLevel,adm_ContactName,adm_ContactEmail) values (" & AdminUser & ",'sub-admin','" & password & "','" & permissions & "',N'" & pcvAdminName & "','" & pcvAdminEmail & "')"
	set rstemp=connTemp.execute(query)
	set rstemp=nothing
...
<table class="pcCPcontent">
	...
	<tr>
		<td colspan="2">
		Use this feature to create new store managers that have limited access to the areas of the Control Panel that you select. For details, <a href="http://wiki.productcart.com/productcart/settings-manage-users" target="_blank">see the ProductCart documentation</a>. </td>
	</tr>
	<tr>
	...
	<tr>          
		...
		<td><input type="password" name="AdminPassword" size="20" maxlength="20">&nbsp;&nbsp;<i>Must be at least 8 characters.</i></td>
	</tr>
	<tr> 
	...
	<tr>
		<td>&nbsp;</td>      
		<td>
		<input name="submit" type="submit" class="btn btn-primary" value="Add New">
		&nbsp;
