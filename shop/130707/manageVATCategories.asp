...
<%
Dim rsVAT, rsVATTemp, pcDontshow, pIdProduct, pSku, pDescription, pcMessage, pAction, sMode, strORD, iPageCount, strCol, Count
...
<!--#include file="AdminHeader.asp"-->
	...
	<table class="pcCPcontent">
		...
		<tr>
			<td colspan="6">
				...
				<ul>
					<% if ptaxVATRate_Code<>"" AND pcNoCategory<>1 then %><li><a href="JavaScript:;" onClick="javascript:document.getElementById('FindProducts').style.display=''">Add Products to this Category</a></li><% end if %>
	...
	<table class="pcCPcontent">
		...
		<tr>
			<td colspan="6">
				<input name="submit" type="submit" class="btn btn-primary" value="Remove unchecked">		
				...
				<% end if %>
				<input type="button" class="btn btn-default"  name="Button" value="Manage VAT Settings" onClick="location='AdminTaxSettings_VAT.asp';">&nbsp;
